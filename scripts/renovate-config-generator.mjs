...
// After writing the JSON file, add a comment to the file
await fs.appendFile(path.join(ROOT_DIR, 'renovate.json5'), '\n// This file was generated by renovate-config-generator.mjs\n');
