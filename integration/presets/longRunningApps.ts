...
export const createLongRunningApps = () => {
  const configs = [
    ...
    { id: 'tanstack.react-start', config: tanstack.reactRouter, env: envs.withEmailCodes },
    { id: 'tanstack.react-router', config: tanstack.reactStart, env: envs.withEmailCodes },
