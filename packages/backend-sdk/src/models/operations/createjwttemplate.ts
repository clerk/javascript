...
export function createJWTTemplateRequestBodyToJSON(createJWTTemplateRequestBody: CreateJWTTemplateRequestBody): string {
  return JSON.stringify(CreateJWTTemplateRequestBody$outboundSchema.parse(createJWTTemplateRequestBody));
}
