...
/** @internal */
export const GetUserListRequest$inboundSchema: z.ZodType<
  GetUserListRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function getUserListRequestToJSON(
  getUserListRequest: GetUserListRequest,
): string {
  return JSON.stringify(
    GetUserListRequest$outboundSchema.parse(getUserListRequest),
  );
}
