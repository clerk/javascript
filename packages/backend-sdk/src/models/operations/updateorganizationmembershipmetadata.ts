...
/** @internal */
export const UpdateOrganizationMembershipMetadataRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export const UpdateOrganizationMembershipMetadataRequestBody$outboundSchema: z.ZodType<
...
export namespace UpdateOrganizationMembershipMetadataRequestBody$ {
  ...
  export const inboundSchema = UpdateOrganizationMembershipMetadataRequestBody$inboundSchema;
  /** @deprecated use `UpdateOrganizationMembershipMetadataRequestBody$outboundSchema` instead. */
  export const outboundSchema = UpdateOrganizationMembershipMetadataRequestBody$outboundSchema;
  /** @deprecated use `UpdateOrganizationMembershipMetadataRequestBody$Outbound` instead. */
  export type Outbound = UpdateOrganizationMembershipMetadataRequestBody$Outbound;
}

export function updateOrganizationMembershipMetadataRequestBodyToJSON(
  updateOrganizationMembershipMetadataRequestBody: UpdateOrganizationMembershipMetadataRequestBody,
): string {
...
export function updateOrganizationMembershipMetadataRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<UpdateOrganizationMembershipMetadataRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    x => UpdateOrganizationMembershipMetadataRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UpdateOrganizationMembershipMetadataRequestBody' from JSON`,
  );
}

/** @internal */
export const UpdateOrganizationMembershipMetadataRequest$inboundSchema: z.ZodType<
...
> = z
  .object({
    ...
    user_id: z.string(),
    RequestBody: z.lazy(() => UpdateOrganizationMembershipMetadataRequestBody$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export type UpdateOrganizationMembershipMetadataRequest$Outbound = {
  ...
  user_id: string;
  RequestBody?: UpdateOrganizationMembershipMetadataRequestBody$Outbound | undefined;
};

/** @internal */
export const UpdateOrganizationMembershipMetadataRequest$outboundSchema: z.ZodType<
...
> = z
  .object({
    ...
    userId: z.string(),
    requestBody: z.lazy(() => UpdateOrganizationMembershipMetadataRequestBody$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export namespace UpdateOrganizationMembershipMetadataRequest$ {
  ...
  export const inboundSchema = UpdateOrganizationMembershipMetadataRequest$inboundSchema;
  /** @deprecated use `UpdateOrganizationMembershipMetadataRequest$outboundSchema` instead. */
  export const outboundSchema = UpdateOrganizationMembershipMetadataRequest$outboundSchema;
...
export function updateOrganizationMembershipMetadataRequestToJSON(
  ...
  return JSON.stringify(
    UpdateOrganizationMembershipMetadataRequest$outboundSchema.parse(updateOrganizationMembershipMetadataRequest),
  );
}

export function updateOrganizationMembershipMetadataRequestFromJSON(
  jsonString: string,
): SafeParseResult<UpdateOrganizationMembershipMetadataRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    x => UpdateOrganizationMembershipMetadataRequest$inboundSchema.parse(JSON.parse(x)),
