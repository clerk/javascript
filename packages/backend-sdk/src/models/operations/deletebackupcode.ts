...
/** @internal */
export const DeleteBackupCodeRequest$inboundSchema: z.ZodType<DeleteBackupCodeRequest, z.ZodTypeDef, unknown> = z
  .object({
    user_id: z.string(),
  })
  .transform(v => {
...
export function deleteBackupCodeRequestToJSON(deleteBackupCodeRequest: DeleteBackupCodeRequest): string {
  return JSON.stringify(DeleteBackupCodeRequest$outboundSchema.parse(deleteBackupCodeRequest));
}
...
export function deleteBackupCodeResponseBodyToJSON(deleteBackupCodeResponseBody: DeleteBackupCodeResponseBody): string {
  return JSON.stringify(DeleteBackupCodeResponseBody$outboundSchema.parse(deleteBackupCodeResponseBody));
}
