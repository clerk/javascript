...
/** @internal */
export const Actor$inboundSchema: z.ZodType<Actor, z.ZodTypeDef, unknown> = collectExtraKeys$(
  z
    .object({
      sub: z.string(),
    })
...
/** @internal */
export const CreateActorTokenRequestBody$inboundSchema: z.ZodType<CreateActorTokenRequestBody, z.ZodTypeDef, unknown> =
  z
    .object({
      user_id: z.string(),
...
export function createActorTokenRequestBodyToJSON(createActorTokenRequestBody: CreateActorTokenRequestBody): string {
  return JSON.stringify(CreateActorTokenRequestBody$outboundSchema.parse(createActorTokenRequestBody));
}
