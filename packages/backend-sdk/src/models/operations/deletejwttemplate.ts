...
/** @internal */
export const DeleteJWTTemplateRequest$inboundSchema: z.ZodType<DeleteJWTTemplateRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function deleteJWTTemplateRequestToJSON(deleteJWTTemplateRequest: DeleteJWTTemplateRequest): string {
  return JSON.stringify(DeleteJWTTemplateRequest$outboundSchema.parse(deleteJWTTemplateRequest));
}
