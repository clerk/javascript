...
export namespace RevokeOrganizationInvitationRequestBody$ {
  ...
  export const inboundSchema =
    RevokeOrganizationInvitationRequestBody$inboundSchema;
  /** @deprecated use `RevokeOrganizationInvitationRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    RevokeOrganizationInvitationRequestBody$outboundSchema;
...
export function revokeOrganizationInvitationRequestBodyToJSON(
  ...
  return JSON.stringify(
    RevokeOrganizationInvitationRequestBody$outboundSchema.parse(
      revokeOrganizationInvitationRequestBody,
    ),
  );
}
...
> {
  return safeParse(
    jsonString,
    (x) =>
      RevokeOrganizationInvitationRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
...
export namespace RevokeOrganizationInvitationRequest$ {
  ...
  export const inboundSchema =
    RevokeOrganizationInvitationRequest$inboundSchema;
  /** @deprecated use `RevokeOrganizationInvitationRequest$outboundSchema` instead. */
  export const outboundSchema =
    RevokeOrganizationInvitationRequest$outboundSchema;
...
export function revokeOrganizationInvitationRequestToJSON(
  ...
  return JSON.stringify(
    RevokeOrganizationInvitationRequest$outboundSchema.parse(
      revokeOrganizationInvitationRequest,
    ),
  );
}
...
export function revokeOrganizationInvitationRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) =>
      RevokeOrganizationInvitationRequest$inboundSchema.parse(JSON.parse(x)),
