...
export namespace RotateOAuthApplicationSecretRequest$ {
  ...
  export const inboundSchema = RotateOAuthApplicationSecretRequest$inboundSchema;
  /** @deprecated use `RotateOAuthApplicationSecretRequest$outboundSchema` instead. */
  export const outboundSchema = RotateOAuthApplicationSecretRequest$outboundSchema;
...
export function rotateOAuthApplicationSecretRequestToJSON(
  ...
  return JSON.stringify(RotateOAuthApplicationSecretRequest$outboundSchema.parse(rotateOAuthApplicationSecretRequest));
}
...
export function rotateOAuthApplicationSecretRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    x => RotateOAuthApplicationSecretRequest$inboundSchema.parse(JSON.parse(x)),
