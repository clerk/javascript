...
/** @internal */
export const GetSAMLConnectionRequest$inboundSchema: z.ZodType<GetSAMLConnectionRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function getSAMLConnectionRequestToJSON(getSAMLConnectionRequest: GetSAMLConnectionRequest): string {
  return JSON.stringify(GetSAMLConnectionRequest$outboundSchema.parse(getSAMLConnectionRequest));
}
