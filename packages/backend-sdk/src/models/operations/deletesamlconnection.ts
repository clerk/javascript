...
/** @internal */
export const DeleteSAMLConnectionRequest$inboundSchema: z.ZodType<DeleteSAMLConnectionRequest, z.ZodTypeDef, unknown> =
  z
    .object({
...
export function deleteSAMLConnectionRequestToJSON(deleteSAMLConnectionRequest: DeleteSAMLConnectionRequest): string {
  return JSON.stringify(DeleteSAMLConnectionRequest$outboundSchema.parse(deleteSAMLConnectionRequest));
}
