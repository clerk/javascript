...
export namespace DeleteOrganizationMembershipRequest$ {
  ...
  export const inboundSchema = DeleteOrganizationMembershipRequest$inboundSchema;
  /** @deprecated use `DeleteOrganizationMembershipRequest$outboundSchema` instead. */
  export const outboundSchema = DeleteOrganizationMembershipRequest$outboundSchema;
...
export function deleteOrganizationMembershipRequestToJSON(
  ...
  return JSON.stringify(DeleteOrganizationMembershipRequest$outboundSchema.parse(deleteOrganizationMembershipRequest));
}
...
export function deleteOrganizationMembershipRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    x => DeleteOrganizationMembershipRequest$inboundSchema.parse(JSON.parse(x)),
