...
/** @internal */
export const UpdateInstanceOrganizationSettingsRequestBody$inboundSchema:
  z.ZodType<
...
/** @internal */
export const UpdateInstanceOrganizationSettingsRequestBody$outboundSchema:
  z.ZodType<
...
export namespace UpdateInstanceOrganizationSettingsRequestBody$ {
  ...
  export const inboundSchema =
    UpdateInstanceOrganizationSettingsRequestBody$inboundSchema;
  /** @deprecated use `UpdateInstanceOrganizationSettingsRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    UpdateInstanceOrganizationSettingsRequestBody$outboundSchema;
...
export function updateInstanceOrganizationSettingsRequestBodyToJSON(
  ...
  return JSON.stringify(
    UpdateInstanceOrganizationSettingsRequestBody$outboundSchema.parse(
      updateInstanceOrganizationSettingsRequestBody,
    ),
  );
}
...
> {
  return safeParse(
    jsonString,
    (x) =>
      UpdateInstanceOrganizationSettingsRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
