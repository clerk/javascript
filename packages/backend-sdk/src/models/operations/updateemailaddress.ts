...
export function updateEmailAddressRequestBodyToJSON(
  ...
  return JSON.stringify(UpdateEmailAddressRequestBody$outboundSchema.parse(updateEmailAddressRequestBody));
}
...
/** @internal */
export const UpdateEmailAddressRequest$inboundSchema: z.ZodType<UpdateEmailAddressRequest, z.ZodTypeDef, unknown> = z
  .object({
    email_address_id: z.string(),
    RequestBody: z.lazy(() => UpdateEmailAddressRequestBody$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    requestBody: z.lazy(() => UpdateEmailAddressRequestBody$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function updateEmailAddressRequestToJSON(updateEmailAddressRequest: UpdateEmailAddressRequest): string {
  return JSON.stringify(UpdateEmailAddressRequest$outboundSchema.parse(updateEmailAddressRequest));
}
