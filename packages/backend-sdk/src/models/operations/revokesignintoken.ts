...
/** @internal */
export const RevokeSignInTokenRequest$inboundSchema: z.ZodType<RevokeSignInTokenRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function revokeSignInTokenRequestToJSON(revokeSignInTokenRequest: RevokeSignInTokenRequest): string {
  return JSON.stringify(RevokeSignInTokenRequest$outboundSchema.parse(revokeSignInTokenRequest));
}
