...
/** @internal */
export const ListRedirectURLsRequest$inboundSchema: z.ZodType<ListRedirectURLsRequest, z.ZodTypeDef, unknown> =
  z.object({
...
export function listRedirectURLsRequestToJSON(listRedirectURLsRequest: ListRedirectURLsRequest): string {
  return JSON.stringify(ListRedirectURLsRequest$outboundSchema.parse(listRedirectURLsRequest));
}
