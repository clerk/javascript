...
/** @internal */
export const UpdateInstanceRequestBody$inboundSchema: z.ZodType<
...
export function updateInstanceRequestBodyToJSON(
  updateInstanceRequestBody: UpdateInstanceRequestBody,
): string {
  return JSON.stringify(
    UpdateInstanceRequestBody$outboundSchema.parse(updateInstanceRequestBody),
  );
}
