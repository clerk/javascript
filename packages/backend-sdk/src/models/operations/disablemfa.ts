...
/** @internal */
export const DisableMFARequest$inboundSchema: z.ZodType<DisableMFARequest, z.ZodTypeDef, unknown> = z
  .object({
    user_id: z.string(),
  })
  .transform(v => {
...
/** @internal */
export const DisableMFARequest$outboundSchema: z.ZodType<DisableMFARequest$Outbound, z.ZodTypeDef, DisableMFARequest> =
  z
    .object({
      userId: z.string(),
    })
...
export function disableMFARequestToJSON(disableMFARequest: DisableMFARequest): string {
  return JSON.stringify(DisableMFARequest$outboundSchema.parse(disableMFARequest));
}

export function disableMFARequestFromJSON(jsonString: string): SafeParseResult<DisableMFARequest, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const DisableMFAResponseBody$inboundSchema: z.ZodType<DisableMFAResponseBody, z.ZodTypeDef, unknown> = z
  .object({
...
export function disableMFAResponseBodyToJSON(disableMFAResponseBody: DisableMFAResponseBody): string {
  return JSON.stringify(DisableMFAResponseBody$outboundSchema.parse(disableMFAResponseBody));
}
