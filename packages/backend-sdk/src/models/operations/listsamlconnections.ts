...
/** @internal */
export const ListSAMLConnectionsRequest$inboundSchema: z.ZodType<ListSAMLConnectionsRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function listSAMLConnectionsRequestToJSON(listSAMLConnectionsRequest: ListSAMLConnectionsRequest): string {
  return JSON.stringify(ListSAMLConnectionsRequest$outboundSchema.parse(listSAMLConnectionsRequest));
}
