...
/** @internal */
export const VerifyPasswordRequestBody$inboundSchema: z.ZodType<
...
export function verifyPasswordRequestBodyToJSON(
  verifyPasswordRequestBody: VerifyPasswordRequestBody,
): string {
  return JSON.stringify(
    VerifyPasswordRequestBody$outboundSchema.parse(verifyPasswordRequestBody),
  );
}
...
/** @internal */
export const VerifyPasswordRequest$inboundSchema: z.ZodType<
...
> = z.object({
  userId: z.string(),
  requestBody: z.lazy(() => VerifyPasswordRequestBody$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    userId: "user_id",
...
export function verifyPasswordRequestToJSON(
  verifyPasswordRequest: VerifyPasswordRequest,
): string {
  return JSON.stringify(
    VerifyPasswordRequest$outboundSchema.parse(verifyPasswordRequest),
  );
}
...
/** @internal */
export const VerifyPasswordResponseBody$inboundSchema: z.ZodType<
...
export function verifyPasswordResponseBodyToJSON(
  verifyPasswordResponseBody: VerifyPasswordResponseBody,
): string {
  return JSON.stringify(
    VerifyPasswordResponseBody$outboundSchema.parse(verifyPasswordResponseBody),
  );
}
