...
/** @internal */
export const VerifyClientRequestBody$inboundSchema: z.ZodType<VerifyClientRequestBody, z.ZodTypeDef, unknown> =
  z.object({
    token: z.string(),
  });
...
export function verifyClientRequestBodyToJSON(verifyClientRequestBody: VerifyClientRequestBody): string {
  return JSON.stringify(VerifyClientRequestBody$outboundSchema.parse(verifyClientRequestBody));
}
