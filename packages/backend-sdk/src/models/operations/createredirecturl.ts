...
export function createRedirectURLRequestBodyToJSON(
  createRedirectURLRequestBody: CreateRedirectURLRequestBody,
): string {
  return JSON.stringify(
    CreateRedirectURLRequestBody$outboundSchema.parse(
      createRedirectURLRequestBody,
    ),
  );
}
