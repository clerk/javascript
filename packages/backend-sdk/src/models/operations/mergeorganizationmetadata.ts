...
export namespace MergeOrganizationMetadataRequestBody$ {
  ...
  export const inboundSchema = MergeOrganizationMetadataRequestBody$inboundSchema;
  /** @deprecated use `MergeOrganizationMetadataRequestBody$outboundSchema` instead. */
  export const outboundSchema = MergeOrganizationMetadataRequestBody$outboundSchema;
...
export function mergeOrganizationMetadataRequestBodyToJSON(
  ...
  return JSON.stringify(
    MergeOrganizationMetadataRequestBody$outboundSchema.parse(mergeOrganizationMetadataRequestBody),
  );
}
...
export function mergeOrganizationMetadataRequestBodyFromJSON(
  ...
  return safeParse(
    jsonString,
    x => MergeOrganizationMetadataRequestBody$inboundSchema.parse(JSON.parse(x)),
...
> = z
  .object({
    ...
    requestBody: z.lazy(() => MergeOrganizationMetadataRequestBody$outboundSchema),
  })
  .transform(v => {
    return remap$(v, {
...
export function mergeOrganizationMetadataRequestToJSON(
  ...
  return JSON.stringify(MergeOrganizationMetadataRequest$outboundSchema.parse(mergeOrganizationMetadataRequest));
}
