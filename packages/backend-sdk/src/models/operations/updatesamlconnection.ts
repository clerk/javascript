...
export namespace UpdateSAMLConnectionAttributeMapping$ {
  ...
  export const inboundSchema = UpdateSAMLConnectionAttributeMapping$inboundSchema;
  /** @deprecated use `UpdateSAMLConnectionAttributeMapping$outboundSchema` instead. */
  export const outboundSchema = UpdateSAMLConnectionAttributeMapping$outboundSchema;
...
export function updateSAMLConnectionAttributeMappingToJSON(
  ...
  return JSON.stringify(
    UpdateSAMLConnectionAttributeMapping$outboundSchema.parse(updateSAMLConnectionAttributeMapping),
  );
}
...
export function updateSAMLConnectionAttributeMappingFromJSON(
  ...
  return safeParse(
    jsonString,
    x => UpdateSAMLConnectionAttributeMapping$inboundSchema.parse(JSON.parse(x)),
...
> = z
  .object({
    ...
    attribute_mapping: z.nullable(z.lazy(() => UpdateSAMLConnectionAttributeMapping$inboundSchema)).optional(),
...
export type UpdateSAMLConnectionRequestBody$Outbound = {
  ...
  attribute_mapping?: UpdateSAMLConnectionAttributeMapping$Outbound | null | undefined;
  active?: boolean | null | undefined;
...
> = z
  .object({
    ...
    attributeMapping: z.nullable(z.lazy(() => UpdateSAMLConnectionAttributeMapping$outboundSchema)).optional(),
    active: z.nullable(z.boolean()).optional(),
...
export function updateSAMLConnectionRequestBodyToJSON(
  ...
  return JSON.stringify(UpdateSAMLConnectionRequestBody$outboundSchema.parse(updateSAMLConnectionRequestBody));
}
...
/** @internal */
export const UpdateSAMLConnectionRequest$inboundSchema: z.ZodType<UpdateSAMLConnectionRequest, z.ZodTypeDef, unknown> =
  z
    .object({
...
export function updateSAMLConnectionRequestToJSON(updateSAMLConnectionRequest: UpdateSAMLConnectionRequest): string {
  return JSON.stringify(UpdateSAMLConnectionRequest$outboundSchema.parse(updateSAMLConnectionRequest));
}
