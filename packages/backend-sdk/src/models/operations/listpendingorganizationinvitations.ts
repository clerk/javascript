...
/** @internal */
export const ListPendingOrganizationInvitationsRequest$outboundSchema: z.ZodType<
...
export namespace ListPendingOrganizationInvitationsRequest$ {
  ...
  export const inboundSchema = ListPendingOrganizationInvitationsRequest$inboundSchema;
  /** @deprecated use `ListPendingOrganizationInvitationsRequest$outboundSchema` instead. */
  export const outboundSchema = ListPendingOrganizationInvitationsRequest$outboundSchema;
...
export function listPendingOrganizationInvitationsRequestToJSON(
  listPendingOrganizationInvitationsRequest: ListPendingOrganizationInvitationsRequest,
): string {
  return JSON.stringify(
    ListPendingOrganizationInvitationsRequest$outboundSchema.parse(listPendingOrganizationInvitationsRequest),
  );
}

export function listPendingOrganizationInvitationsRequestFromJSON(
  jsonString: string,
): SafeParseResult<ListPendingOrganizationInvitationsRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    x => ListPendingOrganizationInvitationsRequest$inboundSchema.parse(JSON.parse(x)),
