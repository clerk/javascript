...
export namespace CreateAllowlistIdentifierRequestBody$ {
  ...
  export const inboundSchema = CreateAllowlistIdentifierRequestBody$inboundSchema;
  /** @deprecated use `CreateAllowlistIdentifierRequestBody$outboundSchema` instead. */
  export const outboundSchema = CreateAllowlistIdentifierRequestBody$outboundSchema;
...
export function createAllowlistIdentifierRequestBodyToJSON(
  ...
  return JSON.stringify(
    CreateAllowlistIdentifierRequestBody$outboundSchema.parse(createAllowlistIdentifierRequestBody),
  );
}
...
export function createAllowlistIdentifierRequestBodyFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateAllowlistIdentifierRequestBody$inboundSchema.parse(JSON.parse(x)),
