...
export namespace CreateOrganizationMembershipRequestBody$ {
  ...
  export const inboundSchema =
    CreateOrganizationMembershipRequestBody$inboundSchema;
  /** @deprecated use `CreateOrganizationMembershipRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    CreateOrganizationMembershipRequestBody$outboundSchema;
...
export function createOrganizationMembershipRequestBodyToJSON(
  ...
  return JSON.stringify(
    CreateOrganizationMembershipRequestBody$outboundSchema.parse(
      createOrganizationMembershipRequestBody,
    ),
  );
}
...
> {
  return safeParse(
    jsonString,
    (x) =>
      CreateOrganizationMembershipRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
...
export namespace CreateOrganizationMembershipRequest$ {
  ...
  export const inboundSchema =
    CreateOrganizationMembershipRequest$inboundSchema;
  /** @deprecated use `CreateOrganizationMembershipRequest$outboundSchema` instead. */
  export const outboundSchema =
    CreateOrganizationMembershipRequest$outboundSchema;
...
export function createOrganizationMembershipRequestToJSON(
  ...
  return JSON.stringify(
    CreateOrganizationMembershipRequest$outboundSchema.parse(
      createOrganizationMembershipRequest,
    ),
  );
}
...
export function createOrganizationMembershipRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) =>
      CreateOrganizationMembershipRequest$inboundSchema.parse(JSON.parse(x)),
