...
/** @internal */
export const UpdateProductionInstanceDomainRequestBody$outboundSchema: z.ZodType<
...
export namespace UpdateProductionInstanceDomainRequestBody$ {
  ...
  export const inboundSchema = UpdateProductionInstanceDomainRequestBody$inboundSchema;
  /** @deprecated use `UpdateProductionInstanceDomainRequestBody$outboundSchema` instead. */
  export const outboundSchema = UpdateProductionInstanceDomainRequestBody$outboundSchema;
...
export function updateProductionInstanceDomainRequestBodyToJSON(
  updateProductionInstanceDomainRequestBody: UpdateProductionInstanceDomainRequestBody,
): string {
  return JSON.stringify(
    UpdateProductionInstanceDomainRequestBody$outboundSchema.parse(updateProductionInstanceDomainRequestBody),
  );
}

export function updateProductionInstanceDomainRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<UpdateProductionInstanceDomainRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    x => UpdateProductionInstanceDomainRequestBody$inboundSchema.parse(JSON.parse(x)),
