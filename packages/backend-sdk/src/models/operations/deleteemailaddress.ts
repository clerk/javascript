...
/** @internal */
export const DeleteEmailAddressRequest$inboundSchema: z.ZodType<DeleteEmailAddressRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function deleteEmailAddressRequestToJSON(deleteEmailAddressRequest: DeleteEmailAddressRequest): string {
  return JSON.stringify(DeleteEmailAddressRequest$outboundSchema.parse(deleteEmailAddressRequest));
}
