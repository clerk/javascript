...
/** @internal */
export const UpdateSignUpRequestBody$inboundSchema: z.ZodType<
...
export function updateSignUpRequestBodyToJSON(
  updateSignUpRequestBody: UpdateSignUpRequestBody,
): string {
  return JSON.stringify(
    UpdateSignUpRequestBody$outboundSchema.parse(updateSignUpRequestBody),
  );
}
...
/** @internal */
export const UpdateSignUpRequest$inboundSchema: z.ZodType<
  UpdateSignUpRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function updateSignUpRequestToJSON(
  updateSignUpRequest: UpdateSignUpRequest,
): string {
  return JSON.stringify(
    UpdateSignUpRequest$outboundSchema.parse(updateSignUpRequest),
  );
}
