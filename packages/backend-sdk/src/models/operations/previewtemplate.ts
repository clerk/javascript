...
/** @internal */
export const PreviewTemplateRequestBody$inboundSchema: z.ZodType<PreviewTemplateRequestBody, z.ZodTypeDef, unknown> = z
  .object({
...
export function previewTemplateRequestBodyToJSON(previewTemplateRequestBody: PreviewTemplateRequestBody): string {
  return JSON.stringify(PreviewTemplateRequestBody$outboundSchema.parse(previewTemplateRequestBody));
}
...
/** @internal */
export const PreviewTemplateRequest$inboundSchema: z.ZodType<PreviewTemplateRequest, z.ZodTypeDef, unknown> = z
  .object({
    template_type: z.string(),
    slug: z.string(),
    RequestBody: z.lazy(() => PreviewTemplateRequestBody$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string(),
    requestBody: z.lazy(() => PreviewTemplateRequestBody$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function previewTemplateRequestToJSON(previewTemplateRequest: PreviewTemplateRequest): string {
  return JSON.stringify(PreviewTemplateRequest$outboundSchema.parse(previewTemplateRequest));
}
...
/** @internal */
export const PreviewTemplateResponseBody$inboundSchema: z.ZodType<PreviewTemplateResponseBody, z.ZodTypeDef, unknown> =
  z.object({});
...
export function previewTemplateResponseBodyToJSON(previewTemplateResponseBody: PreviewTemplateResponseBody): string {
  return JSON.stringify(PreviewTemplateResponseBody$outboundSchema.parse(previewTemplateResponseBody));
}
