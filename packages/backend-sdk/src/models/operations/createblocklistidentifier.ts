...
export namespace CreateBlocklistIdentifierRequestBody$ {
  ...
  export const inboundSchema = CreateBlocklistIdentifierRequestBody$inboundSchema;
  /** @deprecated use `CreateBlocklistIdentifierRequestBody$outboundSchema` instead. */
  export const outboundSchema = CreateBlocklistIdentifierRequestBody$outboundSchema;
...
export function createBlocklistIdentifierRequestBodyToJSON(
  ...
  return JSON.stringify(
    CreateBlocklistIdentifierRequestBody$outboundSchema.parse(createBlocklistIdentifierRequestBody),
  );
}
...
export function createBlocklistIdentifierRequestBodyFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateBlocklistIdentifierRequestBody$inboundSchema.parse(JSON.parse(x)),
