...
/** @internal */
export const VerifySessionRequestBody$inboundSchema: z.ZodType<
...
export function verifySessionRequestBodyToJSON(
  verifySessionRequestBody: VerifySessionRequestBody,
): string {
  return JSON.stringify(
    VerifySessionRequestBody$outboundSchema.parse(verifySessionRequestBody),
  );
}
...
/** @internal */
export const VerifySessionRequest$inboundSchema: z.ZodType<
...
export function verifySessionRequestToJSON(
  verifySessionRequest: VerifySessionRequest,
): string {
  return JSON.stringify(
    VerifySessionRequest$outboundSchema.parse(verifySessionRequest),
  );
}
