...
/** @internal */
export const InstanceGetOrganizationMembershipsRequest$outboundSchema:
  z.ZodType<
...
export namespace InstanceGetOrganizationMembershipsRequest$ {
  ...
  export const inboundSchema =
    InstanceGetOrganizationMembershipsRequest$inboundSchema;
  /** @deprecated use `InstanceGetOrganizationMembershipsRequest$outboundSchema` instead. */
  export const outboundSchema =
    InstanceGetOrganizationMembershipsRequest$outboundSchema;
...
export function instanceGetOrganizationMembershipsRequestToJSON(
  ...
  return JSON.stringify(
    InstanceGetOrganizationMembershipsRequest$outboundSchema.parse(
      instanceGetOrganizationMembershipsRequest,
    ),
  );
}
...
> {
  return safeParse(
    jsonString,
    (x) =>
      InstanceGetOrganizationMembershipsRequest$inboundSchema.parse(
        JSON.parse(x),
      ),
