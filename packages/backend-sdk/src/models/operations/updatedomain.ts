...
/** @internal */
export const UpdateDomainRequestBody$inboundSchema: z.ZodType<UpdateDomainRequestBody, z.ZodTypeDef, unknown> = z
  .object({
...
export function updateDomainRequestBodyToJSON(updateDomainRequestBody: UpdateDomainRequestBody): string {
...
/** @internal */
export const UpdateDomainRequest$inboundSchema: z.ZodType<UpdateDomainRequest, z.ZodTypeDef, unknown> = z
  .object({
    domain_id: z.string(),
...
export function updateDomainRequestToJSON(updateDomainRequest: UpdateDomainRequest): string {
