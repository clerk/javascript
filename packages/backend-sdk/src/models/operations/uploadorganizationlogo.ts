...
/** @internal */
export const UploadOrganizationLogoFile$inboundSchema: z.ZodType<UploadOrganizationLogoFile, z.ZodTypeDef, unknown> =
  z.object({
    fileName: z.string(),
    content: z.union([
...
export function uploadOrganizationLogoFileToJSON(uploadOrganizationLogoFile: UploadOrganizationLogoFile): string {
  return JSON.stringify(UploadOrganizationLogoFile$outboundSchema.parse(uploadOrganizationLogoFile));
}
...
> = z
  .object({
    file: z.lazy(() => UploadOrganizationLogoFile$outboundSchema).or(blobLikeSchema),
...
export namespace UploadOrganizationLogoRequestBody$ {
  ...
  export const outboundSchema = UploadOrganizationLogoRequestBody$outboundSchema;
...
export function uploadOrganizationLogoRequestBodyToJSON(
  ...
  return JSON.stringify(UploadOrganizationLogoRequestBody$outboundSchema.parse(uploadOrganizationLogoRequestBody));
}
...
> = z
  .object({
    ...
    RequestBody: z.lazy(() => UploadOrganizationLogoRequestBody$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    requestBody: z.lazy(() => UploadOrganizationLogoRequestBody$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function uploadOrganizationLogoRequestToJSON(
  ...
  return JSON.stringify(UploadOrganizationLogoRequest$outboundSchema.parse(uploadOrganizationLogoRequest));
}
