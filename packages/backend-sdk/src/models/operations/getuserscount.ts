...
/** @internal */
export const GetUsersCountRequest$inboundSchema: z.ZodType<GetUsersCountRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function getUsersCountRequestToJSON(getUsersCountRequest: GetUsersCountRequest): string {
  return JSON.stringify(GetUsersCountRequest$outboundSchema.parse(getUsersCountRequest));
}
