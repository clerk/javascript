...
/** @internal */
export const AttributeMapping$inboundSchema: z.ZodType<AttributeMapping, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const AttributeMapping$outboundSchema: z.ZodType<AttributeMapping$Outbound, z.ZodTypeDef, AttributeMapping> = z
  .object({
...
export function attributeMappingToJSON(attributeMapping: AttributeMapping): string {
  return JSON.stringify(AttributeMapping$outboundSchema.parse(attributeMapping));
}

export function attributeMappingFromJSON(jsonString: string): SafeParseResult<AttributeMapping, SDKValidationError> {
  return safeParse(
    jsonString,
...
> = z
  .object({
    ...
    attribute_mapping: z.nullable(z.lazy(() => AttributeMapping$inboundSchema)).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    attributeMapping: z.nullable(z.lazy(() => AttributeMapping$outboundSchema)).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function createSAMLConnectionRequestBodyToJSON(
  ...
  return JSON.stringify(CreateSAMLConnectionRequestBody$outboundSchema.parse(createSAMLConnectionRequestBody));
}
