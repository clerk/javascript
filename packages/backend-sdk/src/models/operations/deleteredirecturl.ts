...
/** @internal */
export const DeleteRedirectURLRequest$inboundSchema: z.ZodType<
...
export function deleteRedirectURLRequestToJSON(
  deleteRedirectURLRequest: DeleteRedirectURLRequest,
): string {
  return JSON.stringify(
    DeleteRedirectURLRequest$outboundSchema.parse(deleteRedirectURLRequest),
  );
}
