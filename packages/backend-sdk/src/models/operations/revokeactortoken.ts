...
/** @internal */
export const RevokeActorTokenRequest$inboundSchema: z.ZodType<RevokeActorTokenRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function revokeActorTokenRequestToJSON(revokeActorTokenRequest: RevokeActorTokenRequest): string {
  return JSON.stringify(RevokeActorTokenRequest$outboundSchema.parse(revokeActorTokenRequest));
}
