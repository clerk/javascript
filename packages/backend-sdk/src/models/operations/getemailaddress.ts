...
/** @internal */
export const GetEmailAddressRequest$inboundSchema: z.ZodType<GetEmailAddressRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function getEmailAddressRequestToJSON(getEmailAddressRequest: GetEmailAddressRequest): string {
  return JSON.stringify(GetEmailAddressRequest$outboundSchema.parse(getEmailAddressRequest));
}
