...
export namespace UpdateOrganizationDomainRequestBody$ {
  ...
  export const inboundSchema = UpdateOrganizationDomainRequestBody$inboundSchema;
  /** @deprecated use `UpdateOrganizationDomainRequestBody$outboundSchema` instead. */
  export const outboundSchema = UpdateOrganizationDomainRequestBody$outboundSchema;
...
export function updateOrganizationDomainRequestBodyToJSON(
  ...
  return JSON.stringify(UpdateOrganizationDomainRequestBody$outboundSchema.parse(updateOrganizationDomainRequestBody));
}
...
export function updateOrganizationDomainRequestBodyFromJSON(
  ...
  return safeParse(
    jsonString,
    x => UpdateOrganizationDomainRequestBody$inboundSchema.parse(JSON.parse(x)),
...
export function updateOrganizationDomainRequestToJSON(
  ...
  return JSON.stringify(UpdateOrganizationDomainRequest$outboundSchema.parse(updateOrganizationDomainRequest));
}
