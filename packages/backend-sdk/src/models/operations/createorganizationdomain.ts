...
export namespace CreateOrganizationDomainRequestBody$ {
  ...
  export const inboundSchema = CreateOrganizationDomainRequestBody$inboundSchema;
  /** @deprecated use `CreateOrganizationDomainRequestBody$outboundSchema` instead. */
  export const outboundSchema = CreateOrganizationDomainRequestBody$outboundSchema;
...
export function createOrganizationDomainRequestBodyToJSON(
  ...
  return JSON.stringify(CreateOrganizationDomainRequestBody$outboundSchema.parse(createOrganizationDomainRequestBody));
}
...
export function createOrganizationDomainRequestBodyFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateOrganizationDomainRequestBody$inboundSchema.parse(JSON.parse(x)),
...
export function createOrganizationDomainRequestToJSON(
  ...
  return JSON.stringify(CreateOrganizationDomainRequest$outboundSchema.parse(createOrganizationDomainRequest));
}
