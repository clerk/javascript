...
/** @internal */
export const RevokeInvitationRequest$inboundSchema: z.ZodType<RevokeInvitationRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function revokeInvitationRequestToJSON(revokeInvitationRequest: RevokeInvitationRequest): string {
  return JSON.stringify(RevokeInvitationRequest$outboundSchema.parse(revokeInvitationRequest));
}
