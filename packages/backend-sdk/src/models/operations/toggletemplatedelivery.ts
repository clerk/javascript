...
/** @internal */
export const ToggleTemplateDeliveryPathParamTemplateType$inboundSchema: z.ZodNativeEnum<
  typeof ToggleTemplateDeliveryPathParamTemplateType
> = z.nativeEnum(ToggleTemplateDeliveryPathParamTemplateType);

/** @internal */
export const ToggleTemplateDeliveryPathParamTemplateType$outboundSchema: z.ZodNativeEnum<
  typeof ToggleTemplateDeliveryPathParamTemplateType
...
export namespace ToggleTemplateDeliveryPathParamTemplateType$ {
  ...
  export const inboundSchema = ToggleTemplateDeliveryPathParamTemplateType$inboundSchema;
  /** @deprecated use `ToggleTemplateDeliveryPathParamTemplateType$outboundSchema` instead. */
  export const outboundSchema = ToggleTemplateDeliveryPathParamTemplateType$outboundSchema;
}
...
export namespace ToggleTemplateDeliveryRequestBody$ {
  ...
  export const outboundSchema = ToggleTemplateDeliveryRequestBody$outboundSchema;
...
export function toggleTemplateDeliveryRequestBodyToJSON(
  ...
  return JSON.stringify(ToggleTemplateDeliveryRequestBody$outboundSchema.parse(toggleTemplateDeliveryRequestBody));
}
...
> = z
  .object({
    ...
    slug: z.string(),
    RequestBody: z.lazy(() => ToggleTemplateDeliveryRequestBody$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string(),
    requestBody: z.lazy(() => ToggleTemplateDeliveryRequestBody$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function toggleTemplateDeliveryRequestToJSON(
  ...
  return JSON.stringify(ToggleTemplateDeliveryRequest$outboundSchema.parse(toggleTemplateDeliveryRequest));
}
