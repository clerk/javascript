...
/** @internal */
export const GetRedirectURLRequest$inboundSchema: z.ZodType<GetRedirectURLRequest, z.ZodTypeDef, unknown> = z.object({
  id: z.string(),
});
...
export function getRedirectURLRequestToJSON(getRedirectURLRequest: GetRedirectURLRequest): string {
  return JSON.stringify(GetRedirectURLRequest$outboundSchema.parse(getRedirectURLRequest));
}
