 ...
 * The type of template to revert
 */
export type RevertTemplatePathParamTemplateType = ClosedEnum<typeof RevertTemplatePathParamTemplateType>;
...
/** @internal */
export const RevertTemplatePathParamTemplateType$outboundSchema: z.ZodNativeEnum<
  typeof RevertTemplatePathParamTemplateType
...
export namespace RevertTemplatePathParamTemplateType$ {
  ...
  export const inboundSchema = RevertTemplatePathParamTemplateType$inboundSchema;
  /** @deprecated use `RevertTemplatePathParamTemplateType$outboundSchema` instead. */
  export const outboundSchema = RevertTemplatePathParamTemplateType$outboundSchema;
}

/** @internal */
export const RevertTemplateRequest$inboundSchema: z.ZodType<RevertTemplateRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function revertTemplateRequestToJSON(revertTemplateRequest: RevertTemplateRequest): string {
  return JSON.stringify(RevertTemplateRequest$outboundSchema.parse(revertTemplateRequest));
}
