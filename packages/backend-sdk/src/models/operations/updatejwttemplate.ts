...
/** @internal */
export const UpdateJWTTemplateClaims$inboundSchema: z.ZodType<UpdateJWTTemplateClaims, z.ZodTypeDef, unknown> =
  z.object({});
...
export function updateJWTTemplateClaimsToJSON(updateJWTTemplateClaims: UpdateJWTTemplateClaims): string {
  return JSON.stringify(UpdateJWTTemplateClaims$outboundSchema.parse(updateJWTTemplateClaims));
}
...
export function updateJWTTemplateRequestBodyToJSON(updateJWTTemplateRequestBody: UpdateJWTTemplateRequestBody): string {
  return JSON.stringify(UpdateJWTTemplateRequestBody$outboundSchema.parse(updateJWTTemplateRequestBody));
}
...
/** @internal */
export const UpdateJWTTemplateRequest$inboundSchema: z.ZodType<UpdateJWTTemplateRequest, z.ZodTypeDef, unknown> = z
  .object({
    template_id: z.string(),
    RequestBody: z.lazy(() => UpdateJWTTemplateRequestBody$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    templateId: z.string(),
    requestBody: z.lazy(() => UpdateJWTTemplateRequestBody$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function updateJWTTemplateRequestToJSON(updateJWTTemplateRequest: UpdateJWTTemplateRequest): string {
  return JSON.stringify(UpdateJWTTemplateRequest$outboundSchema.parse(updateJWTTemplateRequest));
}
