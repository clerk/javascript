 ...
 * The slug of the email template to use for the invitation email.
 */
export type CreateBulkInvitationsTemplateSlug = ClosedEnum<typeof CreateBulkInvitationsTemplateSlug>;
...
export namespace CreateBulkInvitationsTemplateSlug$ {
  ...
  export const outboundSchema = CreateBulkInvitationsTemplateSlug$outboundSchema;
}
...
export const RequestBody$inboundSchema: z.ZodType<RequestBody, z.ZodTypeDef, unknown> = z
  .object({
    ...
    template_slug: CreateBulkInvitationsTemplateSlug$inboundSchema.default('invitation'),
  })
  .transform(v => {
    return remap$(v, {
...
/** @internal */
export const RequestBody$outboundSchema: z.ZodType<RequestBody$Outbound, z.ZodTypeDef, RequestBody> = z
  .object({
    ...
    templateSlug: CreateBulkInvitationsTemplateSlug$outboundSchema.default('invitation'),
  })
  .transform(v => {
    return remap$(v, {
...
export function requestBodyFromJSON(jsonString: string): SafeParseResult<RequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
