...
/** @internal */
export const AddDomainRequestBody$inboundSchema: z.ZodType<
...
export function addDomainRequestBodyToJSON(
  addDomainRequestBody: AddDomainRequestBody,
): string {
  return JSON.stringify(
    AddDomainRequestBody$outboundSchema.parse(addDomainRequestBody),
  );
}
