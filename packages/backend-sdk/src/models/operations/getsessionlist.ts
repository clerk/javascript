...
/** @internal */
export const GetSessionListRequest$inboundSchema: z.ZodType<GetSessionListRequest, z.ZodTypeDef, unknown> = z
  .object({
...
export function getSessionListRequestToJSON(getSessionListRequest: GetSessionListRequest): string {
  return JSON.stringify(GetSessionListRequest$outboundSchema.parse(getSessionListRequest));
}
