...
/** @internal */
export const LockUserRequest$inboundSchema: z.ZodType<LockUserRequest, z.ZodTypeDef, unknown> = z
  .object({
    user_id: z.string(),
  })
  .transform(v => {
...
/** @internal */
export const LockUserRequest$outboundSchema: z.ZodType<LockUserRequest$Outbound, z.ZodTypeDef, LockUserRequest> = z
  .object({
    userId: z.string(),
  })
  .transform(v => {
...
export function lockUserRequestToJSON(lockUserRequest: LockUserRequest): string {
  return JSON.stringify(LockUserRequest$outboundSchema.parse(lockUserRequest));
}

export function lockUserRequestFromJSON(jsonString: string): SafeParseResult<LockUserRequest, SDKValidationError> {
  return safeParse(
    jsonString,
