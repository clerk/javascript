...
/** @internal */
export const ListInstanceOrganizationInvitationsQueryParamStatus$inboundSchema: z.ZodNativeEnum<
  typeof ListInstanceOrganizationInvitationsQueryParamStatus
> = z.nativeEnum(ListInstanceOrganizationInvitationsQueryParamStatus);

/** @internal */
export const ListInstanceOrganizationInvitationsQueryParamStatus$outboundSchema: z.ZodNativeEnum<
  typeof ListInstanceOrganizationInvitationsQueryParamStatus
...
export namespace ListInstanceOrganizationInvitationsQueryParamStatus$ {
  ...
  export const inboundSchema = ListInstanceOrganizationInvitationsQueryParamStatus$inboundSchema;
  /** @deprecated use `ListInstanceOrganizationInvitationsQueryParamStatus$outboundSchema` instead. */
  export const outboundSchema = ListInstanceOrganizationInvitationsQueryParamStatus$outboundSchema;
}

/** @internal */
export const ListInstanceOrganizationInvitationsRequest$inboundSchema: z.ZodType<
...
> = z
  .object({
    ...
    status: ListInstanceOrganizationInvitationsQueryParamStatus$inboundSchema.optional(),
...
/** @internal */
export const ListInstanceOrganizationInvitationsRequest$outboundSchema: z.ZodType<
...
> = z
  .object({
    ...
    status: ListInstanceOrganizationInvitationsQueryParamStatus$outboundSchema.optional(),
    query: z.string().optional(),
    limit: z.number().int().default(10),
    offset: z.number().int().default(0),
  })
...
export namespace ListInstanceOrganizationInvitationsRequest$ {
  ...
  export const inboundSchema = ListInstanceOrganizationInvitationsRequest$inboundSchema;
  /** @deprecated use `ListInstanceOrganizationInvitationsRequest$outboundSchema` instead. */
  export const outboundSchema = ListInstanceOrganizationInvitationsRequest$outboundSchema;
...
export function listInstanceOrganizationInvitationsRequestToJSON(
  listInstanceOrganizationInvitationsRequest: ListInstanceOrganizationInvitationsRequest,
): string {
  return JSON.stringify(
    ListInstanceOrganizationInvitationsRequest$outboundSchema.parse(listInstanceOrganizationInvitationsRequest),
  );
}

export function listInstanceOrganizationInvitationsRequestFromJSON(
  jsonString: string,
): SafeParseResult<ListInstanceOrganizationInvitationsRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    x => ListInstanceOrganizationInvitationsRequest$inboundSchema.parse(JSON.parse(x)),
