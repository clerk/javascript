...
export namespace CreateOrganizationInvitationRequestBody$ {
  ...
  export const inboundSchema = CreateOrganizationInvitationRequestBody$inboundSchema;
  /** @deprecated use `CreateOrganizationInvitationRequestBody$outboundSchema` instead. */
  export const outboundSchema = CreateOrganizationInvitationRequestBody$outboundSchema;
...
export function createOrganizationInvitationRequestBodyToJSON(
  createOrganizationInvitationRequestBody: CreateOrganizationInvitationRequestBody,
): string {
  return JSON.stringify(
    CreateOrganizationInvitationRequestBody$outboundSchema.parse(createOrganizationInvitationRequestBody),
  );
}

export function createOrganizationInvitationRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<CreateOrganizationInvitationRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    x => CreateOrganizationInvitationRequestBody$inboundSchema.parse(JSON.parse(x)),
...
> = z
  .object({
    ...
    RequestBody: z.lazy(() => CreateOrganizationInvitationRequestBody$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    requestBody: z.lazy(() => CreateOrganizationInvitationRequestBody$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export namespace CreateOrganizationInvitationRequest$ {
  ...
  export const inboundSchema = CreateOrganizationInvitationRequest$inboundSchema;
  /** @deprecated use `CreateOrganizationInvitationRequest$outboundSchema` instead. */
  export const outboundSchema = CreateOrganizationInvitationRequest$outboundSchema;
...
export function createOrganizationInvitationRequestToJSON(
  ...
  return JSON.stringify(CreateOrganizationInvitationRequest$outboundSchema.parse(createOrganizationInvitationRequest));
}
...
export function createOrganizationInvitationRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    x => CreateOrganizationInvitationRequest$inboundSchema.parse(JSON.parse(x)),
