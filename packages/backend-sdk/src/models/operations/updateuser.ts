...
/** @internal */
export const UpdateUserRequestBody$inboundSchema: z.ZodType<UpdateUserRequestBody, z.ZodTypeDef, unknown> = z
  .object({
...
export function updateUserRequestBodyToJSON(updateUserRequestBody: UpdateUserRequestBody): string {
  return JSON.stringify(UpdateUserRequestBody$outboundSchema.parse(updateUserRequestBody));
}
...
/** @internal */
export const UpdateUserRequest$inboundSchema: z.ZodType<UpdateUserRequest, z.ZodTypeDef, unknown> = z
  .object({
    user_id: z.string(),
...
/** @internal */
export const UpdateUserRequest$outboundSchema: z.ZodType<UpdateUserRequest$Outbound, z.ZodTypeDef, UpdateUserRequest> =
  z
    .object({
      userId: z.string(),
...
export function updateUserRequestToJSON(updateUserRequest: UpdateUserRequest): string {
  return JSON.stringify(UpdateUserRequest$outboundSchema.parse(updateUserRequest));
}

export function updateUserRequestFromJSON(jsonString: string): SafeParseResult<UpdateUserRequest, SDKValidationError> {
  return safeParse(
    jsonString,
