...
export function verifyDomainProxyRequestBodyToJSON(verifyDomainProxyRequestBody: VerifyDomainProxyRequestBody): string {
  return JSON.stringify(VerifyDomainProxyRequestBody$outboundSchema.parse(verifyDomainProxyRequestBody));
}
