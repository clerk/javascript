...
export function createPhoneNumberRequestBodyToJSON(createPhoneNumberRequestBody: CreatePhoneNumberRequestBody): string {
  return JSON.stringify(CreatePhoneNumberRequestBody$outboundSchema.parse(createPhoneNumberRequestBody));
}
