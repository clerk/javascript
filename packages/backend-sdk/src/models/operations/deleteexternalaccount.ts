...
export function deleteExternalAccountRequestToJSON(deleteExternalAccountRequest: DeleteExternalAccountRequest): string {
  return JSON.stringify(DeleteExternalAccountRequest$outboundSchema.parse(deleteExternalAccountRequest));
}
