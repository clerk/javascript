...
/** @internal */
export const GetOAuthApplicationRequest$inboundSchema: z.ZodType<
...
export function getOAuthApplicationRequestToJSON(
  getOAuthApplicationRequest: GetOAuthApplicationRequest,
): string {
  return JSON.stringify(
    GetOAuthApplicationRequest$outboundSchema.parse(getOAuthApplicationRequest),
  );
}
