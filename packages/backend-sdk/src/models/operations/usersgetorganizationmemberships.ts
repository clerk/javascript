...
export namespace UsersGetOrganizationMembershipsRequest$ {
  ...
  export const inboundSchema = UsersGetOrganizationMembershipsRequest$inboundSchema;
  /** @deprecated use `UsersGetOrganizationMembershipsRequest$outboundSchema` instead. */
  export const outboundSchema = UsersGetOrganizationMembershipsRequest$outboundSchema;
...
export function usersGetOrganizationMembershipsRequestToJSON(
  usersGetOrganizationMembershipsRequest: UsersGetOrganizationMembershipsRequest,
): string {
  return JSON.stringify(
    UsersGetOrganizationMembershipsRequest$outboundSchema.parse(usersGetOrganizationMembershipsRequest),
  );
}
...
export function usersGetOrganizationMembershipsRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    x => UsersGetOrganizationMembershipsRequest$inboundSchema.parse(JSON.parse(x)),
