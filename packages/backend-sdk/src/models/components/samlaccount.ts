...
export type TicketVerificationSAMLAccountStatus = ClosedEnum<typeof TicketVerificationSAMLAccountStatus>;

export const TicketVerificationSAMLAccountStrategy = {
  Ticket: 'ticket',
} as const;
export type TicketVerificationSAMLAccountStrategy = OpenEnum<typeof TicketVerificationSAMLAccountStrategy>;
...
export type SAMLVerificationStrategy = ClosedEnum<typeof SAMLVerificationStrategy>;
...
/** @internal */
export const SAMLAccountObject$inboundSchema: z.ZodNativeEnum<typeof SAMLAccountObject> =
  z.nativeEnum(SAMLAccountObject);

/** @internal */
export const SAMLAccountObject$outboundSchema: z.ZodNativeEnum<typeof SAMLAccountObject> =
...
/** @internal */
export const TicketVerificationSAMLAccountStatus$outboundSchema: z.ZodNativeEnum<
  typeof TicketVerificationSAMLAccountStatus
...
export namespace TicketVerificationSAMLAccountStatus$ {
  ...
  export const inboundSchema = TicketVerificationSAMLAccountStatus$inboundSchema;
  /** @deprecated use `TicketVerificationSAMLAccountStatus$outboundSchema` instead. */
  export const outboundSchema = TicketVerificationSAMLAccountStatus$outboundSchema;
}
...
export const TicketVerificationSAMLAccountStrategy$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = z.union([z.nativeEnum(TicketVerificationSAMLAccountStrategy), z.string().transform(catchUnrecognizedEnum)]);
...
export const TicketVerificationSAMLAccountStrategy$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  TicketVerificationSAMLAccountStrategy
> = z.union([z.nativeEnum(TicketVerificationSAMLAccountStrategy), z.string().and(z.custom<Unrecognized<string>>())]);
...
export namespace TicketVerificationSAMLAccountStrategy$ {
  ...
  export const inboundSchema = TicketVerificationSAMLAccountStrategy$inboundSchema;
  /** @deprecated use `TicketVerificationSAMLAccountStrategy$outboundSchema` instead. */
  export const outboundSchema = TicketVerificationSAMLAccountStrategy$outboundSchema;
}

/** @internal */
export const VerificationTicket$inboundSchema: z.ZodType<VerificationTicket, z.ZodTypeDef, unknown> = z
  .object({
...
export function verificationTicketToJSON(verificationTicket: VerificationTicket): string {
  return JSON.stringify(VerificationTicket$outboundSchema.parse(verificationTicket));
}
...
/** @internal */
export const SAMLVerificationStatus$inboundSchema: z.ZodNativeEnum<typeof SAMLVerificationStatus> =
  z.nativeEnum(SAMLVerificationStatus);

/** @internal */
export const SAMLVerificationStatus$outboundSchema: z.ZodNativeEnum<typeof SAMLVerificationStatus> =
...
/** @internal */
export const SAMLVerificationStrategy$inboundSchema: z.ZodNativeEnum<typeof SAMLVerificationStrategy> =
  z.nativeEnum(SAMLVerificationStrategy);

/** @internal */
export const SAMLVerificationStrategy$outboundSchema: z.ZodNativeEnum<typeof SAMLVerificationStrategy> =
...
/** @internal */
export const ClerkErrorErrorMeta$inboundSchema: z.ZodType<ClerkErrorErrorMeta, z.ZodTypeDef, unknown> = z.object({});
...
export function clerkErrorErrorMetaToJSON(clerkErrorErrorMeta: ClerkErrorErrorMeta): string {
  return JSON.stringify(ClerkErrorErrorMeta$outboundSchema.parse(clerkErrorErrorMeta));
}
...
/** @internal */
export const SAMLErrorClerkError$inboundSchema: z.ZodType<SAMLErrorClerkError, z.ZodTypeDef, unknown> = z
  .object({
    message: z.string(),
...
export function samlErrorClerkErrorToJSON(samlErrorClerkError: SAMLErrorClerkError): string {
  return JSON.stringify(SAMLErrorClerkError$outboundSchema.parse(samlErrorClerkError));
}
...
/** @internal */
export const VerificationError$inboundSchema: z.ZodType<VerificationError, z.ZodTypeDef, unknown> = z.lazy(
  () => SAMLErrorClerkError$inboundSchema,
);
...
/** @internal */
export const VerificationError$outboundSchema: z.ZodType<VerificationError$Outbound, z.ZodTypeDef, VerificationError> =
...
export function verificationErrorToJSON(verificationError: VerificationError): string {
  return JSON.stringify(VerificationError$outboundSchema.parse(verificationError));
}

export function verificationErrorFromJSON(jsonString: string): SafeParseResult<VerificationError, SDKValidationError> {
  return safeParse(
    jsonString,
...
export const Saml$inboundSchema: z.ZodType<Saml, z.ZodTypeDef, unknown> = z
  .object({
    ...
    error: z.nullable(z.lazy(() => SAMLErrorClerkError$inboundSchema)).optional(),
...
/** @internal */
export const Saml$outboundSchema: z.ZodType<Saml$Outbound, z.ZodTypeDef, Saml> = z
  .object({
    ...
    error: z.nullable(z.lazy(() => SAMLErrorClerkError$outboundSchema)).optional(),
...
export function samlFromJSON(jsonString: string): SafeParseResult<Saml, SDKValidationError> {
  return safeParse(jsonString, x => Saml$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Saml' from JSON`);
}

/** @internal */
export const SAMLAccountVerification$inboundSchema: z.ZodType<SAMLAccountVerification, z.ZodTypeDef, unknown> = z.union(
  [z.lazy(() => VerificationTicket$inboundSchema), z.lazy(() => Saml$inboundSchema)],
);

/** @internal */
export type SAMLAccountVerification$Outbound = VerificationTicket$Outbound | Saml$Outbound;
...
> = z.union([z.lazy(() => VerificationTicket$outboundSchema), z.lazy(() => Saml$outboundSchema)]);
...
export function samlAccountVerificationToJSON(samlAccountVerification: SAMLAccountVerification): string {
  return JSON.stringify(SAMLAccountVerification$outboundSchema.parse(samlAccountVerification));
}
...
export function samlConnectionSAMLConnectionToJSON(samlConnectionSAMLConnection: SAMLConnectionSAMLConnection): string {
  return JSON.stringify(SAMLConnectionSAMLConnection$outboundSchema.parse(samlConnectionSAMLConnection));
}
...
/** @internal */
export const SamlConnection$inboundSchema: z.ZodType<SamlConnection, z.ZodTypeDef, unknown> = z.lazy(
  () => SAMLConnectionSAMLConnection$inboundSchema,
);
...
/** @internal */
export const SamlConnection$outboundSchema: z.ZodType<SamlConnection$Outbound, z.ZodTypeDef, SamlConnection> = z.lazy(
  () => SAMLConnectionSAMLConnection$outboundSchema,
);
...
export function samlConnectionFromJSON(jsonString: string): SafeParseResult<SamlConnection, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const SAMLAccount$inboundSchema: z.ZodType<SAMLAccount, z.ZodTypeDef, unknown> = z
  .object({
    id: z.string(),
    ...
    verification: z.nullable(
      z.union([z.lazy(() => VerificationTicket$inboundSchema), z.lazy(() => Saml$inboundSchema)]),
    ),
    saml_connection: z.nullable(z.lazy(() => SAMLConnectionSAMLConnection$inboundSchema)).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
/** @internal */
export const SAMLAccount$outboundSchema: z.ZodType<SAMLAccount$Outbound, z.ZodTypeDef, SAMLAccount> = z
  .object({
    id: z.string(),
    ...
    samlConnection: z.nullable(z.lazy(() => SAMLConnectionSAMLConnection$outboundSchema)).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function samlAccountFromJSON(jsonString: string): SafeParseResult<SAMLAccount, SDKValidationError> {
  return safeParse(
    jsonString,
