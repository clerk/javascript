...
/** @internal */
export const OrganizationInvitations$inboundSchema: z.ZodType<OrganizationInvitations, z.ZodTypeDef, unknown> = z
  .object({
...
export function organizationInvitationsToJSON(organizationInvitations: OrganizationInvitations): string {
  return JSON.stringify(OrganizationInvitations$outboundSchema.parse(organizationInvitations));
}
