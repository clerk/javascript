 ...
 * @remarks
 */
export type OrganizationDomainObject = ClosedEnum<typeof OrganizationDomainObject>;
 ...
 * Status of the verification. It can be `unverified` or `verified`
 */
export type OrganizationDomainStatus = ClosedEnum<typeof OrganizationDomainStatus>;
...
/** @internal */
export const OrganizationDomainObject$inboundSchema: z.ZodNativeEnum<typeof OrganizationDomainObject> =
  z.nativeEnum(OrganizationDomainObject);

/** @internal */
export const OrganizationDomainObject$outboundSchema: z.ZodNativeEnum<typeof OrganizationDomainObject> =
...
/** @internal */
export const EnrollmentMode$inboundSchema: z.ZodNativeEnum<typeof EnrollmentMode> = z.nativeEnum(EnrollmentMode);

/** @internal */
export const EnrollmentMode$outboundSchema: z.ZodNativeEnum<typeof EnrollmentMode> = EnrollmentMode$inboundSchema;
...
/** @internal */
export const OrganizationDomainStatus$inboundSchema: z.ZodNativeEnum<typeof OrganizationDomainStatus> =
  z.nativeEnum(OrganizationDomainStatus);

/** @internal */
export const OrganizationDomainStatus$outboundSchema: z.ZodNativeEnum<typeof OrganizationDomainStatus> =
...
export function organizationDomainVerificationToJSON(
  ...
  return JSON.stringify(OrganizationDomainVerification$outboundSchema.parse(organizationDomainVerification));
}
...
/** @internal */
export const OrganizationDomain$inboundSchema: z.ZodType<OrganizationDomain, z.ZodTypeDef, unknown> = z
  .object({
    ...
    verification: z.nullable(z.lazy(() => OrganizationDomainVerification$inboundSchema)),
...
> = z
  .object({
    ...
    verification: z.nullable(z.lazy(() => OrganizationDomainVerification$outboundSchema)),
...
export function organizationDomainToJSON(organizationDomain: OrganizationDomain): string {
  return JSON.stringify(OrganizationDomain$outboundSchema.parse(organizationDomain));
}
