...
export type SchemasSAMLConnectionObject = ClosedEnum<typeof SchemasSAMLConnectionObject>;
...
/** @internal */
export const SchemasSAMLConnectionObject$inboundSchema: z.ZodNativeEnum<typeof SchemasSAMLConnectionObject> =
  z.nativeEnum(SchemasSAMLConnectionObject);

/** @internal */
export const SchemasSAMLConnectionObject$outboundSchema: z.ZodNativeEnum<typeof SchemasSAMLConnectionObject> =
...
/** @internal */
export const SchemasSAMLConnection$inboundSchema: z.ZodType<SchemasSAMLConnection, z.ZodTypeDef, unknown> = z
  .object({
...
export function schemasSAMLConnectionToJSON(schemasSAMLConnection: SchemasSAMLConnection): string {
  return JSON.stringify(SchemasSAMLConnection$outboundSchema.parse(schemasSAMLConnection));
}
