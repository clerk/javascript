...
/** @internal */
export const JWKSEcdsaPublicKeyKty$inboundSchema: z.ZodNativeEnum<
  typeof JWKSEcdsaPublicKeyKty
> = z.nativeEnum(JWKSEcdsaPublicKeyKty);

/** @internal */
export const JWKSEcdsaPublicKeyKty$outboundSchema: z.ZodNativeEnum<
  typeof JWKSEcdsaPublicKeyKty
...
/** @internal */
export const JWKSEcdsaPublicKey$inboundSchema: z.ZodType<
  JWKSEcdsaPublicKey,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function jwksEcdsaPublicKeyToJSON(
  jwksEcdsaPublicKey: JWKSEcdsaPublicKey,
): string {
  return JSON.stringify(
    JWKSEcdsaPublicKey$outboundSchema.parse(jwksEcdsaPublicKey),
  );
}
