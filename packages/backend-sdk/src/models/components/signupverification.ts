...
/** @internal */
export const NextAction$inboundSchema: z.ZodNativeEnum<typeof NextAction> = z.nativeEnum(NextAction);

/** @internal */
export const NextAction$outboundSchema: z.ZodNativeEnum<typeof NextAction> = NextAction$inboundSchema;
...
/** @internal */
export const SignUpVerification$inboundSchema: z.ZodType<SignUpVerification, z.ZodTypeDef, unknown> = collectExtraKeys$(
  z
    .object({
...
export function signUpVerificationToJSON(signUpVerification: SignUpVerification): string {
  return JSON.stringify(SignUpVerification$outboundSchema.parse(signUpVerification));
}
