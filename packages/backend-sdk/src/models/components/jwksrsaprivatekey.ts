...
/** @internal */
export const JWKSRsaPrivateKeyKty$inboundSchema: z.ZodNativeEnum<
  typeof JWKSRsaPrivateKeyKty
> = z.nativeEnum(JWKSRsaPrivateKeyKty);

/** @internal */
export const JWKSRsaPrivateKeyKty$outboundSchema: z.ZodNativeEnum<
  typeof JWKSRsaPrivateKeyKty
...
/** @internal */
export const JWKSRsaPrivateKey$inboundSchema: z.ZodType<
  JWKSRsaPrivateKey,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const JWKSRsaPrivateKey$outboundSchema: z.ZodType<
...
export function jwksRsaPrivateKeyToJSON(
  jwksRsaPrivateKey: JWKSRsaPrivateKey,
): string {
  return JSON.stringify(
    JWKSRsaPrivateKey$outboundSchema.parse(jwksRsaPrivateKey),
  );
}

export function jwksRsaPrivateKeyFromJSON(
  jsonString: string,
): SafeParseResult<JWKSRsaPrivateKey, SDKValidationError> {
  return safeParse(
    jsonString,
