...
export type AdminVerificationWeb3WalletStatus = ClosedEnum<typeof AdminVerificationWeb3WalletStatus>;

export const AdminVerificationWeb3WalletStrategy = {
  Admin: 'admin',
} as const;
export type AdminVerificationWeb3WalletStrategy = OpenEnum<typeof AdminVerificationWeb3WalletStrategy>;
...
export type Web3SignatureVerificationStatus = ClosedEnum<typeof Web3SignatureVerificationStatus>;
...
export type Web3SignatureVerificationStrategy = ClosedEnum<typeof Web3SignatureVerificationStrategy>;
...
export type Web3WalletVerification = Web3WalletVerificationAdmin | Web3Signature;
...
/** @internal */
export const Web3WalletObject$inboundSchema: z.ZodNativeEnum<typeof Web3WalletObject> = z.nativeEnum(Web3WalletObject);

/** @internal */
export const Web3WalletObject$outboundSchema: z.ZodNativeEnum<typeof Web3WalletObject> = Web3WalletObject$inboundSchema;
...
export namespace AdminVerificationWeb3WalletStatus$ {
  ...
  export const outboundSchema = AdminVerificationWeb3WalletStatus$outboundSchema;
}
...
export const AdminVerificationWeb3WalletStrategy$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = z.union([z.nativeEnum(AdminVerificationWeb3WalletStrategy), z.string().transform(catchUnrecognizedEnum)]);
...
export const AdminVerificationWeb3WalletStrategy$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  AdminVerificationWeb3WalletStrategy
> = z.union([z.nativeEnum(AdminVerificationWeb3WalletStrategy), z.string().and(z.custom<Unrecognized<string>>())]);
...
export namespace AdminVerificationWeb3WalletStrategy$ {
  ...
  export const inboundSchema = AdminVerificationWeb3WalletStrategy$inboundSchema;
  /** @deprecated use `AdminVerificationWeb3WalletStrategy$outboundSchema` instead. */
  export const outboundSchema = AdminVerificationWeb3WalletStrategy$outboundSchema;
}

/** @internal */
export const Web3WalletVerificationAdmin$inboundSchema: z.ZodType<Web3WalletVerificationAdmin, z.ZodTypeDef, unknown> =
  z
    .object({
...
export function web3WalletVerificationAdminToJSON(web3WalletVerificationAdmin: Web3WalletVerificationAdmin): string {
  return JSON.stringify(Web3WalletVerificationAdmin$outboundSchema.parse(web3WalletVerificationAdmin));
}
...
/** @internal */
export const Web3SignatureVerificationStatus$inboundSchema: z.ZodNativeEnum<typeof Web3SignatureVerificationStatus> =
  z.nativeEnum(Web3SignatureVerificationStatus);

/** @internal */
export const Web3SignatureVerificationStatus$outboundSchema: z.ZodNativeEnum<typeof Web3SignatureVerificationStatus> =
...
export namespace Web3SignatureVerificationStrategy$ {
  ...
  export const outboundSchema = Web3SignatureVerificationStrategy$outboundSchema;
}

/** @internal */
export const Web3Signature$inboundSchema: z.ZodType<Web3Signature, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const Web3Signature$outboundSchema: z.ZodType<Web3Signature$Outbound, z.ZodTypeDef, Web3Signature> = z
  .object({
...
export function web3SignatureFromJSON(jsonString: string): SafeParseResult<Web3Signature, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const Web3WalletVerification$inboundSchema: z.ZodType<Web3WalletVerification, z.ZodTypeDef, unknown> = z.union([
  z.lazy(() => Web3WalletVerificationAdmin$inboundSchema),
  z.lazy(() => Web3Signature$inboundSchema),
]);

/** @internal */
export type Web3WalletVerification$Outbound = Web3WalletVerificationAdmin$Outbound | Web3Signature$Outbound;
...
> = z.union([z.lazy(() => Web3WalletVerificationAdmin$outboundSchema), z.lazy(() => Web3Signature$outboundSchema)]);
...
export function web3WalletVerificationToJSON(web3WalletVerification: Web3WalletVerification): string {
  return JSON.stringify(Web3WalletVerification$outboundSchema.parse(web3WalletVerification));
}
...
/** @internal */
export const Web3Wallet$inboundSchema: z.ZodType<Web3Wallet, z.ZodTypeDef, unknown> = z
  .object({
    id: z.string().optional(),
    object: Web3WalletObject$inboundSchema,
    web3_wallet: z.string(),
    verification: z.nullable(
      z.union([z.lazy(() => Web3WalletVerificationAdmin$inboundSchema), z.lazy(() => Web3Signature$inboundSchema)]),
    ),
...
export type Web3Wallet$Outbound = {
  ...
  object: string;
  web3_wallet: string;
  verification: Web3WalletVerificationAdmin$Outbound | Web3Signature$Outbound | null;
  created_at: number;
  updated_at: number;
};

/** @internal */
export const Web3Wallet$outboundSchema: z.ZodType<Web3Wallet$Outbound, z.ZodTypeDef, Web3Wallet> = z
  .object({
    id: z.string().optional(),
...
export function web3WalletFromJSON(jsonString: string): SafeParseResult<Web3Wallet, SDKValidationError> {
  return safeParse(
    jsonString,
