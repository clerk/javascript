...
export type OrganizationInvitationWithPublicOrganizationData = {
   ...
   */
  updatedAt: number;
  publicOrganizationData?: OrganizationInvitationPublicOrganizationData | undefined;
};

/** @internal */
export const OrganizationInvitationWithPublicOrganizationDataObject$inboundSchema: z.ZodNativeEnum<
  typeof OrganizationInvitationWithPublicOrganizationDataObject
> = z.nativeEnum(OrganizationInvitationWithPublicOrganizationDataObject);

/** @internal */
export const OrganizationInvitationWithPublicOrganizationDataObject$outboundSchema: z.ZodNativeEnum<
  typeof OrganizationInvitationWithPublicOrganizationDataObject
...
export namespace OrganizationInvitationWithPublicOrganizationDataObject$ {
  ...
  export const inboundSchema = OrganizationInvitationWithPublicOrganizationDataObject$inboundSchema;
  /** @deprecated use `OrganizationInvitationWithPublicOrganizationDataObject$outboundSchema` instead. */
  export const outboundSchema = OrganizationInvitationWithPublicOrganizationDataObject$outboundSchema;
}

/** @internal */
export const OrganizationInvitationWithPublicOrganizationData$inboundSchema: z.ZodType<
  OrganizationInvitationWithPublicOrganizationData,
  z.ZodTypeDef,
  unknown
> = z
  .object({
    object: OrganizationInvitationWithPublicOrganizationDataObject$inboundSchema,
    id: z.string(),
    ...
    public_organization_data: OrganizationInvitationPublicOrganizationData$inboundSchema.optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export type OrganizationInvitationWithPublicOrganizationData$Outbound = {
  ...
  created_at: number;
  updated_at: number;
  public_organization_data?: OrganizationInvitationPublicOrganizationData$Outbound | undefined;
};

/** @internal */
export const OrganizationInvitationWithPublicOrganizationData$outboundSchema: z.ZodType<
  OrganizationInvitationWithPublicOrganizationData$Outbound,
  z.ZodTypeDef,
  OrganizationInvitationWithPublicOrganizationData
> = z
  .object({
    object: OrganizationInvitationWithPublicOrganizationDataObject$outboundSchema,
    id: z.string(),
    ...
    publicOrganizationData: OrganizationInvitationPublicOrganizationData$outboundSchema.optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export namespace OrganizationInvitationWithPublicOrganizationData$ {
  ...
  export const inboundSchema = OrganizationInvitationWithPublicOrganizationData$inboundSchema;
  /** @deprecated use `OrganizationInvitationWithPublicOrganizationData$outboundSchema` instead. */
  export const outboundSchema = OrganizationInvitationWithPublicOrganizationData$outboundSchema;
  /** @deprecated use `OrganizationInvitationWithPublicOrganizationData$Outbound` instead. */
  export type Outbound = OrganizationInvitationWithPublicOrganizationData$Outbound;
}
...
export function organizationInvitationWithPublicOrganizationDataFromJSON(
  jsonString: string,
): SafeParseResult<OrganizationInvitationWithPublicOrganizationData, SDKValidationError> {
  return safeParse(
    jsonString,
    x => OrganizationInvitationWithPublicOrganizationData$inboundSchema.parse(JSON.parse(x)),
