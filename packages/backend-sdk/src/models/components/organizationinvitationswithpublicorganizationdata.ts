...
/** @internal */
export const OrganizationInvitationsWithPublicOrganizationData$inboundSchema:
  z.ZodType<
...
/** @internal */
export const OrganizationInvitationsWithPublicOrganizationData$outboundSchema:
  z.ZodType<
...
export namespace OrganizationInvitationsWithPublicOrganizationData$ {
  ...
  export const outboundSchema =
    OrganizationInvitationsWithPublicOrganizationData$outboundSchema;
...
> {
  return safeParse(
    jsonString,
    (x) =>
      OrganizationInvitationsWithPublicOrganizationData$inboundSchema.parse(
        JSON.parse(x),
      ),
