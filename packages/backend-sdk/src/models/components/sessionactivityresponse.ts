...
/** @internal */
export const SessionActivityResponse$inboundSchema: z.ZodType<
...
export function sessionActivityResponseToJSON(
  sessionActivityResponse: SessionActivityResponse,
): string {
  return JSON.stringify(
    SessionActivityResponse$outboundSchema.parse(sessionActivityResponse),
  );
}
