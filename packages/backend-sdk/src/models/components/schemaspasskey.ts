...
export type PasskeyVerificationStatus = ClosedEnum<
  typeof PasskeyVerificationStatus
>;

export const PasskeyVerificationStrategy = {
  Passkey: "passkey",
} as const;
export type PasskeyVerificationStrategy = ClosedEnum<
  typeof PasskeyVerificationStrategy
>;
...
/** @internal */
export const SchemasPasskeyObject$inboundSchema: z.ZodNativeEnum<
  typeof SchemasPasskeyObject
> = z.nativeEnum(SchemasPasskeyObject);

/** @internal */
export const SchemasPasskeyObject$outboundSchema: z.ZodNativeEnum<
  typeof SchemasPasskeyObject
...
/** @internal */
export const PasskeyVerificationStatus$inboundSchema: z.ZodNativeEnum<
  typeof PasskeyVerificationStatus
> = z.nativeEnum(PasskeyVerificationStatus);

/** @internal */
export const PasskeyVerificationStatus$outboundSchema: z.ZodNativeEnum<
  typeof PasskeyVerificationStatus
...
/** @internal */
export const PasskeyVerificationStrategy$inboundSchema: z.ZodNativeEnum<
  typeof PasskeyVerificationStrategy
> = z.nativeEnum(PasskeyVerificationStrategy);

/** @internal */
export const PasskeyVerificationStrategy$outboundSchema: z.ZodNativeEnum<
  typeof PasskeyVerificationStrategy
...
/** @internal */
export const Nonce$inboundSchema: z.ZodNativeEnum<typeof Nonce> = z.nativeEnum(
  Nonce,
);

/** @internal */
export const Nonce$outboundSchema: z.ZodNativeEnum<typeof Nonce> =
  Nonce$inboundSchema;
...
/** @internal */
export const SchemasPasskeyVerification$inboundSchema: z.ZodType<
...
export function schemasPasskeyVerificationToJSON(
  schemasPasskeyVerification: SchemasPasskeyVerification,
): string {
  return JSON.stringify(
    SchemasPasskeyVerification$outboundSchema.parse(schemasPasskeyVerification),
  );
}
...
/** @internal */
export const SchemasPasskey$inboundSchema: z.ZodType<
  SchemasPasskey,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const SchemasPasskey$outboundSchema: z.ZodType<
...
export function schemasPasskeyFromJSON(
  jsonString: string,
): SafeParseResult<SchemasPasskey, SDKValidationError> {
  return safeParse(
    jsonString,
