...
/** @internal */
export const Keys$inboundSchema: z.ZodType<Keys, z.ZodTypeDef, unknown> = z.union([
  JWKSSymmetricKey$inboundSchema,
  JWKSEd25519PublicKey$inboundSchema,
  JWKSRsaPublicKey$inboundSchema,
  JWKSEcdsaPublicKey$inboundSchema,
...
/** @internal */
export const Keys$outboundSchema: z.ZodType<Keys$Outbound, z.ZodTypeDef, Keys> = z.union([
  JWKSSymmetricKey$outboundSchema,
  JWKSEd25519PublicKey$outboundSchema,
  JWKSRsaPublicKey$outboundSchema,
  JWKSEcdsaPublicKey$outboundSchema,
...
export function keysFromJSON(jsonString: string): SafeParseResult<Keys, SDKValidationError> {
  return safeParse(jsonString, x => Keys$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Keys' from JSON`);
}

/** @internal */
export const Jwks$inboundSchema: z.ZodType<Jwks, z.ZodTypeDef, unknown> = z.object({
  keys: z
    .array(
      z.union([
        JWKSSymmetricKey$inboundSchema,
...
/** @internal */
export const Jwks$outboundSchema: z.ZodType<Jwks$Outbound, z.ZodTypeDef, Jwks> = z.object({
  keys: z
    .array(
      z.union([
        JWKSSymmetricKey$outboundSchema,
...
export function jwksFromJSON(jsonString: string): SafeParseResult<Jwks, SDKValidationError> {
  return safeParse(jsonString, x => Jwks$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Jwks' from JSON`);
}
