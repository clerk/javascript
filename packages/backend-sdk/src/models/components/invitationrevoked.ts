...
export type InvitationRevokedObject = ClosedEnum<typeof InvitationRevokedObject>;

export const InvitationRevokedStatus = {
  Revoked: 'revoked',
} as const;
export type InvitationRevokedStatus = ClosedEnum<typeof InvitationRevokedStatus>;
...
/** @internal */
export const InvitationRevokedObject$inboundSchema: z.ZodNativeEnum<typeof InvitationRevokedObject> =
  z.nativeEnum(InvitationRevokedObject);

/** @internal */
export const InvitationRevokedObject$outboundSchema: z.ZodNativeEnum<typeof InvitationRevokedObject> =
...
/** @internal */
export const InvitationRevokedStatus$inboundSchema: z.ZodNativeEnum<typeof InvitationRevokedStatus> =
  z.nativeEnum(InvitationRevokedStatus);

/** @internal */
export const InvitationRevokedStatus$outboundSchema: z.ZodNativeEnum<typeof InvitationRevokedStatus> =
...
/** @internal */
export const InvitationRevoked$inboundSchema: z.ZodType<InvitationRevoked, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const InvitationRevoked$outboundSchema: z.ZodType<InvitationRevoked$Outbound, z.ZodTypeDef, InvitationRevoked> =
  z
    .object({
...
export function invitationRevokedToJSON(invitationRevoked: InvitationRevoked): string {
  return JSON.stringify(InvitationRevoked$outboundSchema.parse(invitationRevoked));
}

export function invitationRevokedFromJSON(jsonString: string): SafeParseResult<InvitationRevoked, SDKValidationError> {
  return safeParse(
    jsonString,
