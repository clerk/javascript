...
/** @internal */
export const DeletedObject$inboundSchema: z.ZodType<
  DeletedObject,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const DeletedObject$outboundSchema: z.ZodType<
  DeletedObject$Outbound,
  z.ZodTypeDef,
  DeletedObject
> = z.object({
  object: z.string(),
...
export function deletedObjectFromJSON(
  jsonString: string,
): SafeParseResult<DeletedObject, SDKValidationError> {
  return safeParse(
    jsonString,
