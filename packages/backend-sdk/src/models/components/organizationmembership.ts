 ...
 * @remarks
 */
export type OrganizationMembershipObject = ClosedEnum<typeof OrganizationMembershipObject>;

export const OrganizationMembershipOrganizationObject = {
  Organization: 'organization',
} as const;
export type OrganizationMembershipOrganizationObject = ClosedEnum<typeof OrganizationMembershipOrganizationObject>;
...
/** @internal */
export const OrganizationMembershipObject$inboundSchema: z.ZodNativeEnum<typeof OrganizationMembershipObject> =
  z.nativeEnum(OrganizationMembershipObject);

/** @internal */
export const OrganizationMembershipObject$outboundSchema: z.ZodNativeEnum<typeof OrganizationMembershipObject> =
...
/** @internal */
export const OrganizationMembershipOrganizationObject$inboundSchema: z.ZodNativeEnum<
  typeof OrganizationMembershipOrganizationObject
> = z.nativeEnum(OrganizationMembershipOrganizationObject);

/** @internal */
export const OrganizationMembershipOrganizationObject$outboundSchema: z.ZodNativeEnum<
  typeof OrganizationMembershipOrganizationObject
...
export namespace OrganizationMembershipOrganizationObject$ {
  ...
  export const inboundSchema = OrganizationMembershipOrganizationObject$inboundSchema;
  /** @deprecated use `OrganizationMembershipOrganizationObject$outboundSchema` instead. */
  export const outboundSchema = OrganizationMembershipOrganizationObject$outboundSchema;
}
...
export namespace OrganizationMembershipOrganization$ {
  ...
  export const outboundSchema = OrganizationMembershipOrganization$outboundSchema;
...
export function organizationMembershipOrganizationToJSON(
  ...
  return JSON.stringify(OrganizationMembershipOrganization$outboundSchema.parse(organizationMembershipOrganization));
}
...
export function organizationMembershipOrganizationFromJSON(
  ...
  return safeParse(
    jsonString,
    x => OrganizationMembershipOrganization$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'OrganizationMembershipOrganization' from JSON`,
  );
}

/** @internal */
export const OrganizationMembership$inboundSchema: z.ZodType<OrganizationMembership, z.ZodTypeDef, unknown> = z
  .object({
    id: z.string(),
    ...
    public_user_data: OrganizationMembershipPublicUserData$inboundSchema.optional(),
    created_at: z.number().int(),
    updated_at: z.number().int(),
  })
  .transform(v => {
...
> = z
  .object({
    ...
    publicUserData: OrganizationMembershipPublicUserData$outboundSchema.optional(),
    createdAt: z.number().int(),
    updatedAt: z.number().int(),
  })
  .transform(v => {
...
export function organizationMembershipToJSON(organizationMembership: OrganizationMembership): string {
