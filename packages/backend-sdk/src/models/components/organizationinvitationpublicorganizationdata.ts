...
/** @internal */
export const OrganizationInvitationPublicOrganizationData$inboundSchema: z.ZodType<
...
/** @internal */
export const OrganizationInvitationPublicOrganizationData$outboundSchema: z.ZodType<
...
export namespace OrganizationInvitationPublicOrganizationData$ {
  ...
  export const inboundSchema = OrganizationInvitationPublicOrganizationData$inboundSchema;
  /** @deprecated use `OrganizationInvitationPublicOrganizationData$outboundSchema` instead. */
  export const outboundSchema = OrganizationInvitationPublicOrganizationData$outboundSchema;
...
export function organizationInvitationPublicOrganizationDataToJSON(
  ...
  return JSON.stringify(
    OrganizationInvitationPublicOrganizationData$outboundSchema.parse(organizationInvitationPublicOrganizationData),
  );
}

export function organizationInvitationPublicOrganizationDataFromJSON(
  jsonString: string,
): SafeParseResult<OrganizationInvitationPublicOrganizationData, SDKValidationError> {
  return safeParse(
    jsonString,
    x => OrganizationInvitationPublicOrganizationData$inboundSchema.parse(JSON.parse(x)),
