...
/** @internal */
export const SignInTokenObject$inboundSchema: z.ZodNativeEnum<typeof SignInTokenObject> =
  z.nativeEnum(SignInTokenObject);

/** @internal */
export const SignInTokenObject$outboundSchema: z.ZodNativeEnum<typeof SignInTokenObject> =
...
/** @internal */
export const SignInTokenStatus$inboundSchema: z.ZodNativeEnum<typeof SignInTokenStatus> =
  z.nativeEnum(SignInTokenStatus);

/** @internal */
export const SignInTokenStatus$outboundSchema: z.ZodNativeEnum<typeof SignInTokenStatus> =
...
/** @internal */
export const SignInToken$inboundSchema: z.ZodType<SignInToken, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const SignInToken$outboundSchema: z.ZodType<SignInToken$Outbound, z.ZodTypeDef, SignInToken> = z
  .object({
...
export function signInTokenFromJSON(jsonString: string): SafeParseResult<SignInToken, SDKValidationError> {
  return safeParse(
    jsonString,
