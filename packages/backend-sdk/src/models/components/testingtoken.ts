...
/** @internal */
export const TestingTokenObject$inboundSchema: z.ZodNativeEnum<typeof TestingTokenObject> =
  z.nativeEnum(TestingTokenObject);

/** @internal */
export const TestingTokenObject$outboundSchema: z.ZodNativeEnum<typeof TestingTokenObject> =
...
/** @internal */
export const TestingToken$inboundSchema: z.ZodType<TestingToken, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const TestingToken$outboundSchema: z.ZodType<TestingToken$Outbound, z.ZodTypeDef, TestingToken> = z
  .object({
...
export function testingTokenFromJSON(jsonString: string): SafeParseResult<TestingToken, SDKValidationError> {
  return safeParse(
    jsonString,
