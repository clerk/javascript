...
/** @internal */
export const SAMLConnections$inboundSchema: z.ZodType<SAMLConnections, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const SAMLConnections$outboundSchema: z.ZodType<SAMLConnections$Outbound, z.ZodTypeDef, SAMLConnections> = z
  .object({
...
export function samlConnectionsToJSON(samlConnections: SAMLConnections): string {
  return JSON.stringify(SAMLConnections$outboundSchema.parse(samlConnections));
}

export function samlConnectionsFromJSON(jsonString: string): SafeParseResult<SAMLConnections, SDKValidationError> {
  return safeParse(
    jsonString,
