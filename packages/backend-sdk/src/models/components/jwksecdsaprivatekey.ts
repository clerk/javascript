...
/** @internal */
export const JWKSEcdsaPrivateKeyKty$inboundSchema: z.ZodNativeEnum<typeof JWKSEcdsaPrivateKeyKty> =
  z.nativeEnum(JWKSEcdsaPrivateKeyKty);

/** @internal */
export const JWKSEcdsaPrivateKeyKty$outboundSchema: z.ZodNativeEnum<typeof JWKSEcdsaPrivateKeyKty> =
...
/** @internal */
export const JWKSEcdsaPrivateKey$inboundSchema: z.ZodType<JWKSEcdsaPrivateKey, z.ZodTypeDef, unknown> = z
  .object({
    kid: z.string(),
    alg: z.string(),
    use: z.string(),
...
export function jwksEcdsaPrivateKeyToJSON(jwksEcdsaPrivateKey: JWKSEcdsaPrivateKey): string {
  return JSON.stringify(JWKSEcdsaPrivateKey$outboundSchema.parse(jwksEcdsaPrivateKey));
}
