...
/** @internal */
export const SessionObject$inboundSchema: z.ZodNativeEnum<typeof SessionObject> = z.nativeEnum(SessionObject);

/** @internal */
export const SessionObject$outboundSchema: z.ZodNativeEnum<typeof SessionObject> = SessionObject$inboundSchema;
...
/** @internal */
export const Actor$inboundSchema: z.ZodType<Actor, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type Actor$Outbound = {};

/** @internal */
export const Actor$outboundSchema: z.ZodType<Actor$Outbound, z.ZodTypeDef, Actor> = z.object({});
...
export const Session$inboundSchema: z.ZodType<Session, z.ZodTypeDef, unknown> = z
  .object({
    ...
    latest_activity: z.nullable(SessionActivityResponse$inboundSchema).optional(),
...
export function sessionFromJSON(jsonString: string): SafeParseResult<Session, SDKValidationError> {
  return safeParse(jsonString, x => Session$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Session' from JSON`);
}
