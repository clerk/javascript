...
/** @internal */
export const SignUpObject$inboundSchema: z.ZodNativeEnum<typeof SignUpObject> = z.nativeEnum(SignUpObject);

/** @internal */
export const SignUpObject$outboundSchema: z.ZodNativeEnum<typeof SignUpObject> = SignUpObject$inboundSchema;
...
/** @internal */
export const SignUpStatus$inboundSchema: z.ZodNativeEnum<typeof SignUpStatus> = z.nativeEnum(SignUpStatus);

/** @internal */
export const SignUpStatus$outboundSchema: z.ZodNativeEnum<typeof SignUpStatus> = SignUpStatus$inboundSchema;
...
/** @internal */
export const SignUpExternalAccount$inboundSchema: z.ZodType<SignUpExternalAccount, z.ZodTypeDef, unknown> = z.object(
  {},
);
...
export function signUpExternalAccountToJSON(signUpExternalAccount: SignUpExternalAccount): string {
  return JSON.stringify(SignUpExternalAccount$outboundSchema.parse(signUpExternalAccount));
}
...
export const SignUp$inboundSchema: z.ZodType<SignUp, z.ZodTypeDef, unknown> = z
  .object({
    ...
    external_account: z.lazy(() => SignUpExternalAccount$inboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
/** @internal */
export const SignUp$outboundSchema: z.ZodType<SignUp$Outbound, z.ZodTypeDef, SignUp> = z
  .object({
    ...
    externalAccount: z.lazy(() => SignUpExternalAccount$outboundSchema).optional(),
  })
  .transform(v => {
    return remap$(v, {
...
export function signUpFromJSON(jsonString: string): SafeParseResult<SignUp, SDKValidationError> {
  return safeParse(jsonString, x => SignUp$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'SignUp' from JSON`);
}
