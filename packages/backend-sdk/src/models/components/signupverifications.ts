...
/** @internal */
export const ExternalAccount$inboundSchema: z.ZodType<ExternalAccount, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type ExternalAccount$Outbound = {};

/** @internal */
export const ExternalAccount$outboundSchema: z.ZodType<ExternalAccount$Outbound, z.ZodTypeDef, ExternalAccount> =
  z.object({});
...
export function externalAccountToJSON(externalAccount: ExternalAccount): string {
  return JSON.stringify(ExternalAccount$outboundSchema.parse(externalAccount));
}

export function externalAccountFromJSON(jsonString: string): SafeParseResult<ExternalAccount, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const SignUpVerifications$inboundSchema: z.ZodType<SignUpVerifications, z.ZodTypeDef, unknown> = z
  .object({
...
export function signUpVerificationsToJSON(signUpVerifications: SignUpVerifications): string {
  return JSON.stringify(SignUpVerifications$outboundSchema.parse(signUpVerifications));
}
