...
export namespace OrganizationMembershipPublicUserData$ {
  ...
  export const inboundSchema = OrganizationMembershipPublicUserData$inboundSchema;
  /** @deprecated use `OrganizationMembershipPublicUserData$outboundSchema` instead. */
  export const outboundSchema = OrganizationMembershipPublicUserData$outboundSchema;
...
export function organizationMembershipPublicUserDataToJSON(
  ...
  return JSON.stringify(
    OrganizationMembershipPublicUserData$outboundSchema.parse(organizationMembershipPublicUserData),
  );
}
...
export function organizationMembershipPublicUserDataFromJSON(
  ...
  return safeParse(
    jsonString,
    x => OrganizationMembershipPublicUserData$inboundSchema.parse(JSON.parse(x)),
