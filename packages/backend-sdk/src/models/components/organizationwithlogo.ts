...
export type OrganizationWithLogoObject = ClosedEnum<
  typeof OrganizationWithLogoObject
>;
...
/** @internal */
export const OrganizationWithLogoObject$inboundSchema: z.ZodNativeEnum<
  typeof OrganizationWithLogoObject
> = z.nativeEnum(OrganizationWithLogoObject);

/** @internal */
export const OrganizationWithLogoObject$outboundSchema: z.ZodNativeEnum<
  typeof OrganizationWithLogoObject
...
/** @internal */
export const OrganizationWithLogo$inboundSchema: z.ZodType<
...
export function organizationWithLogoToJSON(
  organizationWithLogo: OrganizationWithLogo,
): string {
  return JSON.stringify(
    OrganizationWithLogo$outboundSchema.parse(organizationWithLogo),
  );
}
