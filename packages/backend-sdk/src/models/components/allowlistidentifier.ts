 ...
 * @remarks
 */
export type AllowlistIdentifierObject = ClosedEnum<typeof AllowlistIdentifierObject>;
...
/** @internal */
export const AllowlistIdentifierObject$inboundSchema: z.ZodNativeEnum<typeof AllowlistIdentifierObject> =
  z.nativeEnum(AllowlistIdentifierObject);

/** @internal */
export const AllowlistIdentifierObject$outboundSchema: z.ZodNativeEnum<typeof AllowlistIdentifierObject> =
...
/** @internal */
export const IdentifierType$inboundSchema: z.ZodNativeEnum<typeof IdentifierType> = z.nativeEnum(IdentifierType);

/** @internal */
export const IdentifierType$outboundSchema: z.ZodNativeEnum<typeof IdentifierType> = IdentifierType$inboundSchema;
...
/** @internal */
export const AllowlistIdentifier$inboundSchema: z.ZodType<AllowlistIdentifier, z.ZodTypeDef, unknown> = z
  .object({
...
export function allowlistIdentifierToJSON(allowlistIdentifier: AllowlistIdentifier): string {
  return JSON.stringify(AllowlistIdentifier$outboundSchema.parse(allowlistIdentifier));
}
