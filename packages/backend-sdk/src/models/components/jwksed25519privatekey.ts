...
export type JWKSEd25519PrivateKeyKty = ClosedEnum<typeof JWKSEd25519PrivateKeyKty>;

export const JWKSEd25519PrivateKeyCrv = {
  Ed25519: 'Ed25519',
} as const;
export type JWKSEd25519PrivateKeyCrv = ClosedEnum<typeof JWKSEd25519PrivateKeyCrv>;
...
/** @internal */
export const JWKSEd25519PrivateKeyKty$inboundSchema: z.ZodNativeEnum<typeof JWKSEd25519PrivateKeyKty> =
  z.nativeEnum(JWKSEd25519PrivateKeyKty);

/** @internal */
export const JWKSEd25519PrivateKeyKty$outboundSchema: z.ZodNativeEnum<typeof JWKSEd25519PrivateKeyKty> =
...
/** @internal */
export const JWKSEd25519PrivateKeyCrv$inboundSchema: z.ZodNativeEnum<typeof JWKSEd25519PrivateKeyCrv> =
  z.nativeEnum(JWKSEd25519PrivateKeyCrv);

/** @internal */
export const JWKSEd25519PrivateKeyCrv$outboundSchema: z.ZodNativeEnum<typeof JWKSEd25519PrivateKeyCrv> =
...
/** @internal */
export const JWKSEd25519PrivateKey$inboundSchema: z.ZodType<JWKSEd25519PrivateKey, z.ZodTypeDef, unknown> = z
  .object({
    kid: z.string(),
    alg: z.string(),
    use: z.string(),
...
export function jwksEd25519PrivateKeyToJSON(jwksEd25519PrivateKey: JWKSEd25519PrivateKey): string {
  return JSON.stringify(JWKSEd25519PrivateKey$outboundSchema.parse(jwksEd25519PrivateKey));
}
