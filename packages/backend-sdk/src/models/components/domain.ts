...
/** @internal */
export const DomainObject$inboundSchema: z.ZodNativeEnum<typeof DomainObject> = z.nativeEnum(DomainObject);

/** @internal */
export const DomainObject$outboundSchema: z.ZodNativeEnum<typeof DomainObject> = DomainObject$inboundSchema;
...
/** @internal */
export const Domain$outboundSchema: z.ZodType<Domain$Outbound, z.ZodTypeDef, Domain> = z
  .object({
...
export function domainFromJSON(jsonString: string): SafeParseResult<Domain, SDKValidationError> {
