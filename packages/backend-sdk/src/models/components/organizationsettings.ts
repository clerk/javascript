 ...
 * String representing the object's type. Objects of the same type share the same value.
 */
export type OrganizationSettingsObject = ClosedEnum<typeof OrganizationSettingsObject>;
...
/** @internal */
export const OrganizationSettingsObject$inboundSchema: z.ZodNativeEnum<typeof OrganizationSettingsObject> =
  z.nativeEnum(OrganizationSettingsObject);

/** @internal */
export const OrganizationSettingsObject$outboundSchema: z.ZodNativeEnum<typeof OrganizationSettingsObject> =
...
/** @internal */
export const DomainsEnrollmentModes$inboundSchema: z.ZodNativeEnum<typeof DomainsEnrollmentModes> =
  z.nativeEnum(DomainsEnrollmentModes);

/** @internal */
export const DomainsEnrollmentModes$outboundSchema: z.ZodNativeEnum<typeof DomainsEnrollmentModes> =
...
/** @internal */
export const OrganizationSettings$inboundSchema: z.ZodType<OrganizationSettings, z.ZodTypeDef, unknown> = z
  .object({
...
export function organizationSettingsToJSON(organizationSettings: OrganizationSettings): string {
  return JSON.stringify(OrganizationSettings$outboundSchema.parse(organizationSettings));
}
