...
export type TicketVerificationStatus = ClosedEnum<
  typeof TicketVerificationStatus
>;

export const TicketVerificationStrategy = {
  Ticket: "ticket",
} as const;
export type TicketVerificationStrategy = OpenEnum<
  typeof TicketVerificationStrategy
>;
...
export type FromOAuthVerificationStatus = ClosedEnum<
  typeof FromOAuthVerificationStatus
>;
...
export type AdminVerificationStatus = ClosedEnum<
  typeof AdminVerificationStatus
>;
...
/** @internal */
export const EmailAddressObject$inboundSchema: z.ZodType<
  EmailAddressObject,
  z.ZodTypeDef,
  unknown
> = z
...
/** @internal */
export const EmailAddressObject$outboundSchema: z.ZodType<
  EmailAddressObject,
  z.ZodTypeDef,
  EmailAddressObject
> = z.union([
...
/** @internal */
export const TicketVerificationStatus$inboundSchema: z.ZodNativeEnum<
  typeof TicketVerificationStatus
> = z.nativeEnum(TicketVerificationStatus);

/** @internal */
export const TicketVerificationStatus$outboundSchema: z.ZodNativeEnum<
  typeof TicketVerificationStatus
...
/** @internal */
export const TicketVerificationStrategy$inboundSchema: z.ZodType<
  TicketVerificationStrategy,
  z.ZodTypeDef,
  unknown
> = z
  .union([
    z.nativeEnum(TicketVerificationStrategy),
    z.string().transform(catchUnrecognizedEnum),
  ]);
...
/** @internal */
export const FromOAuthVerificationStatus$inboundSchema: z.ZodNativeEnum<
  typeof FromOAuthVerificationStatus
> = z.nativeEnum(FromOAuthVerificationStatus);

/** @internal */
export const FromOAuthVerificationStatus$outboundSchema: z.ZodNativeEnum<
  typeof FromOAuthVerificationStatus
...
/** @internal */
export const ErrorMeta$inboundSchema: z.ZodType<
  ErrorMeta,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export const ErrorMeta$outboundSchema: z.ZodType<
  ErrorMeta$Outbound,
  z.ZodTypeDef,
  ErrorMeta
> = z.object({});
...
export function errorMetaFromJSON(
  jsonString: string,
): SafeParseResult<ErrorMeta, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const ErrorClerkError$inboundSchema: z.ZodType<
  ErrorClerkError,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ErrorClerkError$outboundSchema: z.ZodType<
  ErrorClerkError$Outbound,
  z.ZodTypeDef,
  ErrorClerkError
> = z.object({
  message: z.string(),
...
export function errorClerkErrorToJSON(
  errorClerkError: ErrorClerkError,
): string {
  return JSON.stringify(ErrorClerkError$outboundSchema.parse(errorClerkError));
}

export function errorClerkErrorFromJSON(
  jsonString: string,
): SafeParseResult<ErrorClerkError, SDKValidationError> {
  return safeParse(
    jsonString,
...
export const ErrorT$inboundSchema: z.ZodType<ErrorT, z.ZodTypeDef, unknown> = z
  .lazy(() => ErrorClerkError$inboundSchema);
...
export const ErrorT$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  ErrorT
> = z.lazy(() => ErrorClerkError$outboundSchema);
...
/** @internal */
export const FromOAuth$inboundSchema: z.ZodType<
  FromOAuth,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const FromOAuth$outboundSchema: z.ZodType<
  FromOAuth$Outbound,
  z.ZodTypeDef,
  FromOAuth
> = z.object({
...
export function fromOAuthFromJSON(
  jsonString: string,
): SafeParseResult<FromOAuth, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const AdminVerificationStatus$inboundSchema: z.ZodNativeEnum<
  typeof AdminVerificationStatus
> = z.nativeEnum(AdminVerificationStatus);

/** @internal */
export const AdminVerificationStatus$outboundSchema: z.ZodNativeEnum<
  typeof AdminVerificationStatus
...
/** @internal */
export const VerificationStrategy$inboundSchema: z.ZodType<
...
/** @internal */
export const VerificationStrategy$outboundSchema: z.ZodType<
  VerificationStrategy,
  z.ZodTypeDef,
  VerificationStrategy
> = z.union([
...
export function otpFromJSON(
  jsonString: string,
): SafeParseResult<Otp, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Otp$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Otp' from JSON`,
  );
}
