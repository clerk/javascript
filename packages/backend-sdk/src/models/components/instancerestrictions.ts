 ...
 * String representing the object's type. Objects of the same type share the same value.
 */
export type InstanceRestrictionsObject = ClosedEnum<typeof InstanceRestrictionsObject>;
...
/** @internal */
export const InstanceRestrictionsObject$inboundSchema: z.ZodNativeEnum<typeof InstanceRestrictionsObject> =
  z.nativeEnum(InstanceRestrictionsObject);

/** @internal */
export const InstanceRestrictionsObject$outboundSchema: z.ZodNativeEnum<typeof InstanceRestrictionsObject> =
...
/** @internal */
export const InstanceRestrictions$inboundSchema: z.ZodType<InstanceRestrictions, z.ZodTypeDef, unknown> = z
  .object({
...
export function instanceRestrictionsToJSON(instanceRestrictions: InstanceRestrictions): string {
  return JSON.stringify(InstanceRestrictions$outboundSchema.parse(instanceRestrictions));
}
