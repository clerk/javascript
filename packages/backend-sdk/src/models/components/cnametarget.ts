...
/** @internal */
export const CNameTarget$inboundSchema: z.ZodType<CNameTarget, z.ZodTypeDef, unknown> = z.object({
  host: z.string(),
  value: z.string(),
  required: z.boolean(),
});
...
/** @internal */
export const CNameTarget$outboundSchema: z.ZodType<CNameTarget$Outbound, z.ZodTypeDef, CNameTarget> = z.object({
  host: z.string(),
  value: z.string(),
  required: z.boolean(),
});
...
export function cNameTargetFromJSON(jsonString: string): SafeParseResult<CNameTarget, SDKValidationError> {
  return safeParse(
    jsonString,
