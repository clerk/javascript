...
/** @internal */
export const InstanceObject$inboundSchema: z.ZodNativeEnum<typeof InstanceObject> = z.nativeEnum(InstanceObject);

/** @internal */
export const InstanceObject$outboundSchema: z.ZodNativeEnum<typeof InstanceObject> = InstanceObject$inboundSchema;
...
/** @internal */
export const Instance$inboundSchema: z.ZodType<Instance, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const Instance$outboundSchema: z.ZodType<Instance$Outbound, z.ZodTypeDef, Instance> = z
  .object({
...
export function instanceFromJSON(jsonString: string): SafeParseResult<Instance, SDKValidationError> {
  return safeParse(
    jsonString,
