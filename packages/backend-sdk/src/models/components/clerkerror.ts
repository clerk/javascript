...
/** @internal */
export const ClerkError$inboundSchema: z.ZodType<
  ClerkError,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ClerkError$outboundSchema: z.ZodType<
  ClerkError$Outbound,
  z.ZodTypeDef,
  ClerkError
> = z.object({
...
export function clerkErrorFromJSON(
  jsonString: string,
): SafeParseResult<ClerkError, SDKValidationError> {
  return safeParse(
    jsonString,
