...
/** @internal */
export const IdentificationLink$inboundSchema: z.ZodType<
  IdentificationLink,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function identificationLinkToJSON(
  identificationLink: IdentificationLink,
): string {
  return JSON.stringify(
    IdentificationLink$outboundSchema.parse(identificationLink),
  );
}
