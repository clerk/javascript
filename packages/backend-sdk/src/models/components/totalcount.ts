...
/** @internal */
export const TotalCountObject$inboundSchema: z.ZodNativeEnum<
  typeof TotalCountObject
> = z.nativeEnum(TotalCountObject);

/** @internal */
export const TotalCountObject$outboundSchema: z.ZodNativeEnum<
  typeof TotalCountObject
> = TotalCountObject$inboundSchema;
...
/** @internal */
export const TotalCount$inboundSchema: z.ZodType<
  TotalCount,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const TotalCount$outboundSchema: z.ZodType<
  TotalCount$Outbound,
  z.ZodTypeDef,
  TotalCount
> = z.object({
