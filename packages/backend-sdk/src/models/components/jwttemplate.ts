...
/** @internal */
export const JWTTemplateObject$inboundSchema: z.ZodNativeEnum<
  typeof JWTTemplateObject
> = z.nativeEnum(JWTTemplateObject);

/** @internal */
export const JWTTemplateObject$outboundSchema: z.ZodNativeEnum<
  typeof JWTTemplateObject
...
/** @internal */
export const JWTTemplate$inboundSchema: z.ZodType<
  JWTTemplate,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const JWTTemplate$outboundSchema: z.ZodType<
  JWTTemplate$Outbound,
  z.ZodTypeDef,
  JWTTemplate
> = z.object({
...
export function jwtTemplateFromJSON(
  jsonString: string,
): SafeParseResult<JWTTemplate, SDKValidationError> {
  return safeParse(
    jsonString,
