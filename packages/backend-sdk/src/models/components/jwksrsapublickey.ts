...
/** @internal */
export const JWKSRsaPublicKeyKty$inboundSchema: z.ZodNativeEnum<
  typeof JWKSRsaPublicKeyKty
> = z.nativeEnum(JWKSRsaPublicKeyKty);

/** @internal */
export const JWKSRsaPublicKeyKty$outboundSchema: z.ZodNativeEnum<
  typeof JWKSRsaPublicKeyKty
...
/** @internal */
export const JWKSRsaPublicKey$inboundSchema: z.ZodType<
  JWKSRsaPublicKey,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const JWKSRsaPublicKey$outboundSchema: z.ZodType<
...
export function jwksRsaPublicKeyToJSON(
  jwksRsaPublicKey: JWKSRsaPublicKey,
): string {
  return JSON.stringify(
    JWKSRsaPublicKey$outboundSchema.parse(jwksRsaPublicKey),
  );
}

export function jwksRsaPublicKeyFromJSON(
  jsonString: string,
): SafeParseResult<JWKSRsaPublicKey, SDKValidationError> {
  return safeParse(
    jsonString,
