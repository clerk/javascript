...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateOrganizationMembershipRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc('/organizations/{organization_id}/memberships')(pathParams);
