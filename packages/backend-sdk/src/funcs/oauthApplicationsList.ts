 ...
 */
export function oauthApplicationsList(
  client: ClerkCore,
  request: operations.ListOAuthApplicationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.OAuthApplications,
    | errors.ClerkErrors
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    value => operations.ListOAuthApplicationsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.OAuthApplications$inboundSchema),
