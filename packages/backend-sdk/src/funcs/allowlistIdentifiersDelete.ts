 ...
 */
export function allowlistIdentifiersDelete(
  client: ClerkCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.DeleteAllowlistIdentifierRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc('/allowlist_identifiers/{identifier_id}')(pathParams);
