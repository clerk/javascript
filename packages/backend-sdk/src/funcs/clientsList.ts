...
> {
  const parsed = safeParse(
    request,
    value => operations.GetClientListRequest$outboundSchema.parse(value),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ['400', '401', '410', '422', '4XX', '5XX'],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.Client$inboundSchema)),
    M.jsonErr([400, 401, 410, 422], errors.ClerkErrors$inboundSchema),
    M.fail('4XX'),
    M.fail('5XX'),
