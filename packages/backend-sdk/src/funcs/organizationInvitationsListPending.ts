 ...
 */
export function organizationInvitationsListPending(
  client: ClerkCore,
  request: operations.ListPendingOrganizationInvitationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.OrganizationInvitations,
    | errors.ClerkErrors
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    value => operations.ListPendingOrganizationInvitationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc('/organizations/{organization_id}/invitations/pending')(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.OrganizationInvitations$inboundSchema),
    M.jsonErr([400, 404], errors.ClerkErrors$inboundSchema),
    M.fail('4XX'),
    M.fail('5XX'),
