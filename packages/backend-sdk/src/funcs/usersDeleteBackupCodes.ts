...
export function usersDeleteBackupCodes(
  ...
  Result<
    operations.DeleteBackupCodeResponseBody,
    | errors.ClerkErrors
    | errors.ClerkErrors
    | APIError
    | SDKValidationError
...
> {
  ...
  const path = pathToFunc("/users/{user_id}/backup_code")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteBackupCodeResponseBody$inboundSchema),
