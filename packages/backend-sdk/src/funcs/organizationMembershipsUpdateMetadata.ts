 ...
 */
export function organizationMembershipsUpdateMetadata(
  client: ClerkCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.UpdateOrganizationMembershipMetadataRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc('/organizations/{organization_id}/memberships/{user_id}/metadata')(pathParams);
