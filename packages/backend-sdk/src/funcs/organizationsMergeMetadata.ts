 ...
 */
export function organizationsMergeMetadata(
  client: ClerkCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.MergeOrganizationMetadataRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc('/organizations/{organization_id}/metadata')(pathParams);
