 ...
 */
export function usersSetProfileImage(
  client: ClerkCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.SetUserProfileImageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc('/users/{user_id}/profile_image')(pathParams);
