...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateWaitlistEntryRequestBody$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.WaitlistEntry$inboundSchema),
