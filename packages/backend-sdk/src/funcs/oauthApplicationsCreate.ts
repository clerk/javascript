 ...
 */
export function oauthApplicationsCreate(
  client: ClerkCore,
...
> {
  const parsed = safeParse(
    request,
    value => operations.CreateOAuthApplicationRequestBody$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc('/oauth_applications')();
