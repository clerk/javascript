...
export class OauthApplications extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(oauthApplicationsList(this, request, options));
  }
  ...
  async create(
    ...
    return unwrapAsync(oauthApplicationsCreate(this, request, options));
  }
  ...
  async get(
    ...
    return unwrapAsync(oauthApplicationsGet(this, request, options));
  }
  ...
  async update(
    ...
    return unwrapAsync(oauthApplicationsUpdate(this, request, options));
  }
  ...
  async delete(
    ...
    return unwrapAsync(oauthApplicationsDelete(this, request, options));
  }
  ...
  async rotateSecret(
    ...
    return unwrapAsync(oauthApplicationsRotateSecret(this, request, options));
  }
}
