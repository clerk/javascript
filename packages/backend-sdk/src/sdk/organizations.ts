...
export class Organizations extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(organizationsList(this, request, options));
  }
   ...
   */
  async get(request: operations.GetOrganizationRequest, options?: RequestOptions): Promise<components.Organization> {
  ...
  async mergeMetadata(
    ...
    return unwrapAsync(organizationsMergeMetadata(this, request, options));
  }
  ...
  async uploadLogo(
    ...
    return unwrapAsync(organizationsUploadLogo(this, request, options));
  }
  ...
  async deleteLogo(
    ...
    return unwrapAsync(organizationsDeleteLogo(this, request, options));
  }
}
