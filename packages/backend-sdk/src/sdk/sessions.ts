...
export class Sessions extends ClientSDK {
   ...
   */
  async list(request: operations.GetSessionListRequest, options?: RequestOptions): Promise<Array<components.Session>> {
    return unwrapAsync(sessionsList(this, request, options));
  }
  ...
  async create(
    ...
    return unwrapAsync(sessionsCreate(this, request, options));
  }
   ...
   */
  async revoke(request: operations.RevokeSessionRequest, options?: RequestOptions): Promise<components.Session> {
    return unwrapAsync(sessionsRevoke(this, request, options));
  }
   ...
   */
  async verify(request: operations.VerifySessionRequest, options?: RequestOptions): Promise<components.Session> {
    return unwrapAsync(sessionsVerify(this, request, options));
  }
  ...
  async createToken(
    ...
    return unwrapAsync(sessionsCreateToken(this, request, options));
  }
  ...
  async createTokenFromTemplate(
    ...
    return unwrapAsync(sessionsCreateTokenFromTemplate(this, request, options));
  }
}
