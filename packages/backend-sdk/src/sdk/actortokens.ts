...
export class ActorTokens extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(actorTokensCreate(this, request, options));
  }
   ...
   */
  async revoke(request: operations.RevokeActorTokenRequest, options?: RequestOptions): Promise<components.ActorToken> {
    return unwrapAsync(actorTokensRevoke(this, request, options));
  }
}
