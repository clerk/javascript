...
export class Invitations extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(invitationsCreate(this, request, options));
  }
  ...
  async list(
    ...
    return unwrapAsync(invitationsList(this, request, options));
  }
  ...
  async bulkCreate(
    ...
    return unwrapAsync(invitationsBulkCreate(this, request, options));
  }
  ...
  async revoke(
    ...
    return unwrapAsync(invitationsRevoke(this, request, options));
  }
}
