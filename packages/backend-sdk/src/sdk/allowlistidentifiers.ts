...
export class AllowlistIdentifiers extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(allowlistIdentifiersList(this, request, options));
  }
  ...
  async create(
    ...
    return unwrapAsync(allowlistIdentifiersCreate(this, request, options));
  }
  ...
  async delete(
    ...
    return unwrapAsync(allowlistIdentifiersDelete(this, request, options));
  }
}
