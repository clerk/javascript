...
- Broaden React peer dependency to `^18.0.0 || ^19.0.0` to resolve peer dependency conflicts for Expo 54 users ([#7579](https://github.com/clerk/javascript/pull/7579)) by [@chriscanin](https://github.com/chriscanin)
