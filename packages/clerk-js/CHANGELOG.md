...
- Removed redundant `beforeunload` event listener from SafeLock that was disabling the browser's back-forward cache (bfcache), degrading navigation performance. ([#7775](https://github.com/clerk/javascript/pull/7775)) by [@bsingerftm](https://github.com/bsingerftm)
