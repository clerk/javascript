...
- Improve bot detection by loading the Turnstile SDK directly from CloudFlare. ([#4330](https://github.com/clerk/javascript/pull/4330)) by [@anagstef](https://github.com/anagstef)
...
- Avoid passing some of the new feedback properties down to the HTML basic elements to avoid react warnings in the console. ([#1951](https://github.com/clerk/javascript/pull/1951)) by [@desiprisg](https://github.com/desiprisg)
