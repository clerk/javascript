...
export const Avatar = (props: AvatarProps) => {
  ...
  const { experimental_enableClerkImageShimmer } = useOptions();
  ...
  return (
    <Flex
      ...
      sx={[
        t => ({
          ...
          position: 'relative',
          boxShadow: experimental_enableClerkImageShimmer ? 'var(--cl-shimmer-hover-shadow)' : 'unset',
    ...
    >
      ...
      <Box
        sx={t => ({
          display: experimental_enableClerkImageShimmer ? 'unset' : 'none',
          overflow: 'hidden',
