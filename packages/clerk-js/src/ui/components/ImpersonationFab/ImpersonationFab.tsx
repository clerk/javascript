...
import type { ActiveSessionResource, PendingSessionResource } from '@clerk/types';
...
const FabContent = ({ title, signOutText }: FabContentProps) => {
  ...
  const handleSignOutSessionClicked = (session: ActiveSessionResource | PendingSessionResource) => () => {
