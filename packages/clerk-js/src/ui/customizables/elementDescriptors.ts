...
export const APPEARANCE_KEYS = containsAllElementsConfigKeys([
  ...
  'statementCard',
  'statementHeader',
  'statementHeaderContent',
  'statementTitle',
  'statementHeaderTitleBadgeContainer',
  'statementId',
  'statementIdContainer',
  'statementTitleIdContainer',
  'statementBadge',
  'statementDetails',
  'statementDetailsItem',
  'statementDetailsItemTitle',
  'statementDetailsItemTitleText',
  'statementDetailsItemValue',
  'statementDetailsItemValueText',
  'statementCopyButton',
  'statementContent',
