...
export const createColorScales = (theme: Theme) => {
  ...
  return removeUndefinedProps({
    ...
    colorTextSecondary: toHSLA(variables.colorTextSecondary) || colors.makeTransparent(variables.colorText, 0.25),
    colorTextTertiary: colors.makeTransparent(variables.colorText, 0.35),
