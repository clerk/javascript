...
export const makeCustomizable = <P,>(
  ...
  const customizableComponent = React.forwardRef((props: Customizable<any>, ref) => {
    ...
    const { parsedElements, hasPrebuiltTheme } = useAppearance();
    const descriptors = [
      defaultDescriptor,
    ...
    const generatedStyles = generateClassName(parsedElements, descriptors, elementId, props, hasPrebuiltTheme);
