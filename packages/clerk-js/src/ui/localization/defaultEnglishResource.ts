  ...
  userProfile: {
    ...
    start: {
      ...
      phoneNumbersSection: {
        ...
        destructiveActionAccordionSubtitle: 'Remove this phone number from the two-step verification methods',
        destructiveAction: 'Remove phone number',
        defaultFactorTitle__default: 'Default factor',
        defaultFactorTitle__setDefault: 'Set as Default factor',
        defaultFactorSubtitle__default:
          'This factor will be used as the default two-step verification method when signing in.',
        defaultFactorSubtitle__setDefault:
          'Set this factor as the default factor to use it as the default two-step verification method when signing in.',
        defaultFactorActionLabel__setDefault: 'Set as default',
      },
    ...
    mfaTOTPPage: {
      ...
      defaultFactorTitle: 'Default factor',
      defaultFactorSubtitle: 'This factor will be used as the default two-step verification method when signing in.',
      removeFactorTitle: 'Remove',
      removeFactorSubtitle: 'Remove authenticator application from the two-step verification methods',
