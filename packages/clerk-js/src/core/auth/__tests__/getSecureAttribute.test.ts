...
describe('getSecureAttribute', () => {
  ...
  it('returns false if the protocol is not https and the browser is Safari', () => {
    ...
    Object.defineProperty(global.window, 'location', { value: mockWindowLocation });
    Object.defineProperty(global.window, 'safari', { value: { dummyValue: true } });
    Object.defineProperty(global.window, 'isSecureContext', { value: undefined });
  ...
  it('returns true if isSecureContext is true', () => {
    const mockWindowLocation = new URL('http://www.clerk.com') as any as Window['location'];
    Object.defineProperty(global.window, 'location', { value: mockWindowLocation });
    Object.defineProperty(global.window, 'safari', { value: undefined });
    Object.defineProperty(global.window, 'isSecureContext', { value: true });
    expect(getSecureAttribute('None')).toBe(true);
  });
