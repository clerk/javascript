...
import { SignUpJSON, SignInJSON } from '@clerk/types';
import { DisplayConfig } from 'core/resources/DisplayConfig';
...
import { MagicLinkErrorCode } from 'core/resources/Error';
