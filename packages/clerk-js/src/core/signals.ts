...
// Single, stable resource+future instance for waitlist actions
const waitlistResource = new WaitlistSignalResource();
...
export const waitlistComputedSignal: WaitlistSignal = computed(() => {
  ...
  return { errors, fetchStatus, waitlist: waitlistResource };
});
