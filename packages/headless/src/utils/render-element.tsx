...
interface RenderElementParamsConditional<
  Tag extends keyof React.JSX.IntrinsicElements,
  State extends Record<string, unknown> = Record<string, never>,
> extends RenderElementParamsBase<Tag, State> {
...
export function renderElement<
  Tag extends keyof React.JSX.IntrinsicElements,
  State extends Record<string, unknown> = Record<string, never>,
>(params: RenderElementParamsAlways<Tag, State>): React.ReactElement;
export function renderElement<
  Tag extends keyof React.JSX.IntrinsicElements,
  State extends Record<string, unknown> = Record<string, never>,
>(params: RenderElementParamsConditional<Tag, State>): React.ReactElement | null;
export function renderElement<
  Tag extends keyof React.JSX.IntrinsicElements,
  State extends Record<string, unknown> = Record<string, never>,
