...
async function run() {
  const result = await clerkBackendApi.sessions.get("<id>");
...
async function run() {
  const res = await sessionsGet(clerkBackendApi, "<id>");
...
async function run() {
  const result = await clerkBackendApi.sessions.revoke("<id>");
...
async function run() {
  const res = await sessionsRevoke(clerkBackendApi, "<id>");
