...
async function run() {
  const result = await clerkBackendApi.redirectUrls.get("<id>");
...
async function run() {
  const res = await redirectUrlsGet(clerkBackendApi, "<id>");
...
async function run() {
  const result = await clerkBackendApi.redirectUrls.delete("<id>");
...
async function run() {
  const res = await redirectUrlsDelete(clerkBackendApi, "<id>");
