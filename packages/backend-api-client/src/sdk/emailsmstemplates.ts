...
export class EmailSMSTemplates extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(emailSMSTemplatesList(
      this,
      request,
      options,
    ));
  ...
  async get(
    ...
    return unwrapAsync(emailSMSTemplatesGet(
      this,
      request,
      options,
    ));
  ...
  async revert(
    ...
    return unwrapAsync(emailSMSTemplatesRevert(
      this,
      request,
      options,
    ));
  ...
  async toggleTemplateDelivery(
    ...
    return unwrapAsync(emailSMSTemplatesToggleTemplateDelivery(
      this,
      request,
      options,
    ));
