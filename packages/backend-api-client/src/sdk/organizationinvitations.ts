...
export class OrganizationInvitations extends ClientSDK {
  ...
  async getAll(
    ...
    return unwrapAsync(organizationInvitationsGetAll(
      this,
      request,
      options,
    ));
  ...
  async create(
    ...
    return unwrapAsync(organizationInvitationsCreate(
      this,
      request,
      options,
    ));
  ...
  async list(
    ...
    return unwrapAsync(organizationInvitationsList(
      this,
      request,
      options,
    ));
  ...
  async bulkCreate(
    ...
    return unwrapAsync(organizationInvitationsBulkCreate(
      this,
      request,
      options,
    ));
  ...
  async listPending(
    ...
    return unwrapAsync(organizationInvitationsListPending(
      this,
      request,
      options,
    ));
  ...
  async get(
    ...
    return unwrapAsync(organizationInvitationsGet(
      this,
      request,
      options,
    ));
  ...
  async revoke(
    ...
    return unwrapAsync(organizationInvitationsRevoke(
      this,
      request,
      options,
    ));
