...
export class OrganizationDomains extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(organizationDomainsCreate(
      this,
      request,
      options,
    ));
  ...
  async list(
    ...
    return unwrapAsync(organizationDomainsList(
      this,
      request,
      options,
    ));
  ...
  async update(
    ...
    return unwrapAsync(organizationDomainsUpdate(
      this,
      request,
      options,
    ));
  ...
  async delete(
    ...
    return unwrapAsync(organizationDomainsDelete(
      this,
      request,
      options,
    ));
