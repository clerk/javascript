 ...
 */
export function usersVerifyTotp(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.VerifyTOTPRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/users/{user_id}/verify_totp")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.VerifyTOTPResponseBody$inboundSchema),
