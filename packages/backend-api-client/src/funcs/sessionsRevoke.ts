...
> {
  const input: operations.RevokeSessionRequest = {
    sessionId: sessionId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.RevokeSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/{session_id}/revoke")(pathParams);
