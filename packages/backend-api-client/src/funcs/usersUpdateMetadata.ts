 ...
 */
export function usersUpdateMetadata(
  client: ClerkCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateUserMetadataRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/users/{user_id}/metadata")(pathParams);
