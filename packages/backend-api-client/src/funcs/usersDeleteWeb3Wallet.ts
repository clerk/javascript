 ...
 */
export function usersDeleteWeb3Wallet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UserWeb3WalletDeleteRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    web3_wallet_identification_id: encodeSimple(
      "web3_wallet_identification_id",
      payload.web3_wallet_identification_id,
