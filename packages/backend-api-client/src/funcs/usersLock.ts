...
> {
  const input: operations.LockUserRequest = {
    userId: userId,
  };

  const parsed = safeParse(
    input,
    (value) => operations.LockUserRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/users/{user_id}/lock")(pathParams);
