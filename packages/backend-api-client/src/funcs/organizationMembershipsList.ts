 ...
 */
export function organizationMembershipsList(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListOrganizationMembershipsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/organizations/{organization_id}/memberships")(
    pathParams,
  );
  ...
  >(
    ...
    M.jsonErr([401, 422], errors.ClerkErrors$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
