 ...
 */
export function organizationInvitationsBulkCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateOrganizationInvitationBulkRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/organizations/{organization_id}/invitations/bulk")(
    pathParams,
  );
