 ...
 */
export function organizationInvitationsGetAll(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListInstanceOrganizationInvitationsRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/organization_invitations")();
  ...
  >(
    M.json(
      200,
      components
        .OrganizationInvitationsWithPublicOrganizationData$inboundSchema,
    ),
