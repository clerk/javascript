 ...
 */
export function redirectUrlsDelete(
...
> {
  const input: operations.DeleteRedirectURLRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => operations.DeleteRedirectURLRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/redirect_urls/{id}")(pathParams);
