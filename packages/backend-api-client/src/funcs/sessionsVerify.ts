 ...
 */
export function sessionsVerify(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.VerifySessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/{session_id}/verify")(pathParams);
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "404", "410", "4XX", "5XX"],
  ...
  >(
    ...
    M.jsonErr([400, 401, 404, 410], errors.ClerkErrors$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
