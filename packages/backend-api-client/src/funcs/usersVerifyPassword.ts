 ...
 */
export function usersVerifyPassword(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.VerifyPasswordRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/users/{user_id}/verify_password")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.VerifyPasswordResponseBody$inboundSchema),
