...
export function createSignInTokenRequestBodyToJSON(
  createSignInTokenRequestBody: CreateSignInTokenRequestBody,
): string {
  return JSON.stringify(
    CreateSignInTokenRequestBody$outboundSchema.parse(
      createSignInTokenRequestBody,
    ),
  );
}
