...
/** @internal */
export const VerifyTOTPRequestBody$inboundSchema: z.ZodType<
...
export function verifyTOTPRequestBodyToJSON(
  verifyTOTPRequestBody: VerifyTOTPRequestBody,
): string {
  return JSON.stringify(
    VerifyTOTPRequestBody$outboundSchema.parse(verifyTOTPRequestBody),
  );
}
...
/** @internal */
export const VerifyTOTPRequest$inboundSchema: z.ZodType<
  VerifyTOTPRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const VerifyTOTPRequest$outboundSchema: z.ZodType<
  VerifyTOTPRequest$Outbound,
  z.ZodTypeDef,
  VerifyTOTPRequest
> = z.object({
  userId: z.string(),
...
export function verifyTOTPRequestToJSON(
  verifyTOTPRequest: VerifyTOTPRequest,
): string {
  return JSON.stringify(
    VerifyTOTPRequest$outboundSchema.parse(verifyTOTPRequest),
  );
}

export function verifyTOTPRequestFromJSON(
  jsonString: string,
): SafeParseResult<VerifyTOTPRequest, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const CodeType$inboundSchema: z.ZodNativeEnum<typeof CodeType> = z
  .nativeEnum(CodeType);

/** @internal */
export const CodeType$outboundSchema: z.ZodNativeEnum<typeof CodeType> =
  CodeType$inboundSchema;
...
/** @internal */
export const VerifyTOTPResponseBody$inboundSchema: z.ZodType<
...
export function verifyTOTPResponseBodyToJSON(
  verifyTOTPResponseBody: VerifyTOTPResponseBody,
): string {
  return JSON.stringify(
    VerifyTOTPResponseBody$outboundSchema.parse(verifyTOTPResponseBody),
  );
}
