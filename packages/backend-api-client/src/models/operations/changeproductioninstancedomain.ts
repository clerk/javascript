...
/** @internal */
export const ChangeProductionInstanceDomainRequestBody$outboundSchema:
  z.ZodType<
...
export namespace ChangeProductionInstanceDomainRequestBody$ {
  ...
  export const inboundSchema =
    ChangeProductionInstanceDomainRequestBody$inboundSchema;
  /** @deprecated use `ChangeProductionInstanceDomainRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    ChangeProductionInstanceDomainRequestBody$outboundSchema;
...
export function changeProductionInstanceDomainRequestBodyToJSON(
  ...
  return JSON.stringify(
    ChangeProductionInstanceDomainRequestBody$outboundSchema.parse(
      changeProductionInstanceDomainRequestBody,
    ),
  );
}
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ChangeProductionInstanceDomainRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
