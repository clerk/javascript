...
/** @internal */
export const RefreshSessionRequestBody$inboundSchema: z.ZodType<
...
export function refreshSessionRequestBodyToJSON(
  refreshSessionRequestBody: RefreshSessionRequestBody,
): string {
  return JSON.stringify(
    RefreshSessionRequestBody$outboundSchema.parse(refreshSessionRequestBody),
  );
}
...
/** @internal */
export const RefreshSessionRequest$inboundSchema: z.ZodType<
...
> = z.object({
  sessionId: z.string(),
  requestBody: z.lazy(() => RefreshSessionRequestBody$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
export function refreshSessionRequestToJSON(
  refreshSessionRequest: RefreshSessionRequest,
): string {
  return JSON.stringify(
    RefreshSessionRequest$outboundSchema.parse(refreshSessionRequest),
  );
}
