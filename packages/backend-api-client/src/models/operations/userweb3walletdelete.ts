...
/** @internal */
export const UserWeb3WalletDeleteRequest$inboundSchema: z.ZodType<
...
export function userWeb3WalletDeleteRequestToJSON(
  userWeb3WalletDeleteRequest: UserWeb3WalletDeleteRequest,
): string {
  return JSON.stringify(
    UserWeb3WalletDeleteRequest$outboundSchema.parse(
      userWeb3WalletDeleteRequest,
    ),
  );
}
