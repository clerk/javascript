...
export function updatePhoneNumberRequestBodyToJSON(
  updatePhoneNumberRequestBody: UpdatePhoneNumberRequestBody,
): string {
  return JSON.stringify(
    UpdatePhoneNumberRequestBody$outboundSchema.parse(
      updatePhoneNumberRequestBody,
    ),
  );
}
...
/** @internal */
export const UpdatePhoneNumberRequest$inboundSchema: z.ZodType<
  UpdatePhoneNumberRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
  phone_number_id: z.string(),
  RequestBody: z.lazy(() => UpdatePhoneNumberRequestBody$inboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  requestBody: z.lazy(() => UpdatePhoneNumberRequestBody$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
export function updatePhoneNumberRequestToJSON(
  updatePhoneNumberRequest: UpdatePhoneNumberRequest,
): string {
  return JSON.stringify(
    UpdatePhoneNumberRequest$outboundSchema.parse(updatePhoneNumberRequest),
  );
}
