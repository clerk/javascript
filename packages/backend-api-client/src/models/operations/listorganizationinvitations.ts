...
/** @internal */
export const ListOrganizationInvitationsQueryParamStatus$inboundSchema:
  z.ZodNativeEnum<typeof ListOrganizationInvitationsQueryParamStatus> = z
    .nativeEnum(ListOrganizationInvitationsQueryParamStatus);

/** @internal */
export const ListOrganizationInvitationsQueryParamStatus$outboundSchema:
  z.ZodNativeEnum<typeof ListOrganizationInvitationsQueryParamStatus> =
...
export namespace ListOrganizationInvitationsQueryParamStatus$ {
  ...
  export const outboundSchema =
    ListOrganizationInvitationsQueryParamStatus$outboundSchema;
}
...
export namespace ListOrganizationInvitationsRequest$ {
  ...
  export const outboundSchema =
    ListOrganizationInvitationsRequest$outboundSchema;
...
export function listOrganizationInvitationsRequestToJSON(
  ...
  return JSON.stringify(
    ListOrganizationInvitationsRequest$outboundSchema.parse(
      listOrganizationInvitationsRequest,
    ),
  );
}
...
export function listOrganizationInvitationsRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) =>
      ListOrganizationInvitationsRequest$inboundSchema.parse(JSON.parse(x)),
