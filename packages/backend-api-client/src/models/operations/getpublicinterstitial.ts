...
export function getPublicInterstitialRequestToJSON(
  getPublicInterstitialRequest: GetPublicInterstitialRequest,
): string {
  return JSON.stringify(
    GetPublicInterstitialRequest$outboundSchema.parse(
      getPublicInterstitialRequest,
    ),
  );
}
