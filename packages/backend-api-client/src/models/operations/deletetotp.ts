...
/** @internal */
export const DeleteTOTPRequest$inboundSchema: z.ZodType<
  DeleteTOTPRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const DeleteTOTPRequest$outboundSchema: z.ZodType<
  DeleteTOTPRequest$Outbound,
  z.ZodTypeDef,
  DeleteTOTPRequest
> = z.object({
  userId: z.string(),
...
export function deleteTOTPRequestToJSON(
  deleteTOTPRequest: DeleteTOTPRequest,
): string {
  return JSON.stringify(
    DeleteTOTPRequest$outboundSchema.parse(deleteTOTPRequest),
  );
}

export function deleteTOTPRequestFromJSON(
  jsonString: string,
): SafeParseResult<DeleteTOTPRequest, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const DeleteTOTPResponseBody$inboundSchema: z.ZodType<
...
export function deleteTOTPResponseBodyToJSON(
  deleteTOTPResponseBody: DeleteTOTPResponseBody,
): string {
  return JSON.stringify(
    DeleteTOTPResponseBody$outboundSchema.parse(deleteTOTPResponseBody),
  );
}
