...
/** @internal */
export const GetTemplateListRequest$inboundSchema: z.ZodType<
...
export function getTemplateListRequestToJSON(
  getTemplateListRequest: GetTemplateListRequest,
): string {
  return JSON.stringify(
    GetTemplateListRequest$outboundSchema.parse(getTemplateListRequest),
  );
}
