 ...
 * The type of template to update
 */
export type UpsertTemplatePathParamTemplateType = ClosedEnum<
...
/** @internal */
export const UpsertTemplatePathParamTemplateType$outboundSchema:
  z.ZodNativeEnum<typeof UpsertTemplatePathParamTemplateType> =
...
export namespace UpsertTemplatePathParamTemplateType$ {
  ...
  export const outboundSchema =
    UpsertTemplatePathParamTemplateType$outboundSchema;
}

/** @internal */
export const UpsertTemplateRequestBody$inboundSchema: z.ZodType<
...
export function upsertTemplateRequestBodyToJSON(
  upsertTemplateRequestBody: UpsertTemplateRequestBody,
): string {
  return JSON.stringify(
    UpsertTemplateRequestBody$outboundSchema.parse(upsertTemplateRequestBody),
  );
}
...
/** @internal */
export const UpsertTemplateRequest$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  slug: z.string(),
  requestBody: z.lazy(() => UpsertTemplateRequestBody$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
export function upsertTemplateRequestToJSON(
  upsertTemplateRequest: UpsertTemplateRequest,
): string {
  return JSON.stringify(
    UpsertTemplateRequest$outboundSchema.parse(upsertTemplateRequest),
  );
}
