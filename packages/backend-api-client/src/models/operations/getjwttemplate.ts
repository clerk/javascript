...
/** @internal */
export const GetJWTTemplateRequest$inboundSchema: z.ZodType<
...
export function getJWTTemplateRequestToJSON(
  getJWTTemplateRequest: GetJWTTemplateRequest,
): string {
  return JSON.stringify(
    GetJWTTemplateRequest$outboundSchema.parse(getJWTTemplateRequest),
  );
}
