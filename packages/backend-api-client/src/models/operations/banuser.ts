...
/** @internal */
export const BanUserRequest$inboundSchema: z.ZodType<
  BanUserRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const BanUserRequest$outboundSchema: z.ZodType<
  BanUserRequest$Outbound,
  z.ZodTypeDef,
  BanUserRequest
> = z.object({
  userId: z.string(),
...
export function banUserRequestFromJSON(
  jsonString: string,
): SafeParseResult<BanUserRequest, SDKValidationError> {
  return safeParse(
    jsonString,
