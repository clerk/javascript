...
/** @internal */
export const OAuthApplications$inboundSchema: z.ZodType<
  OAuthApplications,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const OAuthApplications$outboundSchema: z.ZodType<
  OAuthApplications$Outbound,
  z.ZodTypeDef,
  OAuthApplications
> = z.object({
...
export function oAuthApplicationsToJSON(
  oAuthApplications: OAuthApplications,
): string {
  return JSON.stringify(
    OAuthApplications$outboundSchema.parse(oAuthApplications),
  );
}

export function oAuthApplicationsFromJSON(
  jsonString: string,
): SafeParseResult<OAuthApplications, SDKValidationError> {
  return safeParse(
    jsonString,
