...
/** @internal */
export const ProxyCheckObject$inboundSchema: z.ZodNativeEnum<
  typeof ProxyCheckObject
> = z.nativeEnum(ProxyCheckObject);

/** @internal */
export const ProxyCheckObject$outboundSchema: z.ZodNativeEnum<
  typeof ProxyCheckObject
> = ProxyCheckObject$inboundSchema;
...
/** @internal */
export const ProxyCheck$inboundSchema: z.ZodType<
  ProxyCheck,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ProxyCheck$outboundSchema: z.ZodType<
  ProxyCheck$Outbound,
  z.ZodTypeDef,
  ProxyCheck
> = z.object({
...
export function proxyCheckFromJSON(
  jsonString: string,
): SafeParseResult<ProxyCheck, SDKValidationError> {
  return safeParse(
    jsonString,
