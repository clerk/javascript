...
/** @internal */
export const InstanceSettingsObject$inboundSchema: z.ZodNativeEnum<
  typeof InstanceSettingsObject
> = z.nativeEnum(InstanceSettingsObject);

/** @internal */
export const InstanceSettingsObject$outboundSchema: z.ZodNativeEnum<
  typeof InstanceSettingsObject
...
/** @internal */
export const InstanceSettings$inboundSchema: z.ZodType<
  InstanceSettings,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const InstanceSettings$outboundSchema: z.ZodType<
  InstanceSettings$Outbound,
  z.ZodTypeDef,
  InstanceSettings
> = z.object({
...
export function instanceSettingsToJSON(
  instanceSettings: InstanceSettings,
): string {
  return JSON.stringify(
    InstanceSettings$outboundSchema.parse(instanceSettings),
  );
}

export function instanceSettingsFromJSON(
  jsonString: string,
): SafeParseResult<InstanceSettings, SDKValidationError> {
  return safeParse(
    jsonString,
