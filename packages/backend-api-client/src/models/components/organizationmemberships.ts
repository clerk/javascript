...
/** @internal */
export const OrganizationMemberships$inboundSchema: z.ZodType<
...
export function organizationMembershipsToJSON(
  organizationMemberships: OrganizationMemberships,
): string {
  return JSON.stringify(
    OrganizationMemberships$outboundSchema.parse(organizationMemberships),
  );
}
