...
/** @internal */
export const Kty$outboundSchema: z.ZodNativeEnum<typeof Kty> =
  Kty$inboundSchema;
...
/** @internal */
export const Crv$outboundSchema: z.ZodNativeEnum<typeof Crv> =
  Crv$inboundSchema;
...
/** @internal */
export const JWKSEd25519PublicKey$inboundSchema: z.ZodType<
...
export function jwksEd25519PublicKeyToJSON(
  jwksEd25519PublicKey: JWKSEd25519PublicKey,
): string {
  return JSON.stringify(
    JWKSEd25519PublicKey$outboundSchema.parse(jwksEd25519PublicKey),
  );
}
