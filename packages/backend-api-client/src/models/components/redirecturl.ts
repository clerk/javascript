...
/** @internal */
export const RedirectURLObject$inboundSchema: z.ZodNativeEnum<
  typeof RedirectURLObject
> = z.nativeEnum(RedirectURLObject);

/** @internal */
export const RedirectURLObject$outboundSchema: z.ZodNativeEnum<
  typeof RedirectURLObject
...
/** @internal */
export const RedirectURL$inboundSchema: z.ZodType<
  RedirectURL,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const RedirectURL$outboundSchema: z.ZodType<
...
export function redirectURLFromJSON(
  jsonString: string,
): SafeParseResult<RedirectURL, SDKValidationError> {
  return safeParse(
    jsonString,
