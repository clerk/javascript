...
export type OAuthApplicationWithSecretObject = ClosedEnum<
  typeof OAuthApplicationWithSecretObject
>;
...
/** @internal */
export const OAuthApplicationWithSecretObject$inboundSchema: z.ZodNativeEnum<
  typeof OAuthApplicationWithSecretObject
> = z.nativeEnum(OAuthApplicationWithSecretObject);

/** @internal */
export const OAuthApplicationWithSecretObject$outboundSchema: z.ZodNativeEnum<
  typeof OAuthApplicationWithSecretObject
...
/** @internal */
export const OAuthApplicationWithSecret$inboundSchema: z.ZodType<
...
export function oAuthApplicationWithSecretToJSON(
  oAuthApplicationWithSecret: OAuthApplicationWithSecret,
): string {
  return JSON.stringify(
    OAuthApplicationWithSecret$outboundSchema.parse(oAuthApplicationWithSecret),
  );
}
