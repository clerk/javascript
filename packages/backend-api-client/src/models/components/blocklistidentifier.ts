 ...
 * @remarks
 */
export type BlocklistIdentifierObject = ClosedEnum<
  typeof BlocklistIdentifierObject
>;
...
export type BlocklistIdentifierIdentifierType = ClosedEnum<
...
/** @internal */
export const BlocklistIdentifierObject$inboundSchema: z.ZodNativeEnum<
  typeof BlocklistIdentifierObject
> = z.nativeEnum(BlocklistIdentifierObject);

/** @internal */
export const BlocklistIdentifierObject$outboundSchema: z.ZodNativeEnum<
  typeof BlocklistIdentifierObject
...
export namespace BlocklistIdentifierIdentifierType$ {
  ...
  export const outboundSchema =
    BlocklistIdentifierIdentifierType$outboundSchema;
}

/** @internal */
export const BlocklistIdentifier$inboundSchema: z.ZodType<
  BlocklistIdentifier,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function blocklistIdentifierToJSON(
  blocklistIdentifier: BlocklistIdentifier,
): string {
  return JSON.stringify(
    BlocklistIdentifier$outboundSchema.parse(blocklistIdentifier),
  );
}
