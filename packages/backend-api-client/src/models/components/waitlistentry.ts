...
export type WaitlistEntryInvitationObject = ClosedEnum<
  typeof WaitlistEntryInvitationObject
>;
...
export type WaitlistEntryInvitationStatus = ClosedEnum<
  typeof WaitlistEntryInvitationStatus
>;
...
/** @internal */
export const WaitlistEntryObject$inboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryObject
> = z.nativeEnum(WaitlistEntryObject);

/** @internal */
export const WaitlistEntryObject$outboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryObject
...
/** @internal */
export const WaitlistEntryStatus$inboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryStatus
> = z.nativeEnum(WaitlistEntryStatus);

/** @internal */
export const WaitlistEntryStatus$outboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryStatus
...
/** @internal */
export const WaitlistEntryInvitationObject$inboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryInvitationObject
> = z.nativeEnum(WaitlistEntryInvitationObject);

/** @internal */
export const WaitlistEntryInvitationObject$outboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryInvitationObject
...
/** @internal */
export const WaitlistEntryInvitationStatus$inboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryInvitationStatus
> = z.nativeEnum(WaitlistEntryInvitationStatus);

/** @internal */
export const WaitlistEntryInvitationStatus$outboundSchema: z.ZodNativeEnum<
  typeof WaitlistEntryInvitationStatus
...
/** @internal */
export const WaitlistEntryInvitation$inboundSchema: z.ZodType<
...
export function waitlistEntryInvitationToJSON(
  waitlistEntryInvitation: WaitlistEntryInvitation,
): string {
  return JSON.stringify(
    WaitlistEntryInvitation$outboundSchema.parse(waitlistEntryInvitation),
  );
}
...
/** @internal */
export const WaitlistEntry$inboundSchema: z.ZodType<
  WaitlistEntry,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  created_at: z.number().int(),
  updated_at: z.number().int(),
  invitation: z.nullable(z.lazy(() => WaitlistEntryInvitation$inboundSchema))
    .optional(),
}).transform((v) => {
  return remap$(v, {
    "email_address": "emailAddress",
...
/** @internal */
export const WaitlistEntry$outboundSchema: z.ZodType<
...
> = z.object({
  ...
  createdAt: z.number().int(),
  updatedAt: z.number().int(),
  invitation: z.nullable(z.lazy(() => WaitlistEntryInvitation$outboundSchema))
    .optional(),
}).transform((v) => {
  return remap$(v, {
    emailAddress: "email_address",
...
export function waitlistEntryFromJSON(
  jsonString: string,
): SafeParseResult<WaitlistEntry, SDKValidationError> {
  return safeParse(
    jsonString,
