...
/** @internal */
export const InvitationObject$inboundSchema: z.ZodNativeEnum<
  typeof InvitationObject
> = z.nativeEnum(InvitationObject);

/** @internal */
export const InvitationObject$outboundSchema: z.ZodNativeEnum<
  typeof InvitationObject
> = InvitationObject$inboundSchema;
...
/** @internal */
export const InvitationStatus$inboundSchema: z.ZodNativeEnum<
  typeof InvitationStatus
> = z.nativeEnum(InvitationStatus);

/** @internal */
export const InvitationStatus$outboundSchema: z.ZodNativeEnum<
  typeof InvitationStatus
> = InvitationStatus$inboundSchema;
