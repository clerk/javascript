...
/** @internal */
export const ActorTokenObject$inboundSchema: z.ZodNativeEnum<
  typeof ActorTokenObject
> = z.nativeEnum(ActorTokenObject);

/** @internal */
export const ActorTokenObject$outboundSchema: z.ZodNativeEnum<
  typeof ActorTokenObject
> = ActorTokenObject$inboundSchema;
...
/** @internal */
export const ActorTokenStatus$inboundSchema: z.ZodNativeEnum<
  typeof ActorTokenStatus
> = z.nativeEnum(ActorTokenStatus);

/** @internal */
export const ActorTokenStatus$outboundSchema: z.ZodNativeEnum<
  typeof ActorTokenStatus
> = ActorTokenStatus$inboundSchema;
...
/** @internal */
export const ActorTokenActor$inboundSchema: z.ZodType<
  ActorTokenActor,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export const ActorTokenActor$outboundSchema: z.ZodType<
  ActorTokenActor$Outbound,
  z.ZodTypeDef,
  ActorTokenActor
> = z.object({});
...
export function actorTokenActorToJSON(
  actorTokenActor: ActorTokenActor,
): string {
  return JSON.stringify(ActorTokenActor$outboundSchema.parse(actorTokenActor));
}

export function actorTokenActorFromJSON(
  jsonString: string,
): SafeParseResult<ActorTokenActor, SDKValidationError> {
  return safeParse(
    jsonString,
...
/** @internal */
export const ActorToken$inboundSchema: z.ZodType<
  ActorToken,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ActorToken$outboundSchema: z.ZodType<
  ActorToken$Outbound,
  z.ZodTypeDef,
  ActorToken
> = z.object({
...
export function actorTokenFromJSON(
  jsonString: string,
): SafeParseResult<ActorToken, SDKValidationError> {
  return safeParse(
    jsonString,
