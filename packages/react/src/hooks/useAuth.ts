...
type UseAuthReturn =
  | { isLoaded: false; isSignedIn: undefined; userId: undefined; sessionId: undefined; getToken: GetToken }
  | { isLoaded: true; isSignedIn: false; userId: null; sessionId: null; getToken: GetToken }
  | { isLoaded: true; isSignedIn: true; userId: string; sessionId: string; getToken: GetToken };
...
export const useAuth: UseAuth = () => {
  ...
  if (sessionId === undefined && userId === undefined) {
    return { isLoaded: false, isSignedIn: undefined, sessionId, userId, getToken };
  }
 ...
 * @internal
 */
const __unstable_getToken = (isomorphicClerk: IsomorphicClerk) => (options: any) => {
