...
- Note in the `publishableKey` JSDoc that `@clerk/electron/react` requires it. ([#9867](https://github.com/clerk/javascript/pull/9867)) by [@manovotny](https://github.com/manovotny)
