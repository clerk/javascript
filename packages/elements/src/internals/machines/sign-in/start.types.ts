...
export type SignInStartPasskeyEvent = { type: 'AUTHENTICATE.PASSKEY'; flow: 'discoverable' | undefined };

export type SignInStartEvents = ErrorActorEvent | SignInStartSubmitEvent | SignInStartPasskeyEvent | DoneActorEvent;
