 ...
 */
// We declare an explicit return type here because TypeScript's inference results in the subtype reduction of the union
// used for feedback. Explicitly declaring the return type allows for all members of the union to be included in the
// return type.
