...
- [JavaScript only Quickstart](https://github.com/clerk/clerk-chrome-extension-js-quickstart): The extension without React or frameworks using its own authentication
