...
- Remove deprecated `enableHandshake` option and `req.auth` object-access pattern. ([#7926](https://github.com/clerk/javascript/pull/7926)) by [@wobsoriano](https://github.com/wobsoriano)
