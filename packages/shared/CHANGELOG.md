...
- Add `username` field into `PublicUserData` object. ([#7832](https://github.com/clerk/javascript/pull/7832)) by [@Jibaru](https://github.com/Jibaru)
...
- Fix prototype pollution vulnerability in `fastDeepMergeAndReplace` and `fastDeepMergeAndKeep` utilities by blocking dangerous keys (`__proto__`, `constructor`, `prototype`) during object merging. ([#7621](https://github.com/clerk/javascript/pull/7621)) by [@jacekradko](https://github.com/jacekradko)
