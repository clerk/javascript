 ...
 * 3. Use the prerelease tag of `@clerk/clerk-js` or the package version provided
 * 4. Fallback to the major version of `@clerk/clerk-js` or the package version provided
