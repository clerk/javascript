...
function F(r, n) {
  n === void 0 && (n = {});
  for (var e = _(r), a = n.prefixes, u = a === void 0 ? "./" : a, t = n.delimiter, c = t === void 0 ? "/#?" : t, o = [], h = 0, m = 0, d = "", f = function(l) {
    ...
    if (x || C) {
      var g = T || "";
      u.indexOf(g) === -1 && (d += g, g = ""), d && (o.push(d), d = ""), o.push({
        name: x || h++,
        prefix: g,
        suffix: "",
        pattern: C || A(g),
...
function I(r, n, e) {
  e === void 0 && (e = {});
  var a = e.decode,
    u = a === void 0 ? function(t) {
      return t
    } : a;
  return function(t) {
    var c = r.exec(t);
    if (!c) return !1;
    for (var o = c[0], h = c.index, m = Object.create(null), d = function(w) {
      if (c[w] === void 0) return "continue";
      var p = n[w - 1];
      p.modifier === "*" || p.modifier === "+" ? m[p.name] = c[w].split(p.prefix + p.suffix).map(function(O) {
        return u(O, p)
      }) : m[p.name] = u(c[w], p)
    }, f = 1; f < c.length; f++) d(f);
    return {
      path: o,
      index: h,
      params: m
...
function U(r, n, e) {
  e === void 0 && (e = {});
  for (var a = e.strict, u = a === void 0 ? !1 : a, t = e.start, c = t === void 0 ? !0 : t, o = e.end, h = o === void 0 ? !0 : o, m = e.encode, d = m === void 0 ? function(v) {
    return v
  } : m, f = e.delimiter, w = f === void 0 ? "/#?" : f, p = e.endsWith, O = p === void 0 ? "" : p, A = "[".concat(s(O), "]|$"), T = "[".concat(s(w), "]"), x = c ? "^" : "", C = 0, g = r; C < g.length; C++) {
    var i = g[C];
      ...
      if (i.pattern)
        if (n && n.push(i), R || y)
          if (i.modifier === "+" || i.modifier === "*") {
            var N = i.modifier === "*" ? "?" : "";
            x += "(?:".concat(R, "((?:").concat(i.pattern, ")(?:").concat(y).concat(R, "(?:").concat(i.pattern, "))*)").concat(y, ")").concat(N)
