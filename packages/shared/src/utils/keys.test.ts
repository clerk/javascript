...
describe.concurrent('parsePublishableKey(key)', () => {
  const cases = [
    ...
    ['', null],
    ['whatever', null],
    ['pk_live_Y2xlcmsuY2xlcmsuZGV2JA==', { instanceType: 'live', frontendApi: 'clerk.clerk.dev' }],
    ['pk_test_Y2xlcmsuY2xlcmsuZGV2JA==', { instanceType: 'test', frontendApi: 'clerk.clerk.dev' }],
  ];
