...
- Fix Clerk component styling being lost after Astro View Transitions navigations. ([#8661](https://github.com/clerk/javascript/pull/8661)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Fix compatibility with Astro v6 Cloudflare adapter by using `cloudflare:workers` env when `locals.runtime.env` is unavailable ([#7890](https://github.com/clerk/javascript/pull/7890)) by [@alexcarpenter](https://github.com/alexcarpenter)
