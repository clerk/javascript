...
- Remove deprecated `as` prop from unstyled button components (`SignInButton`, `SignUpButton`, `SignOutButton`, `CheckoutButton`, `PlanDetailsButton`, `SubscriptionDetailsButton`). Use the `asChild` prop with a custom element in the default slot instead. ([#7839](https://github.com/clerk/javascript/pull/7839)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Introduce Keyless quickstart for Astro. This allows the Clerk SDK to be used without having to sign up and paste your keys manually. ([#7812](https://github.com/clerk/javascript/pull/7812)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Add `$billingStore` for access to the `Clerk.billing` object containing various Clerk Billing methods. ([#7732](https://github.com/clerk/javascript/pull/7732)) by [@dstaley](https://github.com/dstaley)
...
- Fixed an error when using Control components in prerendered pages ([#7710](https://github.com/clerk/javascript/pull/7710)) by [@wobsoriano](https://github.com/wobsoriano)

- Fixed an issue when using `ClientRouter` where Clerk components don't load until navigation is performed. ([#7801](https://github.com/clerk/javascript/pull/7801)) by [@lino-levan](https://github.com/lino-levan)
...
- Removes `console.log` from CheckoutButton. ([#6976](https://github.com/clerk/javascript/pull/6976)) by [@panteliselef](https://github.com/panteliselef)
...
- Expose billing buttons as experimental ([#6583](https://github.com/clerk/javascript/pull/6583)) by [@panteliselef](https://github.com/panteliselef)
...
- Fix `async_hooks` import for better Cloudflare compatibility. ([#6287](https://github.com/clerk/javascript/pull/6287)) by [@mlafeldt](https://github.com/mlafeldt)
