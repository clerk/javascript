...
const SamlOktaIdentityProviderMetadataStep = (): JSX.Element => (
  <IdentityProviderMetadataStep
    copy={{
      modesTitle: localizationKeys('configureSSO.configureStep.samlOkta.identityProviderMetadataStep.modes.title'),
      modes: {
      ...
      manual: {
        ...
        issuer: {
          label: localizationKeys(
            'configureSSO.configureStep.samlOkta.identityProviderMetadataStep.manual.issuer.label',
          ),
          placeholder: localizationKeys(
