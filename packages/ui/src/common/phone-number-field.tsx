            ...
            return (
              <div
                ...
                className={cx(
                  ...
                  //   - `ring` – "focus ring"
                  //   - `ring-offset` - border
                  '[--phone-number-field-py:theme(spacing.1)]',
              ...
              >
                ...
                <input
                  ...
                  {...props}
                  className='supports-ios:text-[length:1rem] min-h-[1.875rem] w-full rounded-r-md bg-white py-[--phone-number-field-py] pr-[--phone-number-field-px] text-base outline-none'
                  data-field-input
                />
              </div>
            );
