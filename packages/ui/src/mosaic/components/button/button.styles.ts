...
// `--cl-color-foreground`: it's a 900, so a percentage of it lands lighter than the same
...
// shades — `item` and `avatar` still mix from `--cl-color-foreground`, and unifying them
