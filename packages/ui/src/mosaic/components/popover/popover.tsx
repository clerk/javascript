...
import { popup as popupStyles, sizes } from './popover.styles';
  ...
  function PopoverPositioner({ className, style, ...rest }, ref) {
    ...
    return (
      <Primitive.Positioner
        ref={setRefs}
        {...mergeStyleProps(themeProps('popover-positioner'), stylex.props(floating.positioner), className, style)}
        {...rest}
      />
    );
  },
  ...
  return (
    <Primitive.Popup
      ...
      {...mergeStyleProps(
        ...
        stylex.props(floating.popup, popupStyles.base, sizes[size]),
        className,
        style,
      )}
      {...rest}
