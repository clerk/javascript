...
import { UserButton } from '../user-button.controller';
import type { UserButtonModel } from '../user-button.model';

let model: UserButtonModel;

vi.mock('../user-button.model', () => ({
  useUserButtonModel: () => model,
}));

// The controller's own job is which of the three model states renders what, so the surface is
...
function ready(): UserButtonModel {
  return {
    status: 'ready',
