...
export const APPEARANCE_KEYS = containsAllElementsConfigKeys([
  ...
  'organizationProfileSecuritySsoBypassDescription',
  'organizationProfileSecuritySsoBypassCountLabel',
  'organizationProfileSecuritySsoBypassCountBadge',
  'organizationProfileSecuritySsoBypassPage',
  'organizationProfileSecuritySsoBypassSearchInput',
  'organizationProfileSecuritySsoBypassSearchInputIcon',
  'organizationProfileSecuritySsoBypassAddButton',
  'organizationProfileSecuritySsoBypassEmailInput',
  'organizationProfileSecuritySsoBypassRoleWarning',
  'organizationProfileSecuritySsoBypassFailure',
  ...
  'configureDirectorySyncConnectionCard',
  'configureDirectorySyncConnectionCardName',
  'configureDirectorySyncConnectionCardDomains',
  'configureDirectorySyncConnectionCardDomainBadge',
  'configureDirectorySyncInstructionsToggle',
  'configureDirectorySyncInstructionsList',
  'configureDirectorySyncInstructionsListItem',
  'configureDirectorySyncFieldLabel',
  'configureDirectorySyncEndpointUrlInput',
  'configureDirectorySyncTokenInput',
  'configureDirectorySyncGenerateTokenButton',
  'configureDirectorySyncTokenNotice',
  'configureDirectorySyncRetryButton',
  'configureDirectorySyncAttributeMappingTable',
  'configureDirectorySyncAttributeMappingHeader',
  'configureDirectorySyncAttributeMappingValue',
  'configureDirectorySyncUsersList',
  'configureDirectorySyncUsersRow',
  'configureDirectorySyncUserIdentifier',
  'configureDirectorySyncUserName',
  'configureDirectorySyncUserTimestamp',
  'configureDirectorySyncUserStatusBadge',
  'configureDirectorySyncUsersEmpty',
  'configureDirectorySyncCompleteButton',
  'configureDirectorySyncCredentialsForm',
  'configureDirectorySyncCredentialsBadge',
