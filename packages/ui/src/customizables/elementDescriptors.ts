...
export const APPEARANCE_KEYS = containsAllElementsConfigKeys([
  ...
  'configureSSOVerifyDomainCardAffiliationLabel',
  'configureSSOVerifyDomainCardAffiliationBadge',
  'configureSSOVerifyDomainCardOwnershipArrow',
  'configureSSOVerifyDomainCardOwnershipLabel',
