...
- Improved keyless content and animation. ([#7834](https://github.com/clerk/javascript/pull/7834)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Fix infinite loading spinner when navigating to factor-two sign-in route without an active 2FA session ([#7774](https://github.com/clerk/javascript/pull/7774)) by [@nikosdouvlis](https://github.com/nikosdouvlis)
