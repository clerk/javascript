...
- Improves resilience by keeping users logged in when Clerk's origin is temporarily unavailable using edge-based token generation ([#6678](https://github.com/clerk/javascript/pull/6678)) by [@bratsos](https://github.com/bratsos)
...
- Add `lastSignInAtAfter` and `lastSignInAtBefore` filters to the Users API list and count endpoints. ([#7704](https://github.com/clerk/javascript/pull/7704)) by [@Jibaru](https://github.com/Jibaru)
...
- Add `createBulk()` method to `WaitlistEntryAPI` for bulk creating waitlist entries ([#7761](https://github.com/clerk/javascript/pull/7761)) by [@Jibaru](https://github.com/Jibaru)
...
- Renaming `__experimental_passwordCompromised` to `__experimental_setPasswordCompromised` and introducing `__experimental_unsetPasswordCompromised` ([#7492](https://github.com/clerk/javascript/pull/7492)) by [@octoper](https://github.com/octoper)
...
- Add optional `idToken` member to `OauthAccessToken` returned by `getUserOauthAccessToken`. The ID token is retrieved from OIDC providers and is only present for OIDC-compliant OAuth 2.0 providers when available. ([#7583](https://github.com/clerk/javascript/pull/7583)) by [@jfoshee](https://github.com/jfoshee)
...
- Move cookie to devDependencies and bundle it within @clerk/backend to fix module compatibility problems in TanStack Start apps. ([#7524](https://github.com/clerk/javascript/pull/7524)) by [@nikosdouvlis](https://github.com/nikosdouvlis)

- fix: correct `createInvitationBulk` return type to `Promise<Invitation[]>` ([#7136](https://github.com/clerk/javascript/pull/7136)) by [@mario-jerkovic](https://github.com/mario-jerkovic)
