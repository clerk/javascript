...
- Usage of `rootAuthLoader` without the `clerkMiddleware()` installed will not throw a runtime error. ([#7796](https://github.com/clerk/javascript/pull/7796)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Introduce Keyless quickstart for React Router. This allows the Clerk SDK to be used without having to sign up and paste your keys manually. ([#7794](https://github.com/clerk/javascript/pull/7794)) by [@wobsoriano](https://github.com/wobsoriano)
