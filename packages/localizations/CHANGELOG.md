...
- Improved Greek (el-GR), French (fr-FR), and Korean (ko-KR) translations. ([#7620](https://github.com/clerk/javascript/pull/7620)) by [@wobsoriano](https://github.com/wobsoriano)

- Updated Hebrew localization placeholders for user input fields ([#7566](https://github.com/clerk/javascript/pull/7566)) by [@AryeDepoint](https://github.com/AryeDepoint)

- Update translations for locales: Spanish (es-ES) billing page improvements, Portuguese (pt-BR) enterprise connections and password errors, and comprehensive Finnish (fi-FI) updates across authentication, billing, and organization management ([#7682](https://github.com/clerk/javascript/pull/7682)) by [@wobsoriano](https://github.com/wobsoriano)
...
- Updated es-ES translations for billing ([#7640](https://github.com/clerk/javascript/pull/7640)) by [@fgbbd](https://github.com/fgbbd)
