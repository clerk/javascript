...
export const heIL: LocalizationResource = {
  ...
  dates: {
    ...
    next6Days:
      "{{ date | weekday('iw','long') }} ב-{{ date | timeString('iw') }}",
    nextDay: "מחר ב-{{ date | timeString('iw') }}",
    numeric: "{{ date | numeric('iw') }}",
    previous6Days:
      "{{ date | weekday('iw','long') }} האחרון ב-{{ date | timeString('iw') }}",
  ...
  formFieldError__verificationLinkExpired:
    "הקישור לאימות פג תוקף. אנא בקש/י קישור חדש.",
  formFieldHintText__optional: "אופציונלי",
  formFieldHintText__slug:
    "(slug) הוא מזהה קריא שמיועד להיות ייחודי. הוא משמש לעיתים קרובות בכתובות URL.",
  formFieldInputPlaceholder__backupCode: "",
  formFieldInputPlaceholder__confirmDeletionUserAccount: "מחיקת חשבון",
  formFieldInputPlaceholder__emailAddress: "",
  formFieldInputPlaceholder__emailAddress_username: "",
  formFieldInputPlaceholder__emailAddresses:
    'הכנס או הדבק כתובת או כתובות דוא"ל, מופרדות ברווחים או פסיקים',
  ...
  organizationProfile: {
    ...
    invitePage: {
      detailsTitle__inviteFailed:
        "לא היה ניתן לשלוח את ההזמנות. תקן את הבעיות הבאות ונסה שוב:",
    ...
    membersPage: {
      ...
      requestsTab: {
        autoSuggestions: {
          headerSubtitle:
            "משתמשים שנרשמים עם דומיין אימייל תואם יוכלו לראות הצעה לבקש להצטרף לארגון שלך.",
    ...
    profilePage: {
      ...
      domainSection: {
        ...
        subtitle:
          "אפשר למשתמשים להצטרף לארגון באופן אוטומטי או לבקש להצטרף על בסיס דומיין אימייל מאומת.",
    ...
    removeDomainPage: {
      ...
      messageLine2:
        "משתמשים לא יוכלו להצטרף לארגון באופן אוטומטי לאחר פעולה זו.",
    ...
    verifyDomainPage: {
      ...
      subtitleVerificationCodeScreen:
        "קוד אימות נשלח ל{{emailAddress}}. הזן את הקוד כדי להמשיך.",
      title: "אמת דומיין",
    },
  },
  ...
  signIn: {
    ...
    alternativeMethods: {
      ...
      getHelp: {
        ...
        content:
          "אם אתה נתקל בקשיים בהתחברות לחשבונך, שלח לנו מייל ונעבוד איתך כדי לשחזר את הגישה בהקדם האפשרי.",
        title: "קבל עזרה",
      },
  ...
  unstable__errors: {
    captcha_invalid:
      "ההרשמה נכשלה עקב כשל באימות האבטחה. אנא רענן את הדף ונסה שוב, או פנה לתמיכה לעזרה נוספת.",
    captcha_unavailable:
      "ההרשמה נכשלה עקב כשל באימות נגד בוטים. אנא רענן את הדף ונסה שוב, או פנה לתמיכה לעזרה נוספת.",
    form_code_incorrect: "",
    ...
    form_param_format_invalid__email_address:
      "כתובת האימייל חייבת להיות כתובת אימייל תקינה.",
    form_param_format_invalid__phone_number:
      "מספר הטלפון חייב להיות בפורמט בינלאומי תקין.",
    form_param_max_length_exceeded__first_name:
      "שם פרטי לא צריך לעלות על 256 תווים.",
    form_param_max_length_exceeded__last_name:
      "שם משפחה לא צריך לעלות על 256 תווים.",
    ...
    zxcvbn: {
      couldBeStronger:
        "הסיסמה שלך תקפה, אך יכולה להיות חזקה יותר. נסה להוסיף יותר תווים.",
      ...
      suggestions: {
        ...
        longerKeyboardPattern:
          "השתמש בדפוסי מקלדת ארוכים יותר ושנה את כיוון ההקלדה מספר פעמים.",
        noNeed:
          "אתה יכול ליצור סיסמאות חזקות ללא שימוש בסמלים, מספרים, או אותיות גדולות.",
  ...
  userProfile: {
    ...
    mfaPhoneCodePage: {
      ...
      removeResource: {
        ...
        messageLine2:
          "החשבון שלך עשוי לא להיות בטוח כמו שהוא. האם אתה בטוח שאתה רוצה להמשיך?",
        successMessage: "אימות קוד SMS דו-שלבי הוסר ל{{mfaPhoneCode}}",
        title: "הסר אימות דו-שלבי",
      },
      subtitle__availablePhoneNumbers:
        "בחר מספר טלפון להרשמה לאימות קוד SMS דו-שלבי.",
      subtitle__unavailablePhoneNumbers:
        "אין מספרי טלפון זמינים להרשמה לאימות קוד SMS דו-שלבי.",
      successMessage1:
        "בעת ההתחברות, תצטרך להזין קוד אימות שנשלח למספר טלפון זה כשלב נוסף.",
      successMessage2:
    ...
    mfaTOTPPage: {
      authenticatorApp: {
        ...
        infoText__unableToScan:
          "הגדר שיטת התחברות חדשה באותנטיקטור שלך והכנס את המפתח שסופק למטה.",
      ...
      removeResource: {
        messageLine1:
          "קודי האימות מהאותנטיקטור הזה לא יהיו נדרשים יותר בעת ההתחברות.",
        messageLine2:
          "החשבון שלך עשוי לא להיות בטוח כמו שהוא. האם אתה בטוח שאתה רוצה להמשיך?",
    ...
    passwordPage: {
      checkboxInfoText__signOutOfOtherSessions:
        "מומלץ להתנתק מכל המכשירים האחרים שעלולים היו להשתמש בסיסמה הישנה שלך.",
      readonly:
        "כרגע לא ניתן לערוך את הסיסמה שלך מכיוון שניתן להתחבר רק דרך חיבור ארגוני.",
    ...
    profilePage: {
      fileDropAreaHint:
        'העלה תמונה בפורמט JPG, PNG, GIF, או WEBP הקטנה מ-10 מ"ב',
      imageFormDestructiveActionSubtitle: "הסר תמונה",
      imageFormSubtitle: "העלה תמונה",
      imageFormTitle: "תמונת פרופיל",
      readonly:
        "פרטי הפרופיל שלך ניתנים על ידי החיבור הארגוני ואינם ניתנים לעריכה.",
      ...
      mfaSection: {
        backupCodes: {
          ...
          subtitle__regenerate:
            "קבל קבוצה חדשה של קודי גיבוי מאובטחים. קודי גיבוי קודמים יימחקו ולא ניתן להשתמש בהם.",
