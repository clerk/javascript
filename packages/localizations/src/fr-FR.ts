...
export const frFR: LocalizationResource = {
  ...
  userProfile: {
    ...
    start: {
      ...
      passkeysSection: {
        menuAction__destructive: 'Supprimer', // Traduction ajoutée
        menuAction__rename: 'Renommer', // Traduction ajoutée
  ...
  reverification: {
    alternativeMethods: {
      actionLink: 'Utiliser une autre méthode', // Traduction ajoutée
      actionText: 'Vous ne pouvez pas accéder à votre compte ?', // Traduction ajoutée
      blockButton__backupCode: 'Utiliser un code de récupération', // Traduction ajoutée
      blockButton__emailCode: 'Recevoir un code par e-mail', // Traduction ajoutée
      blockButton__password: 'Utiliser le mot de passe', // Traduction ajoutée
      blockButton__phoneCode: 'Recevoir un code par téléphone', // Traduction ajoutée
      blockButton__totp: 'Utiliser un code d’application d’authentification', // Traduction ajoutée
      getHelp: {
        blockButton__emailSupport: 'Contacter le support par e-mail', // Traduction ajoutée
        content:
          "Si vous ne pouvez pas accéder à votre compte, contactez notre équipe de support pour obtenir de l'aide.", // Traduction ajoutée
        title: "Obtenir de l'aide", // Traduction ajoutée
      },
      subtitle: 'Choisissez une méthode alternative pour vérifier votre identité.', // Traduction ajoutée
      title: 'Vérification alternative', // Traduction ajoutée
    },
    backupCodeMfa: {
      subtitle: "Entrez l'un de vos codes de récupération pour vérifier votre compte.", // Traduction ajoutée
      title: 'Vérification par code de récupération', // Traduction ajoutée
    },
    emailCode: {
      formTitle: 'Entrez le code de vérification', // Traduction ajoutée
      resendButton: 'Renvoyer le code', // Traduction ajoutée
      subtitle: 'Un code a été envoyé à votre adresse e-mail.', // Traduction ajoutée
      title: 'Vérification par e-mail', // Traduction ajoutée
    },
    noAvailableMethods: {
      message: "Aucune méthode de vérification n'est disponible.", // Traduction ajoutée
      subtitle: 'Impossible de procéder à la vérification.', // Traduction ajoutée
      title: 'Aucune méthode disponible', // Traduction ajoutée
    },
    password: {
      actionLink: 'Réinitialiser le mot de passe', // Traduction ajoutée
      subtitle: 'Entrez votre mot de passe pour continuer.', // Traduction ajoutée
      title: 'Vérification par mot de passe', // Traduction ajoutée
    },
    phoneCode: {
      formTitle: 'Entrez le code de vérification', // Traduction ajoutée
      resendButton: 'Renvoyer le code', // Traduction ajoutée
      subtitle: 'Un code a été envoyé à votre téléphone.', // Traduction ajoutée
      title: 'Vérification par téléphone', // Traduction ajoutée
    },
    phoneCodeMfa: {
      formTitle: 'Entrez le code de vérification', // Traduction ajoutée
      resendButton: 'Renvoyer le code', // Traduction ajoutée
      subtitle: 'Un code a été envoyé à votre téléphone pour vérification.', // Traduction ajoutée
      title: 'Vérification par téléphone', // Traduction ajoutée
    },
    totpMfa: {
      formTitle: 'Entrez le code de vérification', // Traduction ajoutée
      subtitle: "Entrez le code généré par votre application d'authentification.", // Traduction ajoutée
      title: 'Vérification par application d’authentification', // Traduction ajoutée
    },
  },
  waitlist: {
    start: {
      actionLink: "Rejoindre la liste d'attente", // Traduction ajoutée
      actionText: 'Intéressé ? Rejoignez-nous !', // Traduction ajoutée
      formButton: "S'inscrire", // Traduction ajoutée
      subtitle: 'Soyez parmi les premiers à découvrir notre nouveau service.', // Traduction ajoutée
      title: "Rejoindre la liste d'attente", // Traduction ajoutée
    },
    success: {
      message: "Merci ! Vous avez été ajouté à la liste d'attente.", // Traduction ajoutée
      subtitle: 'Nous vous contacterons bientôt avec plus de détails.', // Traduction ajoutée
      title: 'Inscription réussie', // Traduction ajoutée
    },
  },
} as const;
