...
export const thTH: LocalizationResource = {
  ...
  __experimental_commerce: {
    ...
    checkout: {
      description__paymentSuccessful: 'การสมัครสมาชิกใหม่ของคุณพร้อมใช้งานแล้ว',
      description__subscriptionSuccessful: 'การสมัครสมาชิกใหม่ของคุณพร้อมใช้งานแล้ว',
      emailForm: {
        subtitle: 'ก่อนที่คุณจะสามารถทำการชำระเงินได้ คุณต้องเพิ่มที่อยู่อีเมลที่จะใช้รับใบเสร็จ',
        title: 'เพิ่มที่อยู่อีเมล',
      },
      lineItems: {
        title__invoiceId: 'รหัสใบแจ้งหนี้',
        title__paymentMethod: 'วิธีการชำระเงิน',
        title__subscriptionBegins: 'การสมัครสมาชิกเริ่มต้น',
        title__totalPaid: 'ยอดชำระทั้งหมด',
      },
    ...
    keepSubscription: 'คงการสมัครสมาชิกไว้',
    manage: 'จัดการ',
  ...
  badge__upcomingPlan: 'แผนที่กำลังจะมาถึง',
  badge__userDevice: 'อุปกรณ์ของผู้ใช้',
  badge__you: 'คุณ',
  createOrganization: {
  ...
  reverification: {
    alternativeMethods: {
      ...
      actionText: 'ไม่มีสิ่งเหล่านี้เลยใช่ไหม?',
      blockButton__backupCode: 'ใช้รหัสสำรอง',
      blockButton__emailCode: 'ส่งรหัสทางอีเมลไปที่ {{identifier}}',
      blockButton__passkey: 'ใช้พาสคีย์ของคุณ',
      blockButton__password: 'ดำเนินการต่อด้วยรหัสผ่านของคุณ',
      blockButton__phoneCode: 'ส่งรหัส SMS ไปที่ {{identifier}}',
      blockButton__totp: 'ใช้แอปพลิเคชันยืนยันตัวตนของคุณ',
      getHelp: {
        blockButton__emailSupport: 'อีเมลถึงฝ่ายสนับสนุน',
        content:
          'หากคุณมีปัญหาในการยืนยันบัญชีของคุณ กรุณาส่งอีเมลถึงเรา และเราจะช่วยคุณเรียกคืนการเข้าถึงโดยเร็วที่สุด',
        title: 'รับความช่วยเหลือ',
      },
      subtitle: 'พบปัญหาหรือไม่? คุณสามารถใช้วิธีเหล่านี้สำหรับการยืนยันตัวตน',
      title: 'ใช้วิธีอื่น',
    },
    backupCodeMfa: {
      subtitle: 'ป้อนรหัสสำรองที่คุณได้รับเมื่อตั้งค่าการยืนยันตัวตนแบบสองขั้นตอน',
      title: 'ป้อนรหัสสำรอง',
    },
    emailCode: {
      formTitle: 'รหัสยืนยันตัวตน',
      resendButton: 'ไม่ได้รับรหัส? ส่งอีกครั้ง',
      subtitle: 'ป้อนรหัสที่ส่งไปยังอีเมลของคุณเพื่อดำเนินการต่อ',
      title: 'จำเป็นต้องยืนยันตัวตน',
    },
    noAvailableMethods: {
      message: 'ไม่สามารถดำเนินการยืนยันตัวตนได้ ไม่มีวิธีการยืนยันตัวตนที่เหมาะสมถูกกำหนดค่าไว้',
      subtitle: 'เกิดข้อผิดพลาด',
      title: 'ไม่สามารถยืนยันบัญชีของคุณได้',
    },
    passkey: {
      blockButton__passkey: 'ใช้คีย์การเข้าถึงของคุณ',
      subtitle: 'การใช้คีย์การเข้าถึงของคุณยืนยันตัวตนของคุณ อุปกรณ์ของคุณอาจขอลายนิ้วมือ ใบหน้า หรือการล็อกหน้าจอ',
      title: 'ใช้คีย์การเข้าถึงของคุณ',
    },
    password: {
      actionLink: 'ใช้วิธีอื่น',
      subtitle: 'ป้อนรหัสผ่านปัจจุบันของคุณเพื่อดำเนินการต่อ',
      title: 'จำเป็นต้องยืนยันตัวตน',
    },
    phoneCode: {
      formTitle: 'รหัสยืนยันตัวตน',
      resendButton: 'ไม่ได้รับรหัส? ส่งอีกครั้ง',
      subtitle: 'ป้อนรหัสที่ส่งไปยังโทรศัพท์ของคุณเพื่อดำเนินการต่อ',
      title: 'จำเป็นต้องยืนยันตัวตน',
    },
    phoneCodeMfa: {
      formTitle: 'รหัสยืนยันตัวตน',
    ...
    totpMfa: {
      formTitle: 'รหัสยืนยันตัวตน',
      subtitle: 'ป้อนรหัสที่สร้างโดยแอปพลิเคชันยืนยันตัวตนของคุณเพื่อดำเนินการต่อ',
      title: 'จำเป็นต้องยืนยันตัวตน',
    },
  },
  signIn: {
  ...
  unstable__errors: {
    ...
    zxcvbn: {
      couldBeStronger: 'รหัสผ่านของคุณใช้งานได้ แต่อาจจะแข็งแรงกว่านี้ได้ ลองเพิ่มตัวอักษรให้มากขึ้น',
      goodPassword: 'รหัสผ่านของคุณตรงตามข้อกำหนดที่จำเป็นทั้งหมด',
      notEnough: 'รหัสผ่านของคุณไม่แข็งแรงเพียงพอ',
      suggestions: {
        allUppercase: 'ใช้ตัวพิมพ์ใหญ่บางตัว แต่ไม่ใช่ทั้งหมด',
        anotherWord: 'เพิ่มคำที่ไม่ค่อยพบเจอมากขึ้น',
        associatedYears: 'หลีกเลี่ยงปีที่เกี่ยวข้องกับคุณ',
        capitalization: 'ใช้ตัวพิมพ์ใหญ่มากกว่าตัวแรกเท่านั้น',
        dates: 'หลีกเลี่ยงวันที่และปีที่เกี่ยวข้องกับคุณ',
        l33t: "หลีกเลี่ยงการแทนที่ตัวอักษรที่คาดเดาได้ง่าย เช่น '@' แทน 'a'",
        longerKeyboardPattern: 'ใช้รูปแบบแป้นพิมพ์ที่ยาวขึ้นและเปลี่ยนทิศทางการพิมพ์หลายครั้ง',
        noNeed: 'คุณสามารถสร้างรหัสผ่านที่แข็งแรงได้โดยไม่ต้องใช้สัญลักษณ์ ตัวเลข หรือตัวพิมพ์ใหญ่',
        pwned: 'หากคุณใช้รหัสผ่านนี้ที่อื่นด้วย คุณควรเปลี่ยนรหัสผ่าน',
        recentYears: 'หลีกเลี่ยงปีล่าสุด',
        repeated: 'หลีกเลี่ยงคำและตัวอักษรที่ซ้ำกัน',
        reverseWords: 'หลีกเลี่ยงการสะกดคำทั่วไปแบบย้อนกลับ',
        sequences: 'หลีกเลี่ยงลำดับตัวอักษรที่พบบ่อย',
        useWords: 'ใช้หลายคำ แต่หลีกเลี่ยงวลีที่พบบ่อย',
      },
      warnings: {
        common: 'นี่เป็นรหัสผ่านที่ใช้กันอย่างแพร่หลาย',
        commonNames: 'ชื่อและนามสกุลทั่วไปเดาได้ง่าย',
        dates: 'วันที่เดาได้ง่าย',
        extendedRepeat: 'รูปแบบตัวอักษรที่ซ้ำกัน เช่น "abcabcabc" เดาได้ง่าย',
        keyPattern: 'รูปแบบแป้นพิมพ์สั้นๆ เดาได้ง่าย',
        namesByThemselves: 'ชื่อหรือนามสกุลเพียงอย่างเดียวเดาได้ง่าย',
        pwned: 'รหัสผ่านของคุณถูกเปิดเผยจากการรั่วไหลของข้อมูลบนอินเทอร์เน็ต',
        recentYears: 'ปีล่าสุดเดาได้ง่าย',
        sequences: 'ลำดับตัวอักษรทั่วไป เช่น "abc" เดาได้ง่าย',
        similarToCommon: 'นี่คล้ายกับรหัสผ่านที่ใช้กันอย่างแพร่หลาย',
        simpleRepeat: 'ตัวอักษรที่ซ้ำกัน เช่น "aaa" เดาได้ง่าย',
        straightRow: 'แถวของปุ่มตรงๆ บนแป้นพิมพ์ของคุณเดาได้ง่าย',
        topHundred: 'นี่เป็นรหัสผ่านที่ใช้บ่อย',
        topTen: 'นี่เป็นรหัสผ่านที่ใช้กันอย่างมาก',
        userInputs: 'ไม่ควรมีข้อมูลส่วนตัวหรือข้อมูลที่เกี่ยวข้องกับหน้าเว็บ',
        wordByItself: 'คำเดี่ยวๆ เดาได้ง่าย',
      },
    },
  },
  userButton: {
  ...
  userProfile: {
    __experimental_billingPage: {
      paymentSourcesSection: {
        ...
        removeResource: {
          ...
          messageLine2:
            'คุณจะไม่สามารถใช้แหล่งการชำระเงินนี้ได้อีก และการสมัครสมาชิกแบบต่อเนื่องที่ขึ้นอยู่กับวิธีการนี้จะไม่สามารถทำงานได้',
          successMessage: '{{paymentSource}} ได้ถูกลบออกจากบัญชีของคุณแล้ว',
          title: 'ลบวิธีการชำระเงิน',
        },
        title: 'ตัวเลือกที่มีอยู่',
      },
      start: {
        headerTitle__invoices: 'ใบแจ้งหนี้',
        headerTitle__paymentMethods: 'วิธีการชำระเงิน',
    ...
    emailAddressPage: {
      emailCode: {
        formHint: 'อีเมลที่มีรหัสยืนยันตัวตนจะถูกส่งไปยังที่อยู่อีเมลนี้',
        formSubtitle: 'ป้อนรหัสยืนยันตัวตนที่ส่งไปยัง {{identifier}}',
        formTitle: 'รหัสยืนยันตัวตน',
        resendButton: 'ไม่ได้รับรหัส? ส่งอีกครั้ง',
        successMessage: 'อีเมล {{identifier}} ได้ถูกเพิ่มเข้าบัญชีของคุณแล้ว',
      },
      emailLink: {
        formHint: 'อีเมลที่มีลิงก์ยืนยันตัวตนจะถูกส่งไปยังที่อยู่อีเมลนี้',
        formSubtitle: 'คลิกที่ลิงก์ยืนยันตัวตนในอีเมลที่ส่งไปยัง {{identifier}}',
        formTitle: 'ลิงก์ยืนยันตัวตน',
      ...
      formHint: 'คุณจะต้องยืนยันที่อยู่อีเมลนี้ก่อนที่จะสามารถเพิ่มเข้าบัญชีของคุณได้',
      removeResource: {
        messageLine1: '{{identifier}} จะถูกลบออกจากบัญชีนี้',
