...
export const zhCN: LocalizationResource = {
  ...
  unstable__errors: {
    ...
    password_confirmation_attempt_remaining: '密码错误。您还有 1 次尝试机会。',
    password_confirmation_attempts_remaining: '密码错误。您还有 {{remainingAttempts}} 次尝试机会。',
    password_confirmation_session_ended: '由于密码确认尝试次数已达上限，您的会话已结束。请重新登录以继续。',
