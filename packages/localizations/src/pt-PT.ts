...
export const ptPT: LocalizationResource = {
  ...
  reverification: {
    alternativeMethods: {
      actionLink: 'Precisa de ajuda?',
      actionText: 'Não tem nenhum destes métodos disponíveis?',
      blockButton__backupCode: 'Utilizar código de backup',
      blockButton__emailCode: 'Enviar código para o e-mail',
      blockButton__password: 'Fazer login com palavra-passe',
      blockButton__phoneCode: 'Enviar código para o telemóvel',
      blockButton__totp: 'Utilizar o seu autenticador',
      getHelp: {
        blockButton__emailSupport: 'Enviar e-mail para suporte',
        content:
          'Se tiver dificuldades a aceder à sua conta, entre em contacto connosco e ajudaremos a restaurar o acesso rapidamente.',
        title: 'Precisa de ajuda?',
      },
      subtitle: 'Escolha um método para continuar.',
      title: 'Métodos alternativos de verificação',
    },
    backupCodeMfa: {
      subtitle: 'Insira o código de backup enviado para o seu dispositivo.',
    ...
    noAvailableMethods: {
      message: 'Não foi possível realizar a verificação. Não há métodos de autenticação disponíveis.',
      subtitle: 'Ocorreu um erro na verificação.',
      title: 'Verificação falhada',
    },
    password: {
      actionLink: 'Utilizar outro método',
      subtitle: 'Insira a sua palavra-passe para continuar.',
      title: 'Verificação com palavra-passe',
    },
    phoneCode: {
      formTitle: 'Código de verificação',
      resendButton: 'Reenviar código',
      subtitle: 'Insira o código enviado para o seu telemóvel.',
      title: 'Verifique o seu telemóvel',
    },
    phoneCodeMfa: {
      formTitle: 'Código de verificação',
      resendButton: 'Reenviar código',
      subtitle: 'Insira o código de verificação enviado para o seu telemóvel.',
      title: 'Verificação de duas etapas',
    },
    totpMfa: {
      formTitle: 'Código de verificação',
      subtitle: 'Insira o código do seu autenticador.',
      title: 'Verificação com autenticador',
    },
  },
  waitlist: {
    start: {
