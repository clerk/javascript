...
export const plPL: LocalizationResource = {
  ...
  formFieldLabel__emailAddress_phoneNumber_username:
    "Adres e-mail, numer telefonu lub nazwa użytkownika",
  ...
  userProfile: {
    ...
    start: {
      ...
      headerSubtitle__security:
        "Zarządzaj swoimi preferencjami dotyczącymi bezpieczeństwa",
      profileSection: {
        title: "Profil",
      },
      usernameSection: {
      ...
      emailAddressesSection: {
        ...
        detailsSubtitle__unverified:
          "Ten adres email nie został zweryfikowany i może mieć ograniczoną funkcjonalność.",
        detailsAction__unverified: "Zakończ weryfikację",
        destructiveActionTitle: "Usuń",
        destructiveActionSubtitle:
          "Usuń ten adres email i usuń go z Twojego konta",
      ...
      phoneNumbersSection: {
        ...
        detailsSubtitle__primary:
          "Ten numer telefonu jest głównym numerem telefonu",
        detailsAction__primary: "Zakończ weryfikację",
        ...
        destructiveActionTitle: "Usuń",
        destructiveActionSubtitle:
          "Usuń ten numer telefonu i usuń go z Twojego konta",
      ...
      connectedAccountsSection: {
        ...
        destructiveActionSubtitle:
          "Po odłączeniu konta nie będzie można zalogować się z jego pomocą.",
      ...
      mfaSection: {
        ...
        phoneCode: {
          destructiveActionTitle: "Usuń",
          destructiveActionSubtitle:
            "Usuń ten numer telefonu z metod weryfikacji dwuetapowej",
        ...
        totp: {
          ...
          destructiveActionTitle: "Usuń",
          destructiveActionSubtitle:
            "Usuń aplikację autoryzacyjną z metod weryfikacji dwuetapowej",
    ...
    phoneNumberPage: {
      ...
      infoText__secondary:
        "Mogą obowiązywać opłaty za wiadomości i transfer danych.",
      removeResource: {
