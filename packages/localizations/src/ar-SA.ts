...
export const arSA: LocalizationResource = {
  ...
  apiKeys: {
    ...
    formHint: 'أضف إسماً لتوليد مفتاح جديد. سيكون بإمكانك إلغاؤه في أي وقت.',
  ...
  dates: {
    ...
    previous6Days: "آخر {{ date | weekday('en-US','long') }} في {{ date | timeString('en-US') }}",
  ...
  formFieldInputPlaceholder__emailAddress_username: 'إسم المستخدم أو عنوان البريد الإلكتروني',
  formFieldInputPlaceholder__emailAddresses: 'أدخل أو لصق عنوان بريد إلكتروني واحد أو أكثر ، مفصولة بمسافات أو فواصل',
  formFieldInputPlaceholder__firstName: 'الإسم الأول',
  formFieldInputPlaceholder__lastName: 'الإسم الأخير',
  ...
  formFieldInputPlaceholder__organizationName: 'إسم المنظمة',
  ...
  formFieldLabel__apiKeyExpiration: 'إنتهاء الصلاحية',
  formFieldLabel__apiKeyName: 'أسم المفتاح السري',
  ...
  formFieldLabel__organizationName: 'إسم المنظمة',
  ...
  formFieldLabel__username: 'إسم المستخدم',
  impersonationFab: {
  ...
  organizationList: {
    ...
    invitationAcceptedLabel: 'تم الإنضمام',
  ...
  reverification: {
    alternativeMethods: {
      ...
      blockButton__backupCode: 'إستعمل الرمز الإحتياطي',
      ...
      blockButton__totp: 'إستعمل تطبيق المصادقة',
      getHelp: {
  ...
  signIn: {
    ...
    emailLink: {
      ...
      expired: {
        subtitle: 'إرجع إلى علامة التبويب الرئيسية للمتابعة.',
        title: 'إنتهت صلاحية رابط التحقق هذا.',
      },
      failed: {
        subtitle: 'إرجع إلى علامة التبويب الرئيسية للمتابعة.',
        title: 'رابط التحقق هذا غير صالح',
      },
      formSubtitle: 'إستعمل رابط التحقق المرسل إلى بريدك الإلكتروني',
    ...
    start: {
      ...
      actionLink__join_waitlist: 'إنضم للائحة الإنتظار',
      actionLink__use_email: 'إستعمل البريد الإلكتروني',
      actionLink__use_email_username: 'إستعمل البريد الإلكتروني أو إسم المستخدم',
      actionLink__use_passkey: 'إستعمل مفتاح المرور بدلاً من ذلك',
      actionLink__use_phone: 'إستعمل رقم الهاتف',
      actionLink__use_username: 'إستعمل إسم المستخدم',
      actionText: 'ليس لديك حساب؟',
      actionText__join_waitlist: undefined,
      alternativePhoneCodeProvider: {
        actionLink: 'إستعمل طريقة أخرى',
        label: '{{provider}} رقم الهاتف',
        subtitle: 'إستعمل رقم هاتفك ليصلك رمز التحقق على {{provider}}',
  ...
  signUp: {
    ...
    emailLink: {
      ...
      verifiedSwitchTab: {
        subtitle: 'إرجع إلى علامة التبويب المفتوحة حديثًا للمتابعة',
        subtitleNewTab: 'إرجع إلى علامة التبويب السابقة للمتابعة',
