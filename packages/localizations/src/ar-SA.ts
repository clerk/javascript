...
export const arSA: LocalizationResource = {
  ...
  formFieldLabel__emailAddress_phoneNumber_username:
    "العنوان الإلكتروني, رقم الجوال أو اسم المستخدم",
    ...
    start: {
      ...
      emailAddressesSection: {
        ...
        detailsSubtitle__primary:
          "هذا البريد الإلكتروني هوا البريد الإلكتروني الرئيسي",
        ...
        detailsSubtitle__unverified:
          "تحقق كامل للوصول إلى جميع المميزات لهذا البريد الإلكتروني",
      ...
      phoneNumbersSection: {
        ...
        detailsSubtitle__nonPrimary:
          "تعيين هذا الرقم كرقم رئيسي لأستقبال المعلومات الخاصة بحسابك",
        detailsAction__nonPrimary: "تعيين كرئيسي",
        detailsTitle__unverified: "تحقق من رقم الجوال",
        detailsSubtitle__unverified:
          "تحقق كامل للوصول إلى جميع المميزات بأستخدام هذا الرقم",
      ...
      mfaSection: {
        ...
        phoneCode: {
          ...
          destructiveActionSubtitle:
            "حذف رقم الجوال هذا من طريقة التحقق بخطوتين",
          destructiveActionLabel: "حذف رقم الجوال",
          title__default: "العامل الأفتراضي",
          title__setDefault: "تعيين كعامل افتراضي",
          subtitle__default:
            "سيتم أستعمال هذا الطريقة كعامل افتراضي لعملية التحقق بخطوتين عند عملية تسجيل الدخول",
          subtitle__setDefault:
            "تعيين هذه الطريقة كعامل افتراضي لعملية التحقق بخطوتين عند عملية تسجيل الدخول.",
        ...
        totp: {
          ...
          destructiveActionTitle: "حذف",
          destructiveActionSubtitle:
            "حذف تطبيق المصادقة هذا من طريقة التحقق بخطوتين",
    ...
    membersPage: {
      ...
      requestsTab: {
        ...
        requests: {
          headerTitle: "الطلبات",
          headerSubtitle:
            "تصفٌح وإدارة المستخدمين الذين طلبوا الانضمام إلى المنظمة.",
        },
        autoSuggestions: {
