...
export const isIS: LocalizationResource = {
  ...
  taskChooseOrganization: {
    chooseOrganization: {
      action__createOrganization: 'Búa til nýja stofnun',
      action__invitationAccept: 'Taka þátt',
      action__suggestionsAccept: 'Beiðni um að taka þátt',
      subtitle: 'Taktu þátt í fyrirliggjandi stofnun eða búðu til nýja',
    ...
    createOrganization: {
      ...
      formFieldInputPlaceholder__name: 'Stofnunin mín',
      formFieldInputPlaceholder__slug: 'stofnunin-min',
      formFieldLabel__name: 'Nafn',
      formFieldLabel__slug: 'Slug',
      subtitle: 'Sláðu inn upplýsingar um stofnunina þína til að halda áfram',
      title: 'Stilltu stofnunina þína',
    },
    signOut: {
      actionLink: 'Skrá út',
