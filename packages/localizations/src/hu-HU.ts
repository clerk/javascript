...
export const huHU: LocalizationResource = {
  ...
  formFieldHintText__slug: 'A slug egy egyedi azonosító, amelyet általában URL-ben használunk.', //TODO: Slug?
  ...
  unstable__errors: {
    ...
    passwordComplexity: {
      maximumLength: 'kevesebb mint {{length}} karakter',
      minimumLength: '{{length}} vagy több karakter',
      requireLowercase: 'egy kisbetű',
      requireNumbers: 'egy szám',
      requireSpecialCharacter: 'egy speciális karakter',
