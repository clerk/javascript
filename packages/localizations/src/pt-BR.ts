...
export const ptBR: LocalizationResource = {
  ...
  apiKeys: {
    ...
    createdAndExpirationStatus__never:
      "Criada {{ createdDate | shortDate('pt-BR') }} • Nunca expira",
    ...
    formHint:
      "Forneça um nome para gerar uma nova chave. Você poderá revogá-la a qualquer momento.",
  ...
  commerce: {
    ...
    switchToAnnualWithAnnualPrice:
      "Mudar para anual {{currency}}{{price}} / ano",
  ...
  formFieldInputPlaceholder__apiKeyDescription:
    "Explique por que você está gerando esta chave",
  ...
  formFieldInputPlaceholder__organizationDomain:
    "Digite o domínio da organização",
  formFieldInputPlaceholder__organizationDomainEmailAddress:
    "Digite o e-mail associado ao domínio da organização",
  ...
  organizationProfile: {
    ...
    billingPage: {
      ...
      statementsSection: {
        ...
        itemCaption__proratedCredit:
          "Crédito proporcional para uso parcial do plano anterior",
        itemCaption__subscribedAndPaidForPlan:
          "Assinado e pago para plano {{plan}} {{period}}",
    ...
    invitePage: {
      ...
      subtitle:
        "Insira ou cole um ou mais endereços de e-mail, separados por espaços ou vírgulas.",
    ...
    plansPage: {
      alerts: {
        noPermissionsToManageBilling:
          "Você não tem permissões para gerenciar o faturamento desta organização.",
      },
      title: "Planos",
    },
    profilePage: {
    ...
    removeDomainPage: {
      ...
      messageLine2:
        "Os usuários não poderão mais se juntar à organização automaticamente após isso.",
    ...
    verifiedDomainPage: {
      dangerTab: {
        calloutInfoLabel:
          "A exclusão deste domínio afetará os usuários convidados.",
      ...
      enrollmentTab: {
        ...
        calloutInfoLabel:
          "Alterar o modo de inscrição afetará apenas os novos usuários.",
        calloutInvitationCountLabel:
          "Convites pendentes enviados aos usuários: {{count}}",
        calloutSuggestionCountLabel:
          "Sugestões pendentes enviadas aos usuários: {{count}}",
        manualInvitationOption__description:
          "Os usuários só podem ser convidados manualmente para a organização.",
        manualInvitationOption__label: "Sem inscrição automática",
        subtitle:
          "Escolha como os usuários deste domínio podem se juntar à organização.",
      },
      start: {
  ...
  reverification: {
    alternativeMethods: {
      ...
      getHelp: {
        ...
        content:
          "Se você não tem nenhum dos métodos listados, entre em contato com nosso suporte.",
        title: "Solicitar ajuda",
      },
      subtitle:
        "Escolha um dos métodos alternativos para verificar sua identidade.",
    ...
    noAvailableMethods: {
      message:
        "Nenhum método de verificação disponível. Entre em contato com o suporte.",
  ...
  signIn: {
    ...
    resetPassword: {
      ...
      successMessage:
        "Sua senha foi alterada com sucesso. Entrando, por favor aguarde um momento.",
      title: "Redefinir Senha",
    },
    resetPasswordMfa: {
      detailsLabel:
    ...
    start: {
      ...
      alternativePhoneCodeProvider: {
        ...
        subtitle:
          "Insira seu número de telefone para receber um código de verificação em {{provider}}.",
    ...
    legalConsent: {
      checkbox: {
        label__onlyPrivacyPolicy:
          'Eu concordo com a {{privacyPolicyLink || link("Política de Privacidade")}}',
        label__onlyTermsOfService:
          'Eu concordo com os {{termsOfServiceLink || link("Termos de Uso")}}',
  ...
  unstable__errors: {
    ...
    form_password_length_too_short:
      "Sua senha é muito curta. Por favor, tente novamente.",
    ...
    form_username_invalid_character:
      "Nome de usuário contém caracteres inválidos. Por favor, tente outro.",
    form_username_invalid_length:
      "Nome de usuário deve ter entre 3 e 256 caracteres.",
    ...
    organization_domain_blocked:
      "Este é um provedor de domínio de e-mail bloqueado. Por favor, use um diferente.",
    organization_domain_common:
      "Este é um provedor de domínio de e-mail comum. Por favor, use um diferente.",
    ...
    passkey_already_exists:
      "Uma chave de acesso já está registrada neste dispositivo.",
    passkey_not_supported:
      "Chaves de acesso não são suportadas neste dispositivo.",
    passkey_pa_not_supported:
      "Registro precisa de chave de acesso mas dispositivo não a suporta.",
    passkey_registration_cancelled:
      "Registro de chave de acesso cancelado ou expirado.",
  ...
  userProfile: {
    ...
    emailAddressPage: {
      ...
      formHint:
        "Você precisará verificar este endereço de email antes de poder adicioná-lo à sua conta.",
      removeResource: {
        messageLine1: "{{identifier}} será removido desta conta.",
        messageLine2:
    ...
    mfaPhoneCodePage: {
      ...
      removeResource: {
        ...
        messageLine2:
          "Sua conta pode ficar menos segura. Tem certeza que deseja continuar?",
        successMessage:
  ...
  waitlist: {
    start: {
      ...
      subtitle:
        "Entre com seu e-mail e entraremos em contato quando seu lugar estiver disponível",
