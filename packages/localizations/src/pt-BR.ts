    ...
    userProfile: {
      ...
      mfaTOTPPage: {
        ...
        removeResource: {
          ...
          messageLine1:
            'Os códigos de verificação deste aplicativo autenticador não serão mais necessários ao conectar.',
    ...
    unstable__errors: {
      ...
      zxcvbn: {
        ...
        warnings: {
          ...
          userInputs: 'Senha não deve haver nenhum dado pessoal ou relacionado.',
          pwned: 'Esta senha já foi exposta por uma violação de dados na Internet.',
        },
        suggestions: {
