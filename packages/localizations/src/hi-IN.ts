...
export const hiIN: LocalizationResource = {
  ...
  apiKeys: {
    ...
    createdAndExpirationStatus__expiresOn:
      "निर्मित {{ createdDate | shortDate('hi-IN') }} • समाप्त {{ expiresDate | longDate('hi-IN') }}",
  ...
  billing: {
    ...
    cancelFreeTrialAccessUntil:
      "आपका परीक्षण {{ date | longDate('hi-IN') }} तक सक्रिय रहेगा। उसके बाद, आप परीक्षण सुविधाओं तक पहुँच खो देंगे। आपसे कोई शुल्क नहीं लिया जाएगा।",
    ...
    cancelSubscriptionAccessUntil:
      "आप {{ date | longDate('hi-IN') }} तक '{{plan}}' सुविधाओं का उपयोग जारी रख सकते हैं, जिसके बाद आपके पास पहुँच नहीं रहेगी।",
    cancelSubscriptionNoCharge: 'इस सदस्यता के लिए आपसे कोई शुल्क नहीं लिया जाएगा।',
    cancelSubscriptionPastDue:
      'आपकी सदस्यता तुरंत समाप्त हो जाएगी और आप सभी योजना सुविधाओं तक पहुँच खो देंगे। आपकी अगली सदस्यता पर आपसे बकाया राशि का भुगतान करने के लिए कहा जाएगा।',
  ...
  organizationProfile: {
    ...
    billingPage: {
      ...
      subscriptionsSection: {
        actionLabel__default: 'प्रबंधित करें',
      },
      switchPlansSection: {
        title: 'योजनाएँ बदलें',
      },
  ...
  signIn: {
    ...
    passwordCompromised: {
      title: 'पासवर्ड से समझौता हुआ',
    },
    passwordPwned: {
      title: 'पासवर्ड समझौता हो गया',
    },
    passwordUntrusted: {
      title: 'पासवर्ड अविश्वसनीय',
    },
    phoneCode: {
      formTitle: 'सत्यापन कोड',
      resendButton: 'कोड नहीं मिला? फिर से भेजें',
  ...
  taskSetupMfa: {
    ...
    smsCode: {
      ...
      success: {
        ...
        message1:
          'दो-चरणीय सत्यापन अब सक्षम है। साइन इन करते समय, एक अतिरिक्त चरण के रूप में आपको इस फ़ोन नंबर पर भेजा गया सत्यापन कोड दर्ज करना होगा।',
        message2:
          'इन बैकअप कोड को सहेजें और उन्हें कहीं सुरक्षित स्थान पर रखें। यदि आप अपने प्रमाणीकरण डिवाइस तक पहुँच खो देते हैं, तो आप साइन इन करने के लिए बैकअप कोड का उपयोग कर सकते हैं।',
    ...
    totpCode: {
      addAuthenticatorApp: {
        ...
        infoText__ableToScan:
          'अपने प्रमाणक ऐप में एक नई साइन-इन विधि सेट करें और इसे अपने खाते से लिंक करने के लिए निम्नलिखित QR कोड स्कैन करें।',
        infoText__unableToScan: 'अपने प्रमाणक में एक नई साइन-इन विधि सेट करें और नीचे दी गई कुंजी दर्ज करें।',
        inputLabel__unableToScan1:
          'सुनिश्चित करें कि समय-आधारित या एक-बार के पासवर्ड सक्षम हैं, फिर अपने खाते को लिंक करना पूरा करें।',
      },
      success: {
        finishButton: 'जारी रखें',
        message1:
          'दो-चरणीय सत्यापन अब सक्षम है। साइन इन करते समय, एक अतिरिक्त चरण के रूप में आपको इस प्रमाणक से एक सत्यापन कोड दर्ज करना होगा।',
        message2:
          'इन बैकअप कोड को सहेजें और उन्हें कहीं सुरक्षित स्थान पर रखें। यदि आप अपने प्रमाणीकरण डिवाइस तक पहुँच खो देते हैं, तो आप साइन इन करने के लिए बैकअप कोड का उपयोग कर सकते हैं।',
  ...
  unstable__errors: {
    ...
    form_password_untrusted__sign_in:
      'आपके पासवर्ड से समझौता हो सकता है। अपने खाते की सुरक्षा के लिए, कृपया किसी वैकल्पिक साइन-इन विधि के साथ जारी रखें। साइन इन करने के बाद आपको अपना पासवर्ड रीसेट करना होगा।',
    ...
    organization_not_found_or_unauthorized_with_create_organization_disabled:
      'आप अब इस संगठन के सदस्य नहीं हैं। कृपया कोई दूसरा चुनें।',
    ...
    billingPage: {
      ...
      paymentMethodsSection: {
        ...
        removeMethod: {
          messageLine1: '{{identifier}} को इस खाते से हटा दिया जाएगा।',
          messageLine2:
            'आप अब इस भुगतान स्रोत का उपयोग नहीं कर पाएँगे और इस पर निर्भर कोई भी आवर्ती सदस्यता अब काम नहीं करेगी।',
          successMessage: '{{paymentMethod}} को आपके खाते से हटा दिया गया है।',
