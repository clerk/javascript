...
export const hiIN: LocalizationResource = {
  ...
  commerce: {
    ...
    billedMonthlyOnly: 'केवल मासिक बिल किया गया',
    cancelSubscription: 'सदस्यता रद्द करें',
    cancelSubscriptionAccessUntil: '{{ date }} तक पहुंच होगी',
    cancelSubscriptionNoCharge: 'कोई शुल्क नहीं लगेगा',
    cancelSubscriptionTitle: 'सदस्यता रद्द करें',
    cannotSubscribeMonthly: 'मासिक सदस्यता उपलब्ध नहीं है',
    cannotSubscribeUnrecoverable: 'सदस्यता पुनर्प्राप्त नहीं की जा सकती',
    checkout: {
    ...
    subscriptionDetails: {
      beginsOn: '{{ date }} को शुरू होती है',
      currentBillingCycle: 'वर्तमान बिलिंग चक्र',
      endsOn: '{{ date }} को समाप्त होती है',
      nextPaymentAmount: 'अगला भुगतान राशि',
      nextPaymentOn: '{{ date }} को अगला भुगतान',
      pastDueAt: '{{ date }} को अतिदेय',
      renewsAt: '{{ date }} को नवीनीकृत होती है',
      subscribedOn: '{{ date }} को सदस्यता ली',
      title: 'सदस्यता विवरण',
    },
    subtotal: 'उप-योग',
