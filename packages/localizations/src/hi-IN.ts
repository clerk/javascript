...
export const hiIN: LocalizationResource = {
  ...
  apiKeys: {
    ...
    action__search: 'कुंजी खोजें',
    createdAndExpirationStatus__expiresOn:
      "बनाया गया {{ createdDate | shortDate('hi-IN') }} • समाप्त होता है {{ expiresDate | longDate('hi-IN') }}",
    createdAndExpirationStatus__never: "बनाया गया {{ createdDate | shortDate('hi-IN') }} • कभी समाप्त नहीं होता",
    detailsTitle__emptyRow: 'कोई API कुंजी नहीं मिली',
    formButtonPrimary__add: 'कुंजी बनाएं',
    formFieldCaption__expiration__expiresOn: '{{ date }} को समाप्त हो रही है',
    ...
    formHint: 'नई कुंजी बनाने के लिए एक नाम प्रदान करें। आप इसे कभी भी रद्द कर सकेंगे।',
    ...
    lastUsed__months: '{{months}} महीने पहले',
  ...
  backButton: 'वापस',
  badge__activePlan: 'सक्रिय योजना',
  badge__canceledEndsAt: 'रद्द किया गया • {{ date }} को समाप्त होता है',
  badge__currentPlan: 'वर्तमान योजना',
  badge__default: 'डिफ़ॉल्ट',
  badge__endsAt: '{{ date }} को समाप्त होता है',
  badge__expired: 'समाप्त',
  badge__freeTrial: undefined,
  badge__otherImpersonatorDevice: 'अन्य प्रतिरूपण उपकरण',
  badge__pastDueAt: '{{ date }} को देय था',
  badge__pastDuePlan: 'अतिदेय योजना',
  badge__primary: 'प्राथमिक',
  badge__renewsAt: '{{ date }} को नवीनीकृत होता है',
  badge__requiresAction: 'कार्रवाई की आवश्यकता है',
  badge__startsAt: '{{ date }} को शुरू होता है',
  badge__thisDevice: 'यह उपकरण',
  badge__trialEndsAt: undefined,
  badge__unverified: 'असत्यापित',
  badge__upcomingPlan: 'आगामी योजना',
  badge__userDevice: 'उपयोगकर्ता उपकरण',
  badge__you: 'आप',
  commerce: {
    addPaymentMethod: 'भुगतान विधि जोड़ें',
    alwaysFree: 'हमेशा मुफ्त',
    annually: 'वार्षिक',
    availableFeatures: 'उपलब्ध सुविधाएं',
    billedAnnually: 'वार्षिक रूप से बिल किया गया',
    billedMonthlyOnly: 'केवल मासिक बिलिंग',
    cancelFreeTrial: 'मुफ्त परीक्षण रद्द करें',
    cancelFreeTrialAccessUntil: 'मुफ्त परीक्षण रद्द - पहुंच तक',
    cancelFreeTrialTitle: 'मुफ्त परीक्षण रद्द करें',
    cancelSubscription: 'सदस्यता रद्द करें',
    cancelSubscriptionAccessUntil: 'सदस्यता रद्द - पहुंच तक',
    cancelSubscriptionNoCharge: 'सदस्यता रद्द करें - कोई शुल्क नहीं',
    cancelSubscriptionTitle: 'सदस्यता रद्द करें',
    cannotSubscribeMonthly: 'मासिक सदस्यता संभव नहीं',
    cannotSubscribeUnrecoverable: 'सदस्यता अपूरणीय त्रुटि',
    checkout: {
      description__paymentSuccessful: 'आपका भुगतान सफल रहा',
      description__subscriptionSuccessful: 'आपकी सदस्यता सफल रही',
      downgradeNotice: 'योजना डाउनग्रेड की गई',
      emailForm: {
        subtitle: 'ईमेल पता दर्ज करें',
        title: 'ईमेल पता',
      },
      lineItems: {
        ...
        title__subscriptionBegins: 'सदस्यता शुरू होती है',
        title__totalPaid: 'कुल भुगतान',
      },
      pastDueNotice: 'बकाया भुगतान',
      perMonth: 'प्रति माह',
      title: 'चेकआउट',
      title__paymentSuccessful: 'भुगतान सफल',
      title__subscriptionSuccessful: 'सदस्यता सफल',
      title__trialSuccess: undefined,
      totalDueAfterTrial: undefined,
    },
    credit: 'क्रेडिट',
    creditRemainder: 'शेष क्रेडिट',
    defaultFreePlanActive: 'डिफ़ॉल्ट मुफ्त योजना सक्रिय',
    free: 'मुफ्त',
    getStarted: 'शुरू करें',
    keepFreeTrial: 'मुफ्त परीक्षण रखें',
    ...
    paymentSource: {
      applePayDescription: {
        annual: 'Apple Pay के साथ वार्षिक भुगतान',
        monthly: 'Apple Pay के साथ मासिक भुगतान',
      },
      dev: {
        ...
        testCardInfo: 'परीक्षण कार्ड जानकारी',
      },
    },
    popular: 'लोकप्रिय',
    pricingTable: {
    ...
    reSubscribe: 'दोबारा सदस्यता लें',
    seeAllFeatures: 'सभी सुविधाएं देखें',
    startFreeTrial: undefined,
    startFreeTrial__days: undefined,
    subscribe: 'सदस्यता लें',
    subscriptionDetails: {
      beginsOn: 'शुरू होता है',
      currentBillingCycle: 'वर्तमान बिलिंग चक्र',
      endsOn: 'समाप्त होता है',
      firstPaymentAmount: 'पहली भुगतान राशि',
      firstPaymentOn: 'पहला भुगतान दिनांक',
      nextPaymentAmount: 'अगली भुगतान राशि',
      nextPaymentOn: 'अगला भुगतान दिनांक',
      pastDueAt: 'बकाया दिनांक',
      renewsAt: 'नवीनीकरण दिनांक',
      subscribedOn: 'सदस्यता दिनांक',
      title: 'शीर्षक',
      trialEndsOn: 'परीक्षण समाप्ति दिनांक',
      trialStartedOn: 'परीक्षण आरंभ दिनांक',
    },
    subtotal: 'उप-योग',
    switchPlan: 'इस योजना पर स्विच करें',
    switchToAnnual: 'वार्षिक पर स्विच करें',
    switchToAnnualWithAnnualPrice: 'वार्षिक {{currency}}{{price}}/वर्ष पर स्विच करें',
    switchToMonthly: 'मासिक पर स्विच करें',
    switchToMonthlyWithPrice: 'मासिक {{currency}}{{price}}/माह पर स्विच करें',
    totalDue: 'कुल देय',
    totalDueToday: 'आज कुल देय',
    viewFeatures: 'सुविधाएं देखें',
  ...
  dividerText: 'या',
  footerActionLink__alternativePhoneCodeProvider: 'वैकल्पिक फोन कोड प्रदाता',
  ...
  formFieldInputPlaceholder__apiKeyDescription: 'API कुंजी का विवरण',
  formFieldInputPlaceholder__apiKeyExpirationDate: 'समाप्ति तिथि',
  formFieldInputPlaceholder__apiKeyName: 'API कुंजी का नाम',
  ...
  formFieldInputPlaceholder__username: 'उपयोगकर्ता नाम',
  formFieldLabel__apiKeyDescription: 'API कुंजी का विवरण',
  formFieldLabel__apiKeyExpiration: 'API कुंजी की समाप्ति',
  formFieldLabel__apiKeyName: 'API कुंजी का नाम',
  ...
  organizationProfile: {
    ...
    billingPage: {
      paymentHistorySection: {
        empty: 'कोई भुगतान इतिहास नहीं मिला',
        notFound: 'भुगतान इतिहास नहीं मिला',
        tableHeader__amount: 'राशि',
        tableHeader__date: 'तारीख',
      ...
      paymentSourcesSection: {
        ...
        payWithTestCardButton: 'परीक्षण कार्ड से भुगतान करें',
        removeResource: {
      ...
      start: {
        ...
        headerTitle__subscriptions: 'सदस्यताएं',
      },
      statementsSection: {
        empty: 'कोई चालान नहीं मिला',
        itemCaption__paidForPlan: '{{ planName }} योजना के लिए भुगतान किया गया',
        itemCaption__proratedCredit: 'आनुपातिक क्रेडिट',
        itemCaption__subscribedAndPaidForPlan: '{{ planName }} योजना की सदस्यता ली और भुगतान किया',
        notFound: 'कोई चालान नहीं मिला',
        tableHeader__amount: 'राशि',
        tableHeader__date: 'तारीख',
        title: 'चालान',
      ...
      subscriptionsListSection: {
        actionLabel__newSubscription: 'नई सदस्यता',
        actionLabel__switchPlan: 'योजना बदलें',
        tableHeader__edit: 'संपादित करें',
        tableHeader__plan: 'योजना',
        tableHeader__startDate: 'प्रारंभ तिथि',
        title: 'सदस्यताएं',
      },
      subscriptionsSection: {
        actionLabel__default: 'डिफ़ॉल्ट',
      },
      switchPlansSection: {
        title: 'योजना बदलें',
      },
    ...
    plansPage: {
      alerts: {
        noPermissionsToManageBilling: 'बिलिंग प्रबंधित करने की अनुमति नहीं है',
      },
      title: 'योजनाएं',
    },
    profilePage: {
  ...
  signIn: {
    ...
    start: {
      ...
      alternativePhoneCodeProvider: {
        actionLink: 'वैकल्पिक प्रदाता का उपयोग करें',
        label: 'वैकल्पिक फोन कोड प्रदाता',
        subtitle: 'दूसरे प्रदाता से कोड प्राप्त करें',
        title: 'वैकल्पिक फोन कोड प्रदाता',
      },
      subtitle: 'वापस आने पर स्वागत है! जारी रखने के लिए कृपया साइन इन करें',
      subtitleCombined: 'जारी रखने के लिए कृपया साइन इन करें',
  ...
  unstable__errors: {
    ...
    form_code_incorrect: 'दर्ज किया गया कोड गलत है।',
    ...
    form_param_type_invalid: 'दर्ज किया गया मान अमान्य प्रकार का है।',
    form_param_type_invalid__email_address: 'ईमेल पता एक वैध ईमेल पता होना चाहिए।',
    form_param_type_invalid__phone_number: 'फोन नंबर एक वैध अंतरराष्ट्रीय प्रारूप में होना चाहिए।',
    ...
    session_exists: 'एक सत्र पहले से मौजूद है। कृपया पहले साइन आउट करें।',
