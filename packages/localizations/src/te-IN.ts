...
export const teIN: LocalizationResource = {
  ...
  configureSSO: {
    ...
    verifyDomainsStep: {
      ...
      subtitle: 'SSOని కాన్ఫిగర్ చేయడానికి డొమైన్‌ను పేర్కొని ధృవీకరించండి.',
      ...
      txtRecordInstructions: {
        paragraph1: 'ఈ TXT రికార్డ్‌ను మీ DNS ప్రొవైడర్‌కు జోడించండి.',
        paragraph2:
          'రికార్డ్ లైవ్ అయిన వెంటనే మేము స్వయంచాలకంగా ధృవీకరిస్తాము. ఇది సాధారణంగా ఒక నిమిషం కంటే తక్కువ సమయం పడుతుంది, అయితే ఇప్పటికే ఉన్న TXT రికార్డ్‌ను అప్‌డేట్ చేయడానికి కొంచెం ఎక్కువ సమయం పట్టవచ్చు.',
      },
      txtRecordTable: {
        columns: {
          domain: 'డొమైన్',
