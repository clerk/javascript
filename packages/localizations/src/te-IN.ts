...
export const teIN: LocalizationResource = {
  ...
  apiKeys: {
    action__add: 'కొత్త కీని జోడించండి',
    action__search: 'కీలను వెతకండి',
    createdAndExpirationStatus__expiresOn:
      "సృష్టించబడింది {{ createdDate | shortDate('te-IN') }} • గడువు ముగుస్తుంది {{ expiresDate | longDate('te-IN') }}",
    createdAndExpirationStatus__never: "సృష్టించబడింది {{ createdDate | shortDate('te-IN') }} • గడువు ముగియదు",
    detailsTitle__emptyRow: 'API కీలు కనుగొనబడలేదు',
    formButtonPrimary__add: 'కీని సృష్టించండి',
    formFieldCaption__expiration__expiresOn: '{{ date }} గడువు ముగుస్తుంది',
    formFieldCaption__expiration__never: 'ఈ కీ ఎప్పుడూ గడువు ముగియదు',
    ...
    formFieldOption__expiration__never: 'ఎప్పుడూ లేదు',
    formHint: 'కొత్త కీని రూపొందించడానికి పేరు అందించండి. మీరు దీన్ని ఎప్పుడైనా రద్దు చేయవచ్చు.',
    formTitle: 'కొత్త API కీని జోడించండి',
    lastUsed__days: '{{days}}రో క్రితం',
    lastUsed__hours: '{{hours}}గం క్రితం',
    lastUsed__minutes: '{{minutes}}ని క్రితం',
    lastUsed__months: '{{months}}నె క్రితం',
    lastUsed__seconds: '{{seconds}}సె క్రితం',
    lastUsed__years: '{{years}}సం క్రితం',
    menuAction__revoke: 'కీని రద్దు చేయండి',
    revokeConfirmation: {
      confirmationText: 'రద్దు చేయండి',
      formButtonPrimary__revoke: 'కీని రద్దు చేయండి',
      formHint: 'మీరు ఈ సీక్రెట్ కీని తొలగించాలనుకుంటున్నారా?',
      formTitle: '"{{apiKeyName}}" సీక్రెట్ కీని రద్దు చేయాలా?',
    },
  },
  backButton: 'వెనుకకు',
  ...
  commerce: {
    ...
    annually: 'వార్షికంగా',
    availableFeatures: 'అందుబాటులో ఉన్న లక్షణాలు',
    billedAnnually: 'వార్షిక బిల్లింగ్',
    billedMonthlyOnly: 'కేవలం మాసిక బిల్లింగ్',
    cancelFreeTrial: 'ఉచిత ట్రయల్ రద్దు చేయండి',
    cancelFreeTrialAccessUntil: 'వరకు ఉచిత ట్రయల్ యాక్సెస్ రద్దు',
    cancelFreeTrialTitle: 'ఉచిత ట్రయల్ రద్దు చేయండి',
    cancelSubscription: 'సబ్స్క్రిప్షన్ రద్దు చేయండి',
    cancelSubscriptionAccessUntil: 'వరకు సబ్స్క్రిప్షన్ యాక్సెస్ రద్దు',
    cancelSubscriptionNoCharge: 'సబ్స్క్రిప్షన్ రద్దు - ఎటువంటి ఛార్జీ లేదు',
    cancelSubscriptionTitle: 'సబ్స్క్రిప్షన్ రద్దు చేయండి',
    cannotSubscribeMonthly: 'మాసిక సబ్స్క్రిప్షన్ చేయలేరు',
    cannotSubscribeUnrecoverable: 'సబ్స్క్రిప్షన్ చేయలేరు - కోలుకోలేని లోపం',
    checkout: {
      description__paymentSuccessful: 'మీ చెల్లింపు విజయవంతంగా ప్రాసెస్ చేయబడింది',
      description__subscriptionSuccessful: 'మీ చందా విజయవంతంగా సృష్టించబడింది',
      downgradeNotice: 'మీ ప్లాన్ తగ్గించబడుతుంది',
      emailForm: {
        subtitle: 'చెక్అవుట్ పూర్తి చేయడానికి మీ ఇమెయిల్ అందించండి',
      ...
      lineItems: {
        ...
        title__totalPaid: 'మొత్తం చెల్లింపు',
      },
      pastDueNotice: 'గడువు దాటిన చెల్లింపు గమనిక',
      perMonth: '/నెలకు',
      title: 'చెక్అవుట్',
    ...
    defaultFreePlanActive: 'డిఫాల్ట్ ఉచిత ప్లాన్ చురుకుగా ఉంది',
    free: 'ఉచితం',
    getStarted: 'ప్రారంభించండి',
    keepFreeTrial: 'ఉచిత ట్రయల్ కొనసాగించండి',
    keepSubscription: 'సబ్స్క్రిప్షన్ కొనసాగించండి',
    manage: 'నిర్వహించండి',
    ...
    paymentSource: {
      applePayDescription: {
        annual: 'Apple Pay • వార్షిక',
        monthly: 'Apple Pay • నెలవారీ',
      },
      dev: {
        anyNumbers: 'ఏదైనా నంబర్లు',
    ...
    subscriptionDetails: {
     beginsOn: 'మొదలవుతుంది',
    currentBillingCycle: 'ప్రస్తుత బిల్లింగ్ చక్రం',
    endsOn: 'ముగుస్తుంది',
    firstPaymentAmount: 'మొదటి చెల్లింపు మొత్తం',
    firstPaymentOn: 'మొదటి చెల్లింపు తేదీ',
    nextPaymentAmount: 'తదుపరి చెల్లింపు మొత్తం',
    nextPaymentOn: 'తదుపరి చెల్లింపు తేదీ',
    pastDueAt: 'గడువు దాటిన తేదీ',
    renewsAt: 'పునరుద్ధరణ తేదీ',
    subscribedOn: 'సబ్‌స్క్రైబ్ చేసిన తేదీ',
    title: 'శీర్షిక',
    trialEndsOn: 'ట్రయల్ ముగింపు తేదీ',
    trialStartedOn: 'ట్రయల్ ప్రారంభ తేదీ',
    },
    subtotal: 'ఉప మొత్తం',
    switchPlan: 'ఈ ప్లాన్‌కు మారండి',
    switchToAnnual: 'వార్షిక ప్లాన్‌కు మారండి',
    switchToAnnualWithAnnualPrice: 'వార్షిక ప్లాన్‌కు మారండి {{price}}/సంవత్సరం',
    switchToMonthly: 'నెలవారీ ప్లాన్‌కు మారండి',
    switchToMonthlyWithPrice: 'నెలవారీ ప్లాన్‌కు మారండి {{price}}/నెల',
    totalDue: 'మొత్తం చెల్లించాల్సిన మొత్తం',
    totalDueToday: 'ఈరోజు చెల్లించాల్సిన మొత్తం',
    viewFeatures: 'లక్షణాలను చూడండి',
    viewPayment: 'చెల్లింపును చూడండి',
    year: 'సంవత్సరం',
  },
  createOrganization: {
  ...
  dividerText: 'లేదా',
  footerActionLink__alternativePhoneCodeProvider: 'మరొక ఫోన్ కోడ్ ప్రొవైడర్ ఉపయోగించండి',
  ...
  formFieldInputPlaceholder__apiKeyDescription: 'API కీ వర్ణన',
  formFieldInputPlaceholder__apiKeyExpirationDate: 'గడువు తేదీని ఎంచుకోండి',
  formFieldInputPlaceholder__apiKeyName: 'API కీ పేరు',
  ...
  formFieldInputPlaceholder__username: 'వినియోగదారు పేరును నమోదు చేయండి',
  formFieldLabel__apiKeyDescription: 'API కీ వర్ణన',
  formFieldLabel__apiKeyExpiration: 'API కీ గడువు',
  formFieldLabel__apiKeyName: 'API కీ పేరు',
  ...
  organizationProfile: {
    ...
    billingPage: {
      paymentHistorySection: {
        ...
        notFound: 'చెల్లింపు చరిత్ర కనుగొనబడలేదు',
      ...
      paymentSourcesSection: {
        ...
        payWithTestCardButton: 'టెస్ట్ కార్డ్‌తో చెల్లించండి',
        removeResource: {
      ...
      start: {
        ...
        headerTitle__subscriptions: 'చందాలు',
      },
      statementsSection: {
        empty: 'స్టేట్‌మెంట్‌లు లేవు',
        itemCaption__paidForPlan: '{{plan}} ప్లాన్ కోసం చెల్లించారు',
        itemCaption__proratedCredit: 'ప్రో-రేటెడ్ క్రెడిట్',
        itemCaption__subscribedAndPaidForPlan: '{{plan}} ప్లాన్‌కు చందా చేసి చెల్లించారు',
        notFound: 'స్టేట్‌మెంట్‌లు కనుగొనబడలేదు',
        tableHeader__amount: 'మొత్తం',
        tableHeader__date: 'తేదీ',
        title: 'స్టేట్‌మెంట్‌లు',
        totalPaid: 'మొత్తం చెల్లించిన మొత్తం',
      },
      subscriptionsListSection: {
        actionLabel__newSubscription: 'కొత్త చందా',
        actionLabel__switchPlan: 'ప్లాన్ మార్చండి',
        tableHeader__edit: 'సవరించండి',
    ...
    plansPage: {
      alerts: {
        noPermissionsToManageBilling: 'బిల్లింగ్ నిర్వహించడానికి అనుమతులు లేవు',
      },
      title: 'ప్లాన్‌లు',
    },
    profilePage: {
  ...
  signIn: {
    ...
    alternativePhoneCodeProvider: {
      formTitle: 'ధృవీకరణ కోడ్',
      resendButton: 'కోడ్ అందలేదా? మళ్ళీ పంపండి',
      subtitle: 'మీ ఫోన్‌కు పంపిన కోడ్‌ను నమోదు చేయండి',
      title: 'ఫోన్ కోడ్‌ను నమోదు చేయండి',
    },
    backupCodeMfa: {
    ...
    start: {
      ...
      alternativePhoneCodeProvider: {
        actionLink: 'మరొక ప్రొవైడర్ ఉపయోగించండి',
        label: 'ఇతర ఫోన్ కోడ్ ప్రొవైడర్',
        subtitle: 'మరొక ప్రొవైడర్ నుండి కోడ్ పొందండి',
        title: 'ఇతర ఫోన్ కోడ్ ప్రొవైడర్',
      },
      subtitle: 'మళ్ళీ స్వాగతం! కొనసాగించడానికి దయచేసి సైన్ ఇన్ చేయండి',
      subtitleCombined: 'మళ్ళీ స్వాగతం! కొనసాగించడానికి దయచేసి సైన్ ఇన్ చేయండి లేదా ఖాతా సృష్టించండి',
  ...
  unstable__errors: {
    ...
    form_code_incorrect: 'తప్పు కోడ్. దయచేసి మళ్ళీ ప్రయత్నించండి.',
    ...
    form_param_type_invalid: 'చెల్లని ఫీల్డ్ రకం. దయచేసి మళ్ళీ ప్రయత్నించండి.',
    form_param_type_invalid__email_address: 'చెల్లని ఇమెయిల్ చిరునామా. దయచేసి మళ్ళీ ప్రయత్నించండి.',
    form_param_type_invalid__phone_number: 'చెల్లని ఫోన్ నంబర్. దయచేసి మళ్ళీ ప్రయత్నించండి.',
    ...
    session_exists: 'సెషన్ ఇప్పటికే ఉంది. దయచేసి మొదట సైన్ అవుట్ చేయండి.',
