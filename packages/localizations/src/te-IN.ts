...
export const teIN: LocalizationResource = {
  ...
  commerce: {
    ...
    billedMonthlyOnly: 'నెలవారీ మాత్రమే బిల్లింగ్',
    cancelSubscription: 'చందాని రద్దు చేయండి',
    cancelSubscriptionAccessUntil: '{{date}} వరకు ప్రాప్యత ఉంటుంది',
    cancelSubscriptionNoCharge: 'మీకు ఎటువంటి అదనపు ఛార్జీలు లేవు',
    cancelSubscriptionTitle: 'చందాని రద్దు చేయండి',
    cannotSubscribeMonthly: 'నెలవారీ చందాలు అందుబాటులో లేవు',
    cannotSubscribeUnrecoverable: 'చందా లోపం కారణంగా కొనసాగించలేము',
    checkout: {
    ...
    keepSubscription: 'చందాను కొనసాగించండి',
    manage: 'నిర్వహించండి',
    ...
    subscriptionDetails: {
      ...
      currentBillingCycle: 'ప్రస్తుత బిల్లింగ్ సైకిల్',
      endsOn: 'ముగుస్తుంది',
