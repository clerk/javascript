...
export const elGR: LocalizationResource = {
  ...
  signIn: {
    ...
    resetPassword: {
      ...
      successMessage: 'Ο κωδικός πρόσβασής σας αλλάχθηκε με επιτυχία. Σας συνδέουμε, παρακαλώ περιμένετε.',
    },
    resetPasswordMfa: {
    ...
    alternativeMethods: {
      ...
      getHelp: {
        title: 'Λήψη βοήθειας',
        content:
          'Εάν αντιμετωπίζετε δυσκολία στη σύνδεση στον λογαριασμό σας, στείλτε μας email και θα συνεργαστούμε μαζί σας για να αποκαταστήσουμε την πρόσβαση το συντομότερο δυνατόν.',
  ...
  profilePage: {
    ...
    fileDropAreaHint: 'Ανεβάστε μια εικόνα σε μορφή JPG, PNG, GIF ή WEBP μικρότερη από 10 MB',
    readonly:
  ...
  emailAddressPage: {
    ...
    emailLink: {
      ...
      resendButton: 'Δεν λάβατε ένα σύνδεσμο; Επανάληψη αποστολής',
      successMessage: 'Το email {{identifier}} έχει προστεθεί στον λογαριασμό σας.',
    },
    removeResource: {
  ...
  mfaPhoneCodePage: {
    ...
    subtitle__unavailablePhoneNumbers:
      'Δεν υπάρχουν διαθέσιμοι αριθμοί τηλεφώνου για εγγραφή στη διπλή επαλήθευση με κωδικούς SMS.',
    successMessage:
  ...
  organizationProfile: {
    ...
    profilePage: {
      ...
      successMessage: 'Η οργάνωση έχει ενημερωθεί.',
      dangerSection: {
        title: 'Κίνδυνος',
        leaveOrganization: {
          ...
          messageLine2: 'Αυτή η ενέργεια είναι μόνιμη και ανεπανόρθωτη.',
