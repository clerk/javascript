...
export const zhTW: LocalizationResource = {
  ...
  userProfile: {
    ...
    start: {
      ...
      connectedAccountsSection: {
        ...
        subtitle__reauthorize:
          "所需的權限已更新，您可能會遇到功能限制。請重新授權此應用程序，以避免任何問題",
    ...
    mfaTOTPPage: {
      ...
      authenticatorApp: {
        infoText__ableToScan:
          "在您的驗證器應用中設置一個新的登錄方法，並掃描下面的二維碼將其鏈接到您的賬戶。",
        infoText__unableToScan:
          "在驗證器中設置一個新的登錄方法，並輸入下面提供的 Key。",
        inputLabel__unableToScan1:
          "確保啟用了基於時間或一次性密碼，然後完成鏈接您的賬戶。",
        inputLabel__unableToScan2:
          "或者，如果您的驗證器支持 TOTP URIs，您也可以覆制完整的 URI。",
    ...
    mfaPhoneCodePage: {
      ...
      subtitle__availablePhoneNumbers:
        "選擇一個電話號碼來注冊短信驗證碼兩步驗證。",
      subtitle__unavailablePhoneNumbers:
        "沒有可用的電話號碼來注冊短信驗證碼兩步驗證。",
      successMessage:
    ...
    backupCodePage: {
      ...
      infoText2:
        "保密並安全存儲備份代碼。如果您懷疑它們已經泄露，您可以重新生成備份代碼。",
      successSubtitle:
        "如果您失去了驗證設備的訪問權限，您可以使用其中之一登錄您的賬戶。",
      successMessage:
    ...
    profilePage: {
      ...
      dangerSection: {
        ...
        leaveOrganization: {
          title: "離開組織",
          messageLine1:
            "您確定要離開此組織嗎？您將失去對此組織及其應用程序的訪問權限。",
  ...
  unstable__errors: {
    ...
    captcha_invalid:
      "由於安全驗證失敗，注冊未成功。請刷新頁面重試或聯系支持獲取更多幫助。",
    form_password_pwned:
      "這個密碼在數據泄露中被發現，不能使用，請換一個密碼試試。",
