...
export const zhTW: LocalizationResource = {
  ...
  billing: {
    ...
    cancelFreeTrialAccessUntil:
      "您的試用期將維持有效直到 {{ date | longDate('zh-TW') }}。在那之後，您將失去對試用期功能的存取。您不會被收取費用。",
  ...
  unstable__errors: {
    ...
    form_password_untrusted__sign_in:
      '您的密碼可能已外洩。為保護您的帳戶，請改用其他登入方式。登入後您將需要重設密碼。',
    ...
    password_confirmation_attempt_remaining: '密碼錯誤。您還有 1 次嘗試機會。',
    password_confirmation_attempts_remaining: '密碼錯誤。您還有 {{remainingAttempts}} 次嘗試機會。',
    password_confirmation_session_ended: '由於密碼確認嘗試次數已達上限，您的工作階段已結束。請重新登入以繼續。',
