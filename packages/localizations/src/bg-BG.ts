...
export const bgBG: LocalizationResource = {
  ...
  billing: {
    ...
    cancelFreeTrial: 'Откажи пробния период',
  ...
  formFieldInputPlaceholder__apiKeyDescription: 'Опишете как ще използвате този API ключ',
  formFieldInputPlaceholder__apiKeyExpirationDate: 'Изберете дата на изтичане',
  formFieldInputPlaceholder__apiKeyName: 'Име на API ключ',
  ...
  formFieldInputPlaceholder__firstName: 'Вашето собствено име',
  ...
  formFieldInput__emailAddress_format: 'Пример: name@example.com',
  ...
  identityPreviewEditButton__emailAddress: 'Променете имейл адреса',
  identityPreviewEditButton__identifier: 'Променете идентификатора',
  identityPreviewEditButton__phoneNumber: 'Променете телефонния номер',
  impersonationFab: {
