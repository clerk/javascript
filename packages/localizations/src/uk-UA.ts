...
export const ukUA: LocalizationResource = {
  ...
  billing: {
    ...
    seatBreakdownIncludedPlural: '{{chargeable}} місць по {{rate}}/міс ({{totalSeats}} всього - {{included}} включено)',
    seatBreakdownIncludedSingular: '1 місце по {{rate}}/міс ({{totalSeats}} всього - {{included}} включено)',
    seatBreakdownPlural: '{{chargeable}} місць по {{rate}}/міс',
  ...
  dividerText: 'або',
  footerActionLink__alternativePhoneCodeProvider: 'Надіслати код через SMS',
  ...
  signIn: {
    ...
    start: {
      ...
      actionLink__use_passkey: 'Використати ключ доступу',
