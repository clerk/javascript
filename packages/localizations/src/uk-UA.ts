...
export const ukUA: LocalizationResource = {
  ...
  signIn: {
    ...
    totpMfa: {
      ...
      formSubtitle: 'Введіть верифікаційний код з Вашого аутнетифікатора',
    },
    backupCodeMfa: {
  ...
  userProfile: {
    ...
    start: {
      ...
      connectedAccountsSection: {
        ...
        subtitle__reauthorize:
          'Потрібна повторна авторизація цієї програми через оновлення необхідних областей видимості, і ви можете відчувати обмежену функціональність. Будь ласка, повторно авторизуйте цю програму, щоб уникнути проблем',
    ...
    mfaTOTPPage: {
      ...
      successMessage:
        'Двоетапна перевірка наразі ввімкнена. Під час входу в систему вам потрібно буде ввести верифікаційний код із цього додатка як додатковий крок.',
      authenticatorApp: {
