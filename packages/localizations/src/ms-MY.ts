...
export const msMY: LocalizationResource = {
  ...
  taskChooseOrganization: {
    signOut: {
      ...
      actionText: 'Didaftarkan sebagai {{identifier}}',
    },
    createOrganization: {
      title: 'Sediakan akaun anda',
      subtitle: 'Beritahu kami sedikit tentang organisasi anda',
      formButtonSubmit: 'Cipta organisasi baharu',
  ...
  apiKeys: {
    ...
    detailsTitle__emptyRow: 'Tiada kunci API dijumpai',
    formButtonPrimary__add: 'Cipta kunci',
    formFieldCaption__expiration__expiresOn: 'Tamat tempoh {{ date }}',
    formFieldCaption__expiration__never: 'Kunci ini tidak akan pernah tamat tempoh',
    ...
    revokeConfirmation: {
      confirmationText: 'Adakah anda pasti mahu membatalkan kunci API ini?',
      formButtonPrimary__revoke: 'Batalkan kunci',
      formHint: 'Tindakan ini tidak boleh dibatalkan.',
      formTitle: 'Batalkan kunci API',
    },
  },
  backButton: 'Kembali',
  badge__activePlan: 'Pelan aktif',
  badge__canceledEndsAt: 'Dibatalkan • Berakhir {{ date }}',
  ...
  commerce: {
    ...
    billedMonthlyOnly: 'Dibilkan bulanan sahaja',
    cancelFreeTrial: 'Batalkan percubaan percuma',
    cancelFreeTrialAccessUntil: 'Batalkan percubaan percuma akses sehingga',
    cancelFreeTrialTitle: 'Batalkan Percubaan Percuma',
    cancelSubscription: 'Batalkan langganan',
    cancelSubscriptionAccessUntil: 'Batalkan langganan akses sehingga',
    cancelSubscriptionNoCharge: 'Batalkan langganan tanpa caj',
    cancelSubscriptionTitle: 'Batalkan Langganan',
    cannotSubscribeMonthly: 'Tidak boleh melanggan secara bulanan',
    cannotSubscribeUnrecoverable: 'Tidak boleh melanggan - tidak dapat dipulihkan',
    checkout: {
      description__paymentSuccessful: 'Pembayaran anda berjaya',
      description__subscriptionSuccessful: 'Langganan anda berjaya',
      downgradeNotice: 'Pelan diturunkan taraf',
      emailForm: {
        subtitle: 'Masukkan alamat e-mel',
        title: 'Alamat e-mel',
      },
      lineItems: {
      ...
      pastDueNotice: 'Pembayaran tertunggak',
      perMonth: 'sebulan',
      title: 'Bayar',
    ...
    defaultFreePlanActive: 'Pelan percuma lalai aktif',
    free: 'Percuma',
    getStarted: 'Mulakan',
    ...
    paymentSource: {
      applePayDescription: {
        annual: 'Pembayaran tahunan dengan Apple Pay',
        monthly: 'Pembayaran bulanan dengan Apple Pay',
      },
      dev: {
    ...
    subscriptionDetails: {
      ...
      currentBillingCycle: 'Kitaran bil semasa',
      ...
      title: 'Tajuk',
      trialEndsOn: 'Percubaan berakhir pada',
      trialStartedOn: 'Percubaan dimulakan pada',
    },
    subtotal: 'Subjumlah',
    switchPlan: 'Tukar ke pelan ini',
    switchToAnnual: 'Tukar ke tahunan',
    switchToAnnualWithAnnualPrice: 'Tukar ke tahunan {{ price }}',
    switchToMonthly: 'Tukar ke bulanan',
    switchToMonthlyWithPrice: 'Tukar ke bulanan {{ price }}',
    totalDue: 'Jumlah terhutang',
    totalDueToday: 'Jumlah terhutang hari ini',
  ...
  dividerText: 'atau',
  footerActionLink__alternativePhoneCodeProvider: 'Pembekal kod telefon alternatif',
  ...
  formFieldInputPlaceholder__apiKeyDescription: 'Perihalan kunci API',
  formFieldInputPlaceholder__apiKeyExpirationDate: 'Tarikh tamat tempoh',
  formFieldInputPlaceholder__apiKeyName: 'Nama kunci API',
  ...
  formFieldInputPlaceholder__username: 'Nama pengguna',
  formFieldLabel__apiKeyDescription: 'Perihalan kunci API',
  formFieldLabel__apiKeyExpiration: 'Tamat tempoh kunci API',
  formFieldLabel__apiKeyName: 'Nama kunci API',
  ...
  organizationProfile: {
    ...
    billingPage: {
      paymentHistorySection: {
        empty: 'Tiada sejarah pembayaran ditemui',
        notFound: 'Sejarah pembayaran tidak ditemui',
      ...
      statementsSection: {
        ...
        itemCaption__paidForPlan: 'Dibayar untuk pelan {{ planName }}',
        itemCaption__proratedCredit: 'Kredit berkadar',
        itemCaption__subscribedAndPaidForPlan: 'Dilanggan dan dibayar untuk pelan {{ planName }}',
      ...
      subscriptionsListSection: {
        actionLabel__newSubscription: 'Langganan baharu',
    ...
    plansPage: {
      alerts: {
        noPermissionsToManageBilling: 'Tiada kebenaran untuk menguruskan pengebilan.',
      },
      title: 'Pelan',
    },
    profilePage: {
  ...
  signIn: {
    ...
    start: {
      ...
      alternativePhoneCodeProvider: {
        actionLink: 'Gunakan kaedah lain',
        label: 'Tidak menerima kod?',
        subtitle: 'Kod pengesahan telah dihantar ke {{phoneNumber}}',
        title: 'Periksa telefon anda',
      },
      subtitle: 'Selamat kembali! Sila daftar masuk untuk meneruskan',
      subtitleCombined: 'untuk meneruskan ke {{applicationName}}',
  ...
  unstable__errors: {
    ...
    form_code_incorrect: 'Kod yang dimasukkan tidak betul. Sila cuba lagi.',
    ...
    form_param_type_invalid: 'Jenis parameter tidak sah.',
    form_param_type_invalid__email_address: 'Alamat e-mel tidak sah.',
    form_param_type_invalid__phone_number: 'Nombor telefon tidak sah.',
    ...
    session_exists: 'Sesi sudah wujud.',
