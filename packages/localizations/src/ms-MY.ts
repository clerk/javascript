...
export const msMY: LocalizationResource = {
  ...
  commerce: {
    ...
    cancelSubscriptionAccessUntil: 'Akses sehingga {{ date }}',
    cancelSubscriptionNoCharge: 'Tiada caj akan dikenakan',
    cancelSubscriptionTitle: 'Batalkan langganan',
    cannotSubscribeMonthly: 'Langganan bulanan tidak tersedia',
    cannotSubscribeUnrecoverable: 'Langganan tidak dapat dipulihkan',
    checkout: {
    ...
    subscriptionDetails: {
      ...
      nextPaymentOn: 'Pembayaran seterusnya pada {{ date }}',
      pastDueAt: 'Tertunggak pada {{ date }}',
      renewsAt: 'Diperbaharui pada {{ date }}',
      subscribedOn: 'Dilanggan pada {{ date }}',
