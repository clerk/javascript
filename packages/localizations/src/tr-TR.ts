...
export const trTR: LocalizationResource = {
  ...
  unstable__errors: {
    already_a_member_in_organization: 'Bu organizasyonda zaten bir üyesiniz.',
    captcha_invalid:
      'Güvenlik doğrulaması başarısız olduğu için kaydolunamadı. Lütfen tekrar denemek için sayfayı yenileyin veya daha fazla yardım için destek ekibine başvurun.',
    captcha_unavailable:
      'Bot doğrulaması başarısız olduğu için kayıt işlemi başarısız oldu. Lütfen tekrar denemek için sayfayı yenileyin veya daha fazla yardım için destek ekibine başvurun.',
    form_code_incorrect: 'Kod hatalı.',
    form_identifier_exists__email_address: 'Bu e-posta adresi zaten kullanımda.',
    form_identifier_exists__phone_number: 'Bu telefon numarası zaten kullanımda.',
    form_identifier_exists__username: 'Bu kullanıcı adı zaten kullanımda.',
    form_identifier_not_found: 'Tanımlayıcı bulunamadı.',
    form_param_format_invalid: 'Geçersiz parametre biçimi.',
    ...
    form_param_max_length_exceeded__first_name: 'Ad 256 karakterden fazla olamaz.',
    form_param_max_length_exceeded__last_name: 'Soyad 256 karakterden fazla olamaz.',
    form_param_max_length_exceeded__name: 'İsim 256 karakterden fazla olamaz.',
    form_param_nil: 'Parametre boş olamaz.',
    form_param_value_invalid: 'Geçersiz parametre değeri.',
    ...
    form_password_size_in_bytes_exceeded:
      'Şifreniz izin verilen maksimum bayt sayısını aştı, lütfen kısaltın veya bazı özel karakterleri kaldırın.',
    form_password_validation_failed: 'Şifre doğrulaması başarısız oldu.',
    ...
    identification_deletion_failed: 'Son tanımlayıcınızı silemezsiniz.',
    not_allowed_access: 'Erişim izni verilmedi.',
    ...
    organization_membership_quota_exceeded: 'Organizasyonun üye kotası aşıldı.',
    organization_minimum_permissions_needed: 'Bu işlemi gerçekleştirmek için minimum izinler gereklidir.',
    passkey_already_exists: 'Bu hesapta zaten bir geçiş anahtarı mevcut.',
    passkey_not_supported: 'Geçiş anahtarları şu anda desteklenmiyor.',
    passkey_pa_not_supported: 'Bu platformda geçiş anahtarları desteklenmiyor.',
    ...
    zxcvbn: {
      ...
      suggestions: {
        ...
        anotherWord: 'Şifreniz nadir görülen sözcüklerden daha fazlasını içersin.',
        associatedYears: 'Kendinizle alakalı yılları kullanmayın.',
        capitalization: 'Sadece ilk harfi büyük yazmak yerine rastgele büyük harfler kullanın.',
        dates: 'Kendinizle alakalı tarihleri kullanmayın.',
        l33t: '"a" yerine "@" gibi tahmin edilebilir harf ikamelerinden kaçının.',
        longerKeyboardPattern:
          'Klavyede elinizin yönünü birden çok kez değiştirerek oluşturulan uzun desenler tercih edin.',
        noNeed: 'Özel karakter, sayı veya büyük harf olmadan da güçlü bir şifre oluşturabilirsiniz.',
        pwned: 'Bu şifreyi başka bir yerde kullanıyorsanız, değiştirmeniz önerilir.',
        ...
        sequences: 'Yaygın sıralı desenleri kullanmayın.',
      ...
      warnings: {
        ...
        dates: 'Tarihlerin tahmini kolaydır.',
        ...
        pwned: 'Bu şifre bir veri ihlalinde ele geçirilmiş.',
        recentYears: 'Yakın yıllar kolay tahmin edilir.',
        sequences: '"abc" gibi yaygın sıralamalar kolay tahmin edilir.',
        similarToCommon: 'Bu şifre yaygın kullanılan şifrelere çok benziyor.',
  ...
  userProfile: {
    ...
    profilePage: {
      ...
      readonly:
        'Profil bilgileriniz kurumsal bağlantı tarafından sağlanmaktadır ve düzenlenemez.',
