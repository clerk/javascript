...
export const trTR: LocalizationResource = {
  ...
  unstable__errors: {
    ...
    form_identifier_exists__email_address: 'Bu e-posta adresi zaten kullanılıyor. Lütfen farklı bir adres deneyin.',
    form_identifier_exists__phone_number: 'Bu telefon numarası zaten kullanılıyor. Lütfen başka bir numara deneyin.',
    form_identifier_exists__username: 'Bu kullanıcı adı zaten kullanılıyor. Lütfen farklı bir tane deneyin.',
    ...
    form_param_max_length_exceeded__first_name: 'Adınız 256 karakteri geçmemelidir.',
    ...
    passkey_pa_not_supported: 'Kayıt için bir platform doğrulayıcısı gerekiyor ancak cihaz bunu desteklemiyor.',
    passkey_registration_cancelled: 'Geçiş anahtarı kaydı iptal edildi veya süresi doldu.',
    passkey_retrieval_cancelled: 'Geçiş anahtarı doğrulaması iptal edildi veya süresi doldu.',
    passwordComplexity: {
