...
export const csCZ: LocalizationResource = {
  ...
  unstable__errors: {
    ...
    form_password_size_in_bytes_exceeded:
      'Vaše heslo překročilo maximální povolený počet bajtů. Zkrátíte ho nebo odstraňte některé speciální znaky.',
    form_password_validation_failed: 'Heslo je neplatné.',
    form_username_invalid_character: 'Uživatelské jméno obsahuje neplatné znaky.',
    form_username_invalid_length: 'Uživatelské jméno má neplatnou délku.',
    identification_deletion_failed: 'Nemůžete odstranit svou poslední identifikaci.',
    not_allowed_access: 'Není povolen přístup.',
    organization_domain_blocked: 'Doména organizace je blokována.',
    organization_domain_common: 'Doména je příliš běžná.',
    organization_membership_quota_exceeded: 'Překročili jste kvótu pro členství v organizaci.',
    organization_minimum_permissions_needed: 'Pro přístup jsou potřebná minimální oprávnění.',
    passkey_already_exists: 'Passkey již existuje.',
    passkey_not_supported: 'Passkey není podporováno.',
    passkey_pa_not_supported: 'Passkey není podporováno pro tento typ zařízení.',
    passkey_registration_cancelled: 'Registrace Passkey byla zrušena.',
    passkey_retrieval_cancelled: 'Získání Passkey bylo zrušeno.',
    passwordComplexity: {
  ...
  reverification: {
    alternativeMethods: {
      actionLink: 'Získat pomoc',
      actionText: 'Nemáte žádnou z těchto metod?',
      blockButton__backupCode: 'Použít záložní kód',
      blockButton__emailCode: 'Odeslat ověřovací kód na email',
      blockButton__password: 'Použít heslo',
      blockButton__phoneCode: 'Odeslat ověřovací kód na telefon',
      blockButton__totp: 'Použít TOTP',
      getHelp: {
        blockButton__emailSupport: 'Kontaktujte podporu',
        content: 'Pokud potřebujete pomoc s ověřením, kontaktujte naši podporu.',
        title: 'Získat pomoc',
      },
      subtitle: 'Pokud nemáte žádnou z výše uvedených metod, můžete požádat o pomoc.',
      title: 'Ověření',
    },
    backupCodeMfa: {
      subtitle: 'Zadejte záložní kód pro pokračování.',
      title: 'Ověření pomocí záložního kódu',
    },
    emailCode: {
      formTitle: 'Ověřovací kód na email',
      resendButton: 'Znovu odeslat kód',
      subtitle: 'Zkontrolujte svůj email a zadejte kód.',
      title: 'Ověřovací kód',
    },
    noAvailableMethods: {
      message: 'Žádná dostupná autentifikační metoda.',
      subtitle: 'Nelze pokračovat bez ověření.',
      title: 'Chyba při ověřování',
    },
    password: {
      actionLink: 'Použít jiné heslo',
      subtitle: 'Pokud chcete změnit heslo, použijte tuto možnost.',
      title: 'Zadejte své heslo',
    },
    phoneCode: {
      formTitle: 'Ověřovací kód na telefon',
      resendButton: 'Znovu odeslat kód',
      subtitle: 'Zkontrolujte svůj telefon a zadejte kód.',
      title: 'Ověření pomocí kódu na telefon',
    },
    phoneCodeMfa: {
      formTitle: 'Ověřovací kód na telefon',
      resendButton: 'Znovu odeslat kód',
      subtitle: 'Zkontrolujte svůj telefon pro ověření.',
      title: 'Ověření pomocí kódu na telefon',
    },
    totpMfa: {
      formTitle: 'Ověřovací kód TOTP',
      subtitle: 'Zadejte kód z vaší aplikace pro ověření.',
      title: 'Ověření pomocí TOTP',
    },
  },
  waitlist: {
    start: {
