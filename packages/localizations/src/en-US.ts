...
export const enUS: LocalizationResource = {
  ...
  apiKeys: {
    ...
    dates: {
      lastUsed__days: '{{date}}d ago',
      lastUsed__hours: '{{date}}h ago',
      lastUsed__minutes: '{{date}}m ago',
      lastUsed__months: '{{date}}mo ago',
      lastUsed__seconds: '{{date}}s ago',
      lastUsed__years: '{{date}}y ago',
    },
