...
const commonPaymentMethodKeys:
  | Defined<LocalizationResource['billing']>['paymentMethod']
  | Defined<LocalizationResource['commerce']>['paymentSource'] = {
  applePayDescription: {
...
const commongBillingKeys: LocalizationResource['billing'] | LocalizationResource['commerce'] = {
