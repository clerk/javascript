...
export const enUS: LocalizationResource = {
  ...
  billing: {
    ...
    seatBreakdownIncludedSingular: '{{used}} used − {{included}} included → 1 seat at {{rate}}/mo',
    seatBreakdownIncludedPlural: '{{used}} used − {{included}} included → {{chargeable}} seats at {{rate}}/mo',
