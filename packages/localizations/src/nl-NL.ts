...
export const nlNL: LocalizationResource = {
  ...
  formFieldInputPlaceholder__backupCode: 'Backupcode',
  formFieldInputPlaceholder__confirmDeletionUserAccount: 'Verwijder account',
  formFieldInputPlaceholder__emailAddress: 'E-mailadres',
  formFieldInputPlaceholder__emailAddress_username: 'E-mailadres of gebruikersnaam',
  ...
  formFieldInputPlaceholder__organizationDomain: 'Domain',
  formFieldInputPlaceholder__organizationDomainEmailAddress: 'Verificatie-e-mailadres',
  formFieldInputPlaceholder__organizationName: 'Organisatienaam',
  formFieldInputPlaceholder__organizationSlug: 'Slug',
  ...
  unstable__errors: {
    ...
    form_code_incorrect: 'De code is incorrect.',
    form_identifier_exists: 'Deze identiteit is al in gebruik.',
    ...
    form_identifier_not_found: 'Deze identiteit is niet gevonden.',
    form_param_format_invalid: 'Deze waarde is niet geldig.',
    ...
    form_param_nil: 'Deze waarde is vereist.',
    form_password_incorrect: 'Wachtwoord is incorrect.',
    form_password_length_too_short: 'Wachtwoord moet minstens 8 tekens bevatten.',
    ...
    form_username_invalid_character: 'Gebruikersnaam bevat ongeldige tekens.',
    form_username_invalid_length: 'Gebruikersnaam moet minstens 3 tekens bevatten.',
    identification_deletion_failed: 'Je kunt je laatste identificatie niet verwijderen.',
    not_allowed_access: 'Je hebt geen toegang tot deze pagina.',
  ...
  userProfile: {
    ...
    passkeyScreen: {
      removeResource: {
        messageLine1: '{{identifier}} zal verwijderd worden uit dit account.',
        messageLine2: 'Je zal niet meer kunnen inloggen met deze passkey.',
        successMessage: '{{passkey}} is verwijderd uit je account.',
        title: 'Verwijder passkey',
      },
      subtitle__rename: 'Wijzig de naam van deze passkey',
      title__rename: 'Passkey wijzigen',
    },
    passwordPage: {
