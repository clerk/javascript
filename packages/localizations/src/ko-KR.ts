...
export const koKR: LocalizationResource = {
  ...
  organizationProfile: {
    ...
    membersPage: {
      ...
      requestsTab: {
        autoSuggestions: {
          headerSubtitle:
            '해당 도메인으로 가입한 사용자는 조직 참여 요청을 제안받을 수 있어요.',
          headerTitle: '자동 제안',
          primaryButton: '인증된 도메인 관리',
        },
    ...
    verifiedDomainPage: {
      ...
      enrollmentTab: {
        automaticInvitationOption__description:
          '사용자가 가입하면 자동으로 초대되고 언제든지 조직에 참여할 수 있어요.',
  ...
  signUp: {
    ...
    legalConsent: {
      checkbox: {
        label__onlyPrivacyPolicy: '{{ privacyPolicyLink || link("개인정보처리방침") }}에 동의합니다',
        label__onlyTermsOfService: '{{ termsOfServiceLink || link("서비스 약관") }}에 동의합니다',
        label__termsOfServiceAndPrivacyPolicy:
          '{{ termsOfServiceLink || link("서비스 약관") }}과 {{ privacyPolicyLink || link("개인정보처리방침") }}에 동의합니다',
      },
      continue: {
  ...
  unstable__errors: {
    ...
    form_username_invalid_length: '사용자 이름은 {{min_length}}~{{max_length}}자여야 해요.',
    ...
    organization_not_found_or_unauthorized:
      '이 조직의 멤버가 아니에요. 다른 조직을 선택하거나 새로 만들어 주세요.',
  ...
  userProfile: {
    ...
    mfaPhoneCodePage: {
      ...
      successMessage1:
        '로그인할 때 이 휴대폰 번호로 전송된 인증 코드를 추가로 입력해야 해요.',
      successMessage2:
    ...
    phoneNumberPage: {
      infoText: '인증 코드가 포함된 문자 메시지가 이 휴대폰 번호로 전송됩니다. 통신사 요금이 부과될 수 있어요.',
      removeResource: {
    ...
    usernamePage: {
      successMessage: '사용자 이름이 업데이트됐어요.',
