...
export const jaJP: LocalizationResource = {
  ...
  oauthConsent: {
    action__allow: '許可',
    action__deny: '拒否',
    offlineAccessNotice: ' サインアウトするか、アクセスを取り消すまで、サインインした状態が維持されます。',
    redirectNotice: 'アクセスを許可すると、このアプリは {{domainAction}} にリダイレクトします。',
    redirectUriModal: {
      subtitle: '{{applicationName}} を信頼できること、およびこの URL が {{applicationName}} のものであることを確認してください。',
      title: 'リダイレクト URL',
    },
    scopeList: {
      title: '{{applicationName}} に以下へのアクセスを許可します:',
    },
    subtitle: '{{identifier}} に代わって {{applicationName}} へのアクセスを求めています',
    viewFullUrl: '完全な URL を表示',
    warning: '{{applicationName}}（{{domainAction}}）を信頼できることを確認してください。このサイトやアプリと機密データを共有する可能性があります。',
  },
  organizationList: {
