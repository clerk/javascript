...
export const taIN: LocalizationResource = {
  ...
  commerce: {
    ...
    cancelSubscriptionAccessUntil:
      "நீங்கள் {{ date | longDate('ta-IN') }} வரை '{{plan}}' அம்சங்களைப் பயன்படுத்த முடியும், அதன் பிறகு நீங்கள் அணுகலை இழப்பீர்கள்.",
    cancelSubscriptionNoCharge: 'இந்த சந்தாவிற்கு நீங்கள் கட்டணம் செலுத்த வேண்டியதில்லை.',
    cancelSubscriptionTitle: '{{plan}} சந்தாவை ரத்து செய்யவா?',
    cannotSubscribeMonthly:
      'இந்த திட்டத்திற்கு மாதாந்திர கட்டணம் செலுத்தி சந்தா செய்ய முடியாது. இந்த திட்டத்திற்கு சந்தா செய்ய, வருடாந்திர கட்டணத்தைத் தேர்வு செய்ய வேண்டும்.',
    cannotSubscribeUnrecoverable:
      'இந்த திட்டத்திற்கு சந்தா செய்ய முடியாது. உங்கள் தற்போதைய சந்தா இந்த திட்டத்தை விட விலையானது.',
    checkout: {
    ...
    keepSubscription: 'சந்தாவை வைத்திருக்கவும்',
    manage: 'நிர்வகி',
    ...
    subscriptionDetails: {
      ...
      pastDueAt: 'தாமதமானது',
      renewsAt: 'புதுப்பிக்கிறது',
      subscribedOn: 'சந்தா செய்தது',
      title: 'சந்தா',
    },
