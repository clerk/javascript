...
- Bump `@modelcontextprotocol/sdk` from 1.7.0 to 1.25.2 to resolve security alerts ([#7739](https://github.com/clerk/javascript/pull/7739)) by [@wobsoriano](https://github.com/wobsoriano)
