  ...
  useSafeLayoutEffect(() => {
    window.__unstable__onBeforeSetActive = intent => {
      ...
      return new Promise(resolve => {
        ...
        // Once `setActive` performs the navigation, `__unstable__onAfterSetActive` will kick in and perform a router.refresh ensuring the router cache gets clear with the correct authentication context.
