...
- `authMiddleware` handles multi-domain relared properties passed as functions properly ([#1332](https://github.com/clerkinc/javascript/pull/1332)) by [@panteliselef](https://github.com/panteliselef)
