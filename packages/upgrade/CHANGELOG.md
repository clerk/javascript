...
- Improve CLI usability for monorepos: traverse parent directories for pnpm workspace detection and support named catalogs in version resolution ([#7874](https://github.com/clerk/javascript/pull/7874)) by [@jacekradko](https://github.com/jacekradko)
...
- fix(upgrade): add package replacement for @clerk/themes → @clerk/ui ([#7932](https://github.com/clerk/javascript/pull/7932)) by [@jacekradko](https://github.com/jacekradko)
