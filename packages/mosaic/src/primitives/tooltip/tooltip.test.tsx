...
describe('Tooltip', () => {
  ...
  describe('ARIA attributes', () => {
    ...
    it('keeps trigger/positioner aria-describedby intact when a custom id is passed to the positioner', async () => {
      const user = userEvent.setup();
      render(
      ...
      const positionerId = positioner!.getAttribute('id');
      expect(positionerId).not.toBe('consumer-custom-id');
      expect(trigger.getAttribute('aria-describedby')).toBe(positionerId);
    });
  });
