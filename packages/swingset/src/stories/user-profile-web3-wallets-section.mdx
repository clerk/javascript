...
An unverified wallet has a Remove action, and its provider remains available to connect.

<Story name='UnverifiedWallet' storyModule={Stories} />

## Admin Wallet

Wallets added by an administrator can have an address without a provider name or icon.

<Story name='AdminWallet' storyModule={Stories} />
