...
A floating panel anchored to a trigger, holding interactive content. It is a **headless**
primitive: it supplies open state, portalling, floating-ui positioning
