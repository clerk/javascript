...
A small floating label shown on hover or focus, from `@clerk/mosaic/primitives`. It is a **headless**
...
CSS by targeting the `data-*` attributes each part emits. A tooltip never receives or
traps focus.
