...
A controlled step viewport from `@clerk/mosaic/primitives`. It maps controller states to presentational steps, keeps an outgoing step mounted until its CSS animation finishes, and publishes the measurements needed to animate the viewport height. It ships no styles.
