import type { UserProfileBillingHistoryItem } from '@clerk/mosaic/user-profile/user-profile-billing-history-section.view';
import { UserProfileBillingHistorySectionView } from '@clerk/mosaic/user-profile/user-profile-billing-history-section.view';
...
export const meta: StoryMeta = {
  ...
  source: 'packages/mosaic/src/user-profile/user-profile-billing-history-section.view.tsx',
};
