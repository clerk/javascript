import { UserProfileWeb3WalletsSectionView } from '@clerk/mosaic/user-profile/user-profile-web3-wallets-section.view';
...
export const meta: StoryMeta = {
  ...
  source: 'packages/mosaic/src/user-profile/user-profile-web3-wallets-section.view.tsx',
};
