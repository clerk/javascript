...
that would navigate (Manage, Invite, Add organization, Add account) only close the popover here.
...
The org heads it, with **Invite** and the gear (**Manage organization**). **Add organization** trails
