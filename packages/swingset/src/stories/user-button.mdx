...
`headerLayout='inline'` (the default) trails the workspace with the actions, the gear as an icon
alone. `headerLayout='stacked'` runs them under it as full-width labelled buttons.
...
<Story
  name='UserPriorityStackedHeader'
  storyModule={UserButtonStories}
/>
