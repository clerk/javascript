...
`modePriority='user'` leads with the account instead. With an organization active, the account's
avatar is badged with it, and the header carries **Settings** for the account and **Invite** for the
organization.

<Story
  name='CombinedUserPriority'
  storyModule={UserButtonStories}
/>

<Story
  name='CombinedUserPriorityAvatarTrigger'
  storyModule={UserButtonStories}
/>
...
| `.cl-user-button-group`              |                                         |
| `.cl-user-button-separator`          |                                         |
| `.cl-user-button-item`               | `data-interactive`                      |
| `.cl-user-button-item-media`         |                                         |
| `.cl-user-button-item-content`       |                                         |
| `.cl-user-button-item-label`         | `data-variant="default \| interactive"` |
| `.cl-user-button-item-description`   |                                         |
| `.cl-user-button-item-trailing`      |                                         |
