...
import { UserProfileSecurityPanelView } from '@clerk/mosaic/user-profile/user-profile-security-panel.view';
...
export const meta: StoryMeta = {
  ...
  source: 'packages/mosaic/src/user-profile/user-profile-security-panel.view.tsx',
};
