...
Use `render` to compose the avatar onto a button or another trigger without introducing a separate wrapper component. The `xl` avatar and button are both 48×48.
