...
A set of stacked sections where each is toggled by its own heading button. It is a
**headless** primitive: it supplies behavior, single/multiple
...
```tsx
import { Accordion } from '@clerk/mosaic/primitives/accordion';
