import { UserProfileSubscriptionSectionView } from '@clerk/mosaic/user-profile/user-profile-subscription-section.view';
...
export const meta: StoryMeta = {
  ...
  source: 'packages/mosaic/src/user-profile/user-profile-subscription-section.view.tsx',
};
