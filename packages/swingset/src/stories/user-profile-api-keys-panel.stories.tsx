...
import { UserProfileApiKeysPanelView } from '@clerk/mosaic/user-profile/user-profile-api-keys-panel.view';
...
export const meta: StoryMeta = {
  ...
  source: 'packages/mosaic/src/user-profile/user-profile-api-keys-panel.view.tsx',
};
