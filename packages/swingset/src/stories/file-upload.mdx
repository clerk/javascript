...
A file picker that accepts input from a trigger button or drag-and-drop. It is a **headless**
primitive: it owns the selected-file state, a hidden `<input type="file">`,
