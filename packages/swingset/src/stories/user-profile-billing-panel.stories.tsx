...
import { UserProfileBillingPanelView } from '@clerk/mosaic/user-profile/user-profile-billing-panel.view';
...
export const meta: StoryMeta = {
  ...
  source: 'packages/mosaic/src/user-profile/user-profile-billing-panel.view.tsx',
};
