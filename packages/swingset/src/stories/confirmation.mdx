...
It is an `alertdialog`: it announces as an interruption, an outside press cannot answer it, and the card carries no corner dismiss — the footer is the only way out. Under the phone band it arrives as a bottom sheet.
